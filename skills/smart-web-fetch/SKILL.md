...
description: 智能网页抓取技能 - 替代内置 web_fetch，自动使用 Jina Reader / markdown.new / defuddle.md 清洗服务获取干净 Markdown。支持多级降级策略，大幅降低 Token 消耗。
version: 1.0.0
author: leochens
category: web
flags: optional
...
```bash
# 克隆技能目录
git clone <repo> skills/smart-web-fetch/

# 或手动下载 Python 脚本
# 放置在 ~/.openclaw/skills/smart-web-fetch/scripts/ 目录下
```
...
```bash
# 获取知乎文章
python3 scripts/fetch.py "https://zhuanlan.zhihu.com/p/article"

# 获取 GitHub README
python3 scripts/fetch.py "https://github.com/user/repo/blob/main/README.md"

# 获取 Stack Overflow 问题
python3 scripts/fetch.py "https://stackoverflow.com/questions/question-id"
```
...
Skill created by Leo Chen (leochens)
License: MIT
