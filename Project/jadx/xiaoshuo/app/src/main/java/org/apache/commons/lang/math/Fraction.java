...
public final class Fraction extends Number implements Comparable {
                ...
                if (i == i2) {
                    ...
                    if (i < (-i2)) {
                        ...
                        if (properNumerator == 0) {
                            ...
                            this.toProperString = new StrBuilder(32).append(getProperWhole()).append(' ').append(properNumerator).append(JsonPointer.SEPARATOR).append(getDenominator()).toString();
                        }
                    } else {
                        this.toProperString = new StrBuilder(32).append(getNumerator()).append(JsonPointer.SEPARATOR).append(getDenominator()).toString();
                    }
                }
            }
        }
    ...
    public String toString() {
        if (this.toString == null) {
            this.toString = new StrBuilder(32).append(getNumerator()).append(JsonPointer.SEPARATOR).append(getDenominator()).toString();
        }
