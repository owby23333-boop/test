...
public class SmoothPathProvider2 {
    ...
    public void drawPath(Canvas canvas, Paint paint, @Nullable SmoothData smoothData, int i, int i2, int i3) {
        if (smoothData == null) {
            return;
        }
        ...
        if (smoothData.topRight.smoothForHorizontal != w51.l) {
            Path path2 = new Path();
        ...
        if (smoothData.bottomRight.smoothForVertical != w51.l) {
            Path path4 = new Path();
        ...
        if (smoothData.bottomLeft.smoothForHorizontal != w51.l) {
            Path path6 = new Path();
        ...
        if (smoothData.topLeft.smoothForVertical != w51.l) {
            Path path8 = new Path();
