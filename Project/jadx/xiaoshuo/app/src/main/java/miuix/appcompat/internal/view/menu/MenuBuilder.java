...
public class MenuBuilder extends com.android.internal.view.menu.MenuBuilder {
    ...
    private void setHeaderInternal(int i, CharSequence charSequence, int i2, Drawable drawable2, View view) {
    ...
    */
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            for (MenuItemImpl menuItemImpl : this.mItems) {
                ...
                if ((metaState & 5) == 0 && alphabeticShortcut != 0) {
                    char[] cArr = keyData.meta;
                    if (alphabeticShortcut == cArr[0] || alphabeticShortcut == cArr[2] || (zIsQwertyMode && alphabeticShortcut == '\b' && i == 67)) {
    ...
    public MenuBuilder setHeaderIconInt(Drawable drawable2) {
        setHeaderInternal(0, null, 0, drawable2, null);
        return this;
    }
