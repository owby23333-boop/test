...
public class Debug {
    public static void dumpLayoutParams(ViewGroup layout, String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + str + CollapseTextView.k;
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams param, String str) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + str + CollapseTextView.k;
        System.out.println(" >>>>>>>>>>>>>>>>>>. dump " + str2 + CollapseTextView.k + param.getClass().getName());
