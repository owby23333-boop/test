...
public final class ViewPropertyAnimatorCompat {
    ...
    public static class ViewPropertyAnimatorListenerApi14 implements ViewPropertyAnimatorListener {
        ...
        public ViewPropertyAnimatorListenerApi14(ViewPropertyAnimatorCompat vpa) {
            this.mVpa = vpa;
        }
    ...
    private void setListenerInternal(final View view, final ViewPropertyAnimatorListener listener2) {
        if (listener2 != null) {
            view.animate().setListener(new AnimatorListenerAdapter() { // from class: androidx.core.view.ViewPropertyAnimatorCompat.1
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationCancel(Animator animation) {
                    listener2.onAnimationCancel(view);
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
                    listener2.onAnimationEnd(view);
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animation) {
                    listener2.onAnimationStart(view);
                }
            });
        } else {
    ...
    public ViewPropertyAnimatorCompat setListener(final ViewPropertyAnimatorListener listener2) {
        View view = this.mView.get();
        if (view != null) {
            setListenerInternal(view, listener2);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat setUpdateListener(final ViewPropertyAnimatorUpdateListener listener2) {
        final View view = this.mView.get();
        if (view != null) {
            view.animate().setUpdateListener(listener2 != null ? new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.ViewPropertyAnimatorCompat.2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    listener2.onAnimationUpdate(view);
                }
            } : null);
        }
        return this;
