...
public final class Palette {
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmapDown(Bitmap bitmap) {
            ...
            return dSqrt <= w51.l ? bitmap : Bitmap.createScaledBitmap(bitmap, (int) Math.ceil(((double) bitmap.getWidth()) * dSqrt), (int) Math.ceil(((double) bitmap.getHeight()) * dSqrt), false);
        }
