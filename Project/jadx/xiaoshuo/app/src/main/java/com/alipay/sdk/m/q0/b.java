...
public class b {
    ...
    public static final /* synthetic */ boolean f1909a = true;
    ...
    public static byte[] a(byte[] bArr, int i, int i2, int i3) {
        C0036b c0036b = new C0036b(i3, new byte[(i2 * 3) / 4]);
        if (!c0036b.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        int i4 = c0036b.f1911b;
        byte[] bArr2 = c0036b.f1910a;
        if (i4 == bArr2.length) {
            return bArr2;
        }
    ...
    public static byte[] b(byte[] bArr, int i, int i2, int i3) {
        ...
        cVar.f1910a = new byte[i4];
        cVar.a(bArr, i, i2, true);
        if (f1909a || cVar.f1911b == i4) {
            return cVar.f1910a;
        }
