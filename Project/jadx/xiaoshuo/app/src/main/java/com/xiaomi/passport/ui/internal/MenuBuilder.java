    ...
    */
    private void setShortcutsVisibleInner(boolean r3) {
        /*
            ...
            if (r3 == r0) goto L18
            android.content.res.Resources r3 = r2.mResources
            int r1 = com.xiaomi.account.passportsdk.account_sso.R.bool.passport_abc_config_showMenuShortcutsWhenKeyboardPresent
    ...
    public boolean performItemAction(MenuItem menuItem, int i) {
        ...
        if (menuItemImpl.hasCollapsibleActionView()) {
            ...
            zInvoke |= dispatchSubMenuSelected(subMenuBuilder);
            if (!zInvoke) {
                close(true);
            }
        } else if ((i & 1) == 0) {
