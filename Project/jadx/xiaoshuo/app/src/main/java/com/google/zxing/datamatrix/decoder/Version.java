...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        return new Version[]{new Version(1, 10, 10, 8, 8, new ECBlocks(i3, new ECB(i2, 3))), new Version(2, 12, 12, 10, 10, new ECBlocks(7, new ECB(i2, i3))), version, new Version(4, 16, 16, 14, 14, new ECBlocks(i5, new ECB(i2, i5))), new Version(5, 18, 18, 16, 16, new ECBlocks(14, new ECB(i2, i6))), new Version(6, 20, 20, 18, 18, new ECBlocks(i6, new ECB(i2, 22))), version2, new Version(8, 24, 24, 22, 22, new ECBlocks(24, new ECB(i2, i8))), new Version(9, 26, 26, 24, 24, new ECBlocks(28, new ECB(i2, 44))), new Version(10, 32, 32, 14, 14, new ECBlocks(i8, new ECB(i2, i9))), new Version(11, 36, 36, 16, 16, new ECBlocks(42, new ECB(i2, 86))), new Version(12, 40, 40, 18, 18, new ECBlocks(48, new ECB(i2, 114))), new Version(13, 44, 44, 20, 20, new ECBlocks(i10, new ECB(i2, MediaPlayer.MEDIA_PLAYER_OPTION_SPADE))), new Version(14, 48, 48, 22, 22, new ECBlocks(i11, new ECB(i2, MediaPlayer.MEDIA_PLAYER_OPTION_ABR_AVERAGE_BITRATE))), new Version(15, 52, 52, 24, 24, new ECBlocks(42, new ECB(i4, 102))), new Version(16, 64, 64, 14, 14, new ECBlocks(i10, new ECB(i4, 140))), new Version(17, 72, 72, 16, 16, new ECBlocks(i8, new ECB(4, 92))), new Version(18, 80, 80, 18, 18, new ECBlocks(48, new ECB(4, 114))), new Version(19, 88, 88, 20, 20, new ECBlocks(i10, new ECB(4, MediaPlayer.MEDIA_PLAYER_OPTION_SPADE))), new Version(20, 96, 96, 22, 22, new ECBlocks(i11, new ECB(4, MediaPlayer.MEDIA_PLAYER_OPTION_ABR_AVERAGE_BITRATE))), new Version(21, 104, 104, 24, 24, new ECBlocks(i10, new ECB(i7, 136))), new Version(22, 120, 120, 18, 18, new ECBlocks(i11, new ECB(i7, MediaPlayer.MEDIA_PLAYER_OPTION_ABR_AVERAGE_PLAY_SPEED))), new Version(23, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_SIDE_DATA, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_SIDE_DATA, 20, 20, new ECBlocks(i9, new ECB(i, 163))), new Version(24, MediaPlayer.MEDIA_PLAYER_OPTION_SPADE, MediaPlayer.MEDIA_PLAYER_OPTION_SPADE, 22, 22, new ECBlocks(i9, new ECB(i, MediaPlayer.MEDIA_PLAYER_OPTION_GET_AUDIO_DEVICE_OPEN_TIME), new ECB(i4, MediaPlayer.MEDIA_PLAYER_OPTION_GET_VIDEO_DEVICE_OPEN_TIME))), new Version(25, 8, 18, 6, 16, new ECBlocks(7, ecb)), new Version(26, 8, 32, 6, 14, new ECBlocks(11, ecb2)), new Version(27, 12, 26, 10, 24, new ECBlocks(14, ecb3)), new Version(28, 12, 36, 10, 16, new ECBlocks(i6, new ECB(i2, 22))), new Version(29, 16, 36, 14, 16, new ECBlocks(24, new ECB(i2, 32))), new Version(30, 16, 48, 14, 22, new ECBlocks(28, new ECB(i2, 49)))};
    }
