...
public enum fs {
    ...
    GSLB_TCP_NOACCESS(ErrorCode.MSP_ERROR_OUT_OF_MEMORY),
    GSLB_TCP_NETUNREACH(ErrorCode.MSP_ERROR_FILE_NOT_FOUND),
    GSLB_TCP_CONNREFUSED(ErrorCode.MSP_ERROR_NOT_SUPPORT),
    GSLB_TCP_NOROUTETOHOST(ErrorCode.MSP_ERROR_NOT_IMPLEMENT),
    GSLB_TCP_TIMEOUT(ErrorCode.MSP_ERROR_ACCESS),
    GSLB_TCP_INVALARG(ErrorCode.MSP_ERROR_INVALID_PARA),
    GSLB_TCP_UKNOWNHOST(ErrorCode.MSP_ERROR_INVALID_PARA_VALUE),
    ...
    CHANNEL_TCP_CONNRESET_DEPRECTED(uz.i),
