...
public class lc {
    ...
    public static List<File> e(String str, String str2) throws IOException {
        return e(str, str2, (String) null);
    }

    public static List<File> e(String str, String str2, String str3) throws IOException {
        return e(e(str), e(str2), str3);
    }

    public static List<File> e(File file, File file2, String str) throws IOException {
        ...
        try {
            if (bf(str)) {
                while (enumerationEntries.hasMoreElements()) {
                    ...
                    if (name.contains("../")) {
                        wu.tg("ZipUtils", "entryName: " + name + " is dangerous!");
                    } else if (!e(file2, arrayList, zipFile, zipEntryNextElement, name)) {
                        return arrayList;
                    }
                }
            } else {
                while (enumerationEntries.hasMoreElements()) {
                    ...
                    if (name2.contains("../")) {
                        wu.tg("ZipUtils", "entryName: " + name2 + " is dangerous!");
                    } else if (name2.contains(str) && !e(file2, arrayList, zipFile, zipEntryNextElement2, name2)) {
                        return arrayList;
                    }
                }
            }
    ...
    */
    private static boolean e(java.io.File r2, java.util.List<java.io.File> r3, java.util.zip.ZipFile r4, java.util.zip.ZipEntry r5, java.lang.String r6) throws java.lang.Throwable {
        /*
        ...
        L66:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.component.utils.lc.e(java.io.File, java.util.List, java.util.zip.ZipFile, java.util.zip.ZipEntry, java.lang.String):boolean");
    }
