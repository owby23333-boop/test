...
public final class MpegAudioUtil {
    ...
    private static final int[] SAMPLING_RATE_V1 = {44100, OpusUtil.SAMPLE_RATE, to2.a.h};
    private static final int[] BITRATE_V1_L1 = {to2.a.h, to2.a.i, 96000, 128000, 160000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 224000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 288000, 320000, 352000, 384000, 416000, 448000};
    private static final int[] BITRATE_V2_L1 = {to2.a.h, OpusUtil.SAMPLE_RATE, 56000, to2.a.i, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 96000, 112000, 128000, 144000, 160000, 176000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 224000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND};
    private static final int[] BITRATE_V1_L2 = {to2.a.h, OpusUtil.SAMPLE_RATE, 56000, to2.a.i, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 96000, 112000, 128000, 160000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 224000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 320000, 384000};
    public static final int MAX_RATE_BYTES_PER_SECOND = 40000;
    private static final int[] BITRATE_V1_L3 = {to2.a.h, MAX_RATE_BYTES_PER_SECOND, OpusUtil.SAMPLE_RATE, 56000, to2.a.i, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 96000, 112000, 128000, 160000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 224000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 320000};
    private static final int[] BITRATE_V2 = {8000, 16000, ErrorCode.ERROR_TTS_INVALID_PARA, to2.a.h, MAX_RATE_BYTES_PER_SECOND, OpusUtil.SAMPLE_RATE, 56000, to2.a.i, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 96000, 112000, 128000, 144000, 160000};
    ...
    public static int getFrameSize(int i) {
        ...
        int i9 = MediaPlayer.MEDIA_PLAYER_OPTION_SPADE;
        if (i2 == 3) {
            return ((i8 * MediaPlayer.MEDIA_PLAYER_OPTION_SPADE) / i6) + i7;
        }
        if (i3 == 1) {
            i9 = 72;
        }
