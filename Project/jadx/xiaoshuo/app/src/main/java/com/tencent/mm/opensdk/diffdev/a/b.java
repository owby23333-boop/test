...
public class b extends AsyncTask<Void, Void, a> {
            ...
            if (bArr == null || bArr.length == 0) {
                ...
                try {
                    try {
                        ...
                        int i = jSONObject.getInt(CommonConstants.KEY_ERR_CODE);
                        if (i != 0) {
                            Log.e("MicroMsg.SDK.GetQRCodeResult", String.format("resp errcode = %d", Integer.valueOf(i)));
                            aVar.f7242a = OAuthErrCode.WechatAuth_Err_NormalErr;
                        ...
                        if (string != null && string.length() != 0) {
                            ...
                            if (bArrDecode != null && bArrDecode.length != 0) {
                                aVar.f7242a = OAuthErrCode.WechatAuth_Err_OK;
                                aVar.e = bArrDecode;
                                aVar.f7243b = jSONObject.getString(Constants.EXTRA_UUID);
                                String string2 = jSONObject.getString("appname");
                                aVar.c = string2;
                                Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in memory, uuid = %s, appname = %s, imgBufLength = %d", aVar.f7243b, string2, Integer.valueOf(aVar.e.length)));
                                return aVar;
                            }
                            Log.e("MicroMsg.SDK.GetQRCodeResult", "parse fail, qrcodeBuf is null");
                            aVar.f7242a = OAuthErrCode.WechatAuth_Err_JsonDecodeErr;
                            return aVar;
                        }
    ...
    public a doInBackground(Void[] voidArr) throws Throwable {
        ...
        String str = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.f7240a, this.c, this.d, this.f7241b, this.e);
    ...
    public void onPostExecute(a aVar) {
        ...
        c cVar = new c(aVar2.f7243b, this.f);
        this.g = cVar;
