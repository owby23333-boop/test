...
final class DefaultConnectivityMonitor implements ConnectivityMonitor {
    ...
    private final BroadcastReceiver connectivityReceiver = new BroadcastReceiver() { // from class: com.bumptech.glide.manager.DefaultConnectivityMonitor.1
        ...
        public void onReceive(@NonNull Context context, Intent intent) {
            ...
            if (z != DefaultConnectivityMonitor.this.isConnected) {
                ...
                defaultConnectivityMonitor2.f2022listener.onConnectivityChanged(defaultConnectivityMonitor2.isConnected);
            }
        }
    };
    ...
    final ConnectivityMonitor.ConnectivityListener f2022listener;

    public DefaultConnectivityMonitor(@NonNull Context context, @NonNull ConnectivityMonitor.ConnectivityListener connectivityListener) {
        this.context = context.getApplicationContext();
        this.f2022listener = connectivityListener;
    }
