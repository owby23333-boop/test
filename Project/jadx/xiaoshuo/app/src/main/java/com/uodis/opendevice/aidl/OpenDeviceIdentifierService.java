...
public interface OpenDeviceIdentifierService extends IInterface {
    ...
    public static class Default implements OpenDeviceIdentifierService {
        ...
        public boolean getBoos() throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements OpenDeviceIdentifierService {
        ...
        static final int TRANSACTION_getBoos = 2;
        static final int TRANSACTION_getIDs = 1;
            ...
            public boolean getBoos() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getBoos();
                    }
            ...
            public String getIDs() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getIDs();
                    }
                    parcelObtain2.readException();
        ...
        public static boolean setDefaultImpl(OpenDeviceIdentifierService openDeviceIdentifierService) {
            if (Proxy.sDefaultImpl != null || openDeviceIdentifierService == null) {
                return false;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            parcel.enforceInterface("com.uodis.opendevice.aidl.OpenDeviceIdentifierService");
            boolean boos = getBoos();
            parcel2.writeNoException();
            parcel2.writeInt(boos ? 1 : 0);
            return true;
        }
    }

    boolean getBoos() throws RemoteException;

    String getIDs() throws RemoteException;
}
