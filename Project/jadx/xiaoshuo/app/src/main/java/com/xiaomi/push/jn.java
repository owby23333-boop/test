...
public final class jn {
    ...
    private static final Comparator f8136a = new a();
    ...
    public static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            return obj instanceof List ? jn.a((List) obj, (List) obj2) : obj instanceof Set ? jn.a((Set) obj, (Set) obj2) : obj instanceof Map ? jn.a((Map) obj, (Map) obj2) : obj instanceof byte[] ? jn.a((byte[]) obj, (byte[]) obj2) : jn.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static int a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int iCompare = f8136a.compare(list.get(i), list2.get(i));
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int iCompare = f8136a.compare(it.next(), it2.next());
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static byte[] m673a(ByteBuffer byteBuffer) {
        if (m672a(byteBuffer)) {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static boolean m672a(ByteBuffer byteBuffer) {
    ...
    public static ByteBuffer a(ByteBuffer byteBuffer) {
        return m672a(byteBuffer) ? byteBuffer : ByteBuffer.wrap(m673a(byteBuffer));
    }
}
