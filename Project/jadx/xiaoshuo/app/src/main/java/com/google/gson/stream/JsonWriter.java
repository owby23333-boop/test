...
public class JsonWriter implements Closeable, Flushable {
    ...
    private void newline() throws IOException {
        ...
        this.out.write(SignatureUtils.DELIMITER);
    ...
    */
    ...
    public JsonWriter value(boolean z) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(z ? a.c : MscKeys.VAL_FALSE);
        return this;
    }
    ...
    public JsonWriter value(Boolean bool) throws IOException {
        ...
        writeDeferredName();
        beforeValue();
        this.out.write(bool.booleanValue() ? a.c : MscKeys.VAL_FALSE);
        return this;
    }
