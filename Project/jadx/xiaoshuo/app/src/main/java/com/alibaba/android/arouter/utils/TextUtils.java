...
public class TextUtils {
    ...
    public static String getLeft(String str) {
        return (!str.contains(b.e.t) || str.endsWith(b.e.t)) ? str : str.substring(0, str.indexOf(b.e.t));
    }

    public static String getRight(String str) {
        return (!str.contains(b.e.t) || str.startsWith(b.e.t)) ? str : str.substring(str.indexOf(b.e.t) + 1);
    }
