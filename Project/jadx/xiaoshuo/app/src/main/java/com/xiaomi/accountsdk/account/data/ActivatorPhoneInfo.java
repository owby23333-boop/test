...
public class ActivatorPhoneInfo implements Parcelable {
    public static final Parcelable.Creator<ActivatorPhoneInfo> CREATOR = new Parcelable.Creator<ActivatorPhoneInfo>() { // from class: com.xiaomi.accountsdk.account.data.ActivatorPhoneInfo.1
        ...
        public ActivatorPhoneInfo createFromParcel(Parcel parcel) {
            ...
            return new Builder().phone(bundle.getString("phone")).phoneHash(bundle.getString(ActivatorPhoneInfo.KEY_PHONE_HASH)).activatorToken(bundle.getString(ActivatorPhoneInfo.KEY_ACTIVATOR_TOKEN)).slotId(bundle.getInt(ActivatorPhoneInfo.KEY_SLOT_ID)).copyWriter(bundle.getString(ActivatorPhoneInfo.KEY_COPY_WRITER)).operatorLink(bundle.getString(ActivatorPhoneInfo.KEY_OPERATOR_LINK)).needVerify(bundle.getBoolean(ActivatorPhoneInfo.KEY_NEED_VERIFY)).isVerified(bundle.getBoolean(ActivatorPhoneInfo.KEY_IS_VERIFIED)).build();
        }
