...
public final class Base64 {
    ...
    public static byte[] decode(String str) {
                ...
                if (isData(c2)) {
                    ...
                    if (isData(c3)) {
                        ...
                        if (isData(c4)) {
                            ...
                            int i10 = i9 + 1;
                            bArr[i9] = (byte) (((b3 & Ascii.SI) << 4) | ((b4 >> 2) & 15));
                            i4 = i10 + 1;
        ...
        if (isData(c7) && isData(c8)) {
            ...
            bArr[i14] = (byte) (((b7 & Ascii.SI) << 4) | ((b8 >> 2) & 15));
        ...
        bArr5[i4 + 1] = (byte) (((b10 >> 2) & 15) | ((b7 & Ascii.SI) << 4));
        return bArr5;
    }
    ...
    public static String encode(byte[] bArr) {
        ...
        while (i3 < i2) {
            ...
            int i9 = (b4 & (-128)) == 0 ? b4 >> 6 : (b4 >> 6) ^ MediaPlayer.MEDIA_PLAYER_OPTION_HW_DEC_DROP_NON_REF;
            int i10 = i5 + 1;
            ...
            cArr[i12] = cArr2[b4 & Utf8.REPLACEMENT_BYTE];
            i3++;
            i5 = i12 + 1;
            i4 = i8;
        }
        if (i == 8) {
            ...
            int i16 = (b12 & (-128)) == 0 ? b12 >> 4 : (b12 >> 4) ^ 240;
            int i17 = i5 + 1;
