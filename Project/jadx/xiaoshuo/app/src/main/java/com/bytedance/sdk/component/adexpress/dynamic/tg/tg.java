        ...
        try {
            ...
            while (itKeys.hasNext()) {
                ...
                if (objOpt2 == null) {
                    ...
                    jSONObject3.put(next, e((JSONObject) objOpt, (JSONObject) objOpt2));
                } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                    jSONObject3.put(next, e((JSONArray) objOpt, (JSONArray) objOpt2));
                } else {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                if (objOpt2 == null) {
                    ...
                    jSONArray3.put(i, e((JSONObject) objOpt, (JSONObject) objOpt2));
                } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                    jSONArray3.put(i, e((JSONArray) objOpt, (JSONArray) objOpt2));
                } else {
