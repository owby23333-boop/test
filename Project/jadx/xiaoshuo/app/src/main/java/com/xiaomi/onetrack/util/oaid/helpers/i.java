...
public class i {
    ...
    com.xiaomi.onetrack.util.oaid.a.d f7755a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final LinkedBlockingQueue<IBinder> f7756b = new LinkedBlockingQueue<>(1);
    ServiceConnection c = new ServiceConnection() { // from class: com.xiaomi.onetrack.util.oaid.helpers.OnePlusDeviceIDHelper$1
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            try {
                this.f7735a.f7756b.offer(iBinder, 1L, TimeUnit.SECONDS);
            } catch (Exception e) {
    ...
    public String a(Context context) {
        ...
        if (context.bindService(intent, this.c, 1)) {
            try {
                try {
                    try {
                        IBinder iBinderPoll = this.f7756b.poll(1L, TimeUnit.SECONDS);
                        if (iBinderPoll == null) {
                            return "";
                        }
                        com.xiaomi.onetrack.util.oaid.a.d dVarA = d.a.a(iBinderPoll);
                        this.f7755a = dVarA;
                        strA = dVarA != null ? a("OUID", context) : "";
    ...
    private String a(String str, Context context) {
        ...
        return ((d.a.C0550a) this.f7755a).a(packageName, this.e, str);
    }
}
