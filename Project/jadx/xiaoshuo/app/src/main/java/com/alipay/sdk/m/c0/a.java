...
public class a {
    ...
    public class RunnableC0024a implements Runnable {
        ...
        public void run() {
            if (a.this.f1759a == null) {
                a aVar = a.this;
                a aVar2 = a.this;
                aVar.f1759a = aVar2.new d(aVar2.f1760b);
                a.this.f1759a.setCancelable(a.this.g);
            }
            try {
                if (a.this.f1759a.isShowing()) {
                    return;
                }
                a.this.f1759a.show();
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (a.this.f1759a == null || !a.this.f1759a.isShowing()) {
                return;
            }
            try {
                a.this.h.removeMessages(1);
                a.this.f1759a.dismiss();
            } catch (Exception e) {
                g.a(e);
            }
        }
    ...
    public class d extends AlertDialog {
        ...
        public final View a(Context context) {
            ...
            layoutParams2.setMargins(a(a.this.f1760b, 17.0f), a(a.this.f1760b, 10.0f), a(a.this.f1760b, 8.0f), a(a.this.f1760b, 10.0f));
