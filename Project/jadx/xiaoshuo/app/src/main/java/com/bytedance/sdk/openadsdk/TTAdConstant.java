...
public class TTAdConstant {
    ...
    public static final String BRANCH = "v5400";
    public static final int BUILD_IN_MODULE_VERSION_CODE = 5438;
    public static final String BUILD_IN_MODULE_VERSION_NAME = "5.4.3.8";
    ...
    public static final String C_H = "e47e047";
    ...
    public static final int SDK_VERSION_CODE = 5438;
    public static final String SDK_VERSION_NAME = "5.4.3.8";
    ...
    public static final String S_C = "privacy";
    ...
    public enum RitScenes {
        ...
        GAME_MORE_KLLKRTUNITIES(TTAdConstant.bf("game_more_kllkrtunities")),
    ...
    public static String bf(String str) {
        return TextUtils.isEmpty(str) ? "" : str.contains("KLLK") ? str.replace("KLLK", OsHelper.ROM_OPPO) : str.contains("kllk") ? str.replace("kllk", "oppo") : "";
    }
