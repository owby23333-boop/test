...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{759}, "VE");
            add(new int[]{TtsPlayerController.j1, 769}, "CH");
            add(new int[]{770}, "CO");
            add(new int[]{773}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            ...
            add(new int[]{885}, "TH");
            add(new int[]{888}, "SG");
            add(new int[]{890}, Region.IN);
            add(new int[]{893}, "VN");
            add(new int[]{DateUtils.FORMAT_SHOW_DATE}, "PK");
            add(new int[]{899}, Region.ID);
            add(new int[]{900, 919}, "AT");
            add(new int[]{MediaPlayer.MEDIA_PLAYER_OPTION_LIVE_ABR_SWITCH_COST, 939}, "AU");
            add(new int[]{MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_PARAMS, km2.e}, "AZ");
            add(new int[]{955}, "MY");
            add(new int[]{958}, SmsUplinkConfig.ACTIVATION_SMS_PREFIX);
        }
    }
