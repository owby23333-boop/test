...
public final class ClassUtil {
    ...
    public static boolean isConcrete(Class<?> cls) {
        return (cls.getModifiers() & CommonConstants.Mgc.PAY_TYPE_ERROR) == 0;
    }
    ...
    public static boolean isConcrete(Member member) {
        return (member.getModifiers() & CommonConstants.Mgc.PAY_TYPE_ERROR) == 0;
    }
