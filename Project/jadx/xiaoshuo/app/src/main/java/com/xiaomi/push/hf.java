...
public class hf extends hg {
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.f;
        if (str == null ? hfVar.f != null : !str.equals(hfVar.f)) {
            return false;
        }
        String str2 = this.d;
        if (str2 == null ? hfVar.d != null : !str2.equals(hfVar.d)) {
            return false;
        }
        String str3 = this.e;
        if (str3 == null ? hfVar.e != null : !str3.equals(hfVar.e)) {
            return false;
        }
        String str4 = this.c;
        if (str4 == null ? hfVar.c == null : str4.equals(hfVar.c)) {
            return this.f8034b == hfVar.f8034b;
        }
        return false;
    }
    ...
    public Bundle a() {
        ...
        if (!TextUtils.isEmpty(this.f8034b)) {
            bundleA.putString("ext_msg_type", this.f8034b);
        }
        String str = this.d;
        if (str != null) {
    ...
    public hf(Bundle bundle) {
        ...
        this.l = "";
        this.f495b = false;
        this.f8034b = bundle.getString("ext_msg_type");
        ...
        this.f8033a = bundle.getBoolean("ext_msg_trans", false);
        this.f495b = bundle.getBoolean("ext_msg_encrypt", false);
    ...
    public String mo496a() {
        ...
        if ("error".equalsIgnoreCase(this.f8034b) && (hkVarM497a = m497a()) != null) {
