...
public class bf {
    ...
    public static JSONObject pl(String str) {
        HashMap<String, JSONObject> map = e;
    ...
    public static void t(String str) {
        try {
            e.put(str, new JSONObject("{\"values\":{\"widthMode\":\"flex\",\"paddingBottom\":0,\"bgColor\":\"#333333\",\"paddingRight\":0,\"width\":1,\"heightMode\":\"fixed\",\"borderSize\":0,\"paddingTop\":0,\"position\":\"0\",\"paddingLeft\":0,\"height\":1},\"areaType\":1,\"themeValues\":{},\"clickType\":\"\"}"));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
