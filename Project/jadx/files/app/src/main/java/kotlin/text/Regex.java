...
public final class Regex implements Serializable {
    ...
    public Regex(@NotNull Pattern pattern) {
        this.f20984s = pattern;
    }

    public final boolean a(@NotNull CharSequence charSequence) {
        return this.f20984s.matcher(charSequence).matches();
    }

    @NotNull
    public String toString() {
        return this.f20984s.toString();
    }
    ...
    public final String a(@NotNull CharSequence charSequence, @NotNull String str) {
        return this.f20984s.matcher(charSequence).replaceAll(str);
    }
}
