...
public final class Segment {
    ...
    public final void compact() {
        ...
        if (this.prev.owner) {
            ...
            if (i2 > (8192 - this.prev.limit) + (this.prev.shared ? 0 : this.prev.pos)) {
                return;
            }
    ...
    public final Segment split(int byteCount) {
        ...
        if (byteCount >= 1024) {
            ...
            int i2 = this.pos;
            c.a(bArr, bArr2, 0, i2, i2 + byteCount, 2, null);
        }
    ...
    public final void writeTo(@NotNull Segment sink, int byteCount) {
        ...
        int i4 = sink.limit;
        int i5 = this.pos;
        c.a(bArr2, bArr3, i4, i5, i5 + byteCount);
