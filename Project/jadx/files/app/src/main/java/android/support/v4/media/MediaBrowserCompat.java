...
public final class MediaBrowserCompat {
    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int i2, Bundle bundle) {
            ...
            String str = "Unknown result code: " + i2 + " (extras=" + this.mExtras + ", resultData=" + bundle + ad.f20406s;
        }
    }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            ...
            if (i2 == 0 || i2 == 1) {
                ...
                throw new IllegalStateException("connect() called while neigther disconnecting nor disconnected (state=" + getStateLabel(this.mState) + ad.f20406s);
            }
        }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException("getExtras() called while not connected (state=" + getStateLabel(this.mState) + ad.f20406s);
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException("getRoot() called while not connected(state=" + getStateLabel(this.mState) + ad.f20406s);
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException("getServiceComponent() called while not connected (state=" + this.mState + ad.f20406s);
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException("getSessionToken() called while not connected(state=" + this.mState + ad.f20406s);
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException("search() called while not connected (state=" + getStateLabel(this.mState) + ad.f20406s);
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException unused) {
