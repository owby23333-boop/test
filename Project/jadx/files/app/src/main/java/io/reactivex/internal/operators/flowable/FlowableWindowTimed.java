...
public final class FlowableWindowTimed<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowSkipSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription, Runnable {
        ...
        static final class SubjectWork<T> {
            ...
            final UnicastProcessor<T> f20893w;

            SubjectWork(UnicastProcessor<T> unicastProcessor, boolean z2) {
                this.f20893w = unicastProcessor;
                this.open = z2;
            }
        }
        ...
        void drainLoop() {
            ...
            while (!this.terminated) {
                ...
                if (z3) {
                    ...
                    if (!subjectWork.open) {
                        list.remove(subjectWork.f20893w);
                        subjectWork.f20893w.onComplete();
    ...
    protected void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        ...
        if (j4 == Long.MAX_VALUE) {
            this.source.subscribe((FlowableSubscriber) new WindowExactUnboundedSubscriber(serializedSubscriber, j2, this.unit, this.scheduler, this.bufferSize));
        } else {
