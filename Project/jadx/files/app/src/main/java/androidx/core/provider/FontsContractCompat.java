...
public class FontsContractCompat {
    ...
    public static class FontFamilyResult {
        ...
        static FontFamilyResult create(int i2, @Nullable FontInfo[] fontInfoArr) {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i2, @IntRange(from = 1, to = d.a) int i3, boolean z2, int i4) {
        ...
        static FontInfo create(@NonNull Uri uri, @IntRange(from = 0) int i2, @IntRange(from = 1, to = d.a) int i3, boolean z2, int i4) {
