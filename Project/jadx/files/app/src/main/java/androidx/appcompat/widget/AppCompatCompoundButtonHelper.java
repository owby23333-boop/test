...
class AppCompatCompoundButtonHelper {
    ...
    void loadFromAttributes(@Nullable AttributeSet attributeSet, int i2) {
        ...
        try {
            ...
            if (!z2 && tintTypedArrayObtainStyledAttributes.hasValue(R.styleable.CompoundButton_android_button) && (resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(R.styleable.CompoundButton_android_button, 0)) != 0) {
