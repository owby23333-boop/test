...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        Location lastKnownLocationForProvider = PermissionChecker.checkSelfPermission(this.mContext, g.f16728h) == 0 ? getLastKnownLocationForProvider("network") : null;
        Location lastKnownLocationForProvider2 = PermissionChecker.checkSelfPermission(this.mContext, g.f16727g) == 0 ? getLastKnownLocationForProvider("gps") : null;
    ...
    @RequiresPermission(anyOf = {g.f16728h, g.f16727g})
