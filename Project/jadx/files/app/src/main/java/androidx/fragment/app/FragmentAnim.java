...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z2, boolean z3) {
        ...
        if (nextAnim != 0) {
            boolean zEquals = i.f10648f.equals(context.getResources().getResourceTypeName(nextAnim));
            if (zEquals) {
                try {
