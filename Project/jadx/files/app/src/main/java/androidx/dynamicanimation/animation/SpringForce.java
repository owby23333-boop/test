...
public final class SpringForce implements Force {
    ...
    private void init() {
        ...
        } else if (d2 >= PangleAdapterUtils.CPM_DEFLAUT_VALUE && d2 < 1.0d) {
    ...
    public SpringForce setDampingRatio(@FloatRange(from = PangleAdapterUtils.CPM_DEFLAUT_VALUE) float f2) {
        if (f2 < 0.0f) {
    ...
    public SpringForce setStiffness(@FloatRange(from = PangleAdapterUtils.CPM_DEFLAUT_VALUE, fromInclusive = false) float f2) {
        if (f2 <= 0.0f) {
