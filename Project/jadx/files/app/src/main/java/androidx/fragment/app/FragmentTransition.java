...
class FragmentTransition {
    ...
    */
    ...
    static void callSharedElementStartEnd(Fragment fragment, Fragment fragment2, boolean z2, ArrayMap<String, View> arrayMap, boolean z3) {
    ...
    static void startTransitions(@NonNull Context context, @NonNull FragmentContainer fragmentContainer, ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i2, int i3, boolean z2, Callback callback) {
        ViewGroup viewGroup;
