    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 17) {
                ...
                SERVICES.put(UserManager.class, BmobDbOpenHelper.USER);
            }
            ...
            SERVICES.put(AudioManager.class, o.b);
            ...
            SERVICES.put(NotificationManager.class, UMessage.DISPLAY_TYPE_NOTIFICATION);
            SERVICES.put(PowerManager.class, "power");
            SERVICES.put(SearchManager.class, "search");
            SERVICES.put(SensorManager.class, am.ac);
