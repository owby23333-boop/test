...
public abstract class RoomDatabase {
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public T build() {
            ...
            if (j2 > 0) {
                ...
                sQLiteCopyOpenHelperFactory = new AutoClosingRoomOpenHelperFactory(sQLiteCopyOpenHelperFactory, new AutoCloser(j2, this.mAutoCloseTimeUnit, this.mTransactionExecutor));
            }
    ...
    public void beginTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.o0
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return this.a.a((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.p0
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        while (true) {
            ...
            if (!it.hasNext()) {
                ...
                if (autoClosingRoomOpenHelper != null) {
                    this.mAutoCloser = autoClosingRoomOpenHelper.getAutoCloser();
                    this.mInvalidationTracker.setAutoCloser(this.mAutoCloser);
                }
                if (Build.VERSION.SDK_INT >= 16) {
                    z2 = databaseConfiguration.journalMode == JournalMode.WRITE_AHEAD_LOGGING;
