...
public final class WindowInsetsAnimationControllerCompat {
    ...
    private static class Impl {
        ...
        public void setInsetsAndAlpha(@Nullable Insets insets, @FloatRange(from = PangleAdapterUtils.CPM_DEFLAUT_VALUE, to = 1.0d) float f2, @FloatRange(from = PangleAdapterUtils.CPM_DEFLAUT_VALUE, to = 1.0d) float f3) {
        }
    }
