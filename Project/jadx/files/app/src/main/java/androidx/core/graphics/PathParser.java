    ...
    */
    ...
    public static class PathDataNode {
            ...
            while (i4 < fArr2.length) {
                if (c4 != 'A') {
                    if (c4 == 'C') {
                        ...
                        float f36 = f16;
                        boolean z2 = fArr2[i4 + 3] != 0.0f;
                        i3 = i4;
                        drawArc(path, f16, f17, f31, f32, f33, f34, f35, z2, fArr2[i4 + 4] != 0.0f);
                        f16 = f36 + fArr2[i45];
                        f17 += fArr2[i46];
                    }
                    i4 = i3 + i2;
        ...
        private static void drawArc(Path path, float f2, float f3, float f4, float f5, float f6, float f7, float f8, boolean z2, boolean z3) {
            ...
            if (d22 == PangleAdapterUtils.CPM_DEFLAUT_VALUE) {
                return;
            }
            double d23 = (1.0d / d22) - 0.25d;
            if (d23 < PangleAdapterUtils.CPM_DEFLAUT_VALUE) {
            ...
            if (z3 != (dAtan22 >= PangleAdapterUtils.CPM_DEFLAUT_VALUE)) {
                dAtan22 = dAtan22 > PangleAdapterUtils.CPM_DEFLAUT_VALUE ? dAtan22 - 6.283185307179586d : dAtan22 + 6.283185307179586d;
            }
            Double.isNaN(d7);
            double d26 = d2 * d7;
            Double.isNaN(d11);
