...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public final class Recycler {
        ...
        void addViewHolderToRecycledViewPool(@NonNull ViewHolder viewHolder, boolean z2) {
        ...
        /* JADX WARN: Removed duplicated region for block: B:72:0x0180 A[PHI: r1 r4
 ...
 binds: [B:28:0x005d, B:58:0x0101] A[DONT_GENERATE, DONT_INLINE]
  0x0180: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:58:0x0101] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static abstract class ViewHolder {
        ...
        public final void setIsRecyclable(boolean z2) {
            ...
            this.mIsRecyclableCount = z2 ? i2 - 1 : i2 + 1;
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                sb.append(" not recyclable(" + this.mIsRecyclableCount + ad.f20406s);
            }
  ...
  0x00d9: PHI (r0v42 int) = (r0v31 int), (r0v46 int) binds: [B:41:0x00c2, B:45:0x00d5] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    boolean scrollByInternal(int i2, int i3, MotionEvent motionEvent, int i4) {
        ...
        iArr3[1] = 0;
        int i11 = i5;
        dispatchNestedScroll(i7, i5, i8, i6, this.mScrollOffset, i4, iArr3);
        ...
        if (i7 != 0 || i11 != 0) {
            dispatchOnScrolled(i7, i11);
        }
        if (!awakenScrollBars()) {
            invalidate();
        }
        return (!z2 && i7 == 0 && i11 == 0) ? false : true;
    }
    ...
    */
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewCompat.saveAttributeDataForStyleable(this, context, NESTED_SCROLLING_ATTRS, attributeSet, typedArrayObtainStyledAttributes2, i2, 0);
    ...
    void smoothScrollBy(@Px int i2, @Px int i3, @Nullable Interpolator interpolator, int i4, boolean z2) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null || this.mLayoutSuppressed) {
            return;
        }
