...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float f2) {
        ...
        double d2 = fMin;
        Double.isNaN(d2);
        float fMax = (((float) Math.max(d2 - 0.4d, PangleAdapterUtils.CPM_DEFLAUT_VALUE)) * 5.0f) / 3.0f;
        ...
        this.mProgress.setProgressRotation((((fMax * 0.4f) - 0.25f) + (f4 * DECELERATE_INTERPOLATION_FACTOR)) * 0.5f);
