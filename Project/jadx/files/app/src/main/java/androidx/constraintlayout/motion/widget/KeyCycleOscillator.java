...
public abstract class KeyCycleOscillator {
    ...
    static class CycleOscillator {
        ...
        public void setup(float f2) {
            ...
            if (this.mPosition[0] > PangleAdapterUtils.CPM_DEFLAUT_VALUE) {
                this.mOscillator.addPoint(PangleAdapterUtils.CPM_DEFLAUT_VALUE, this.mPeriod[0]);
            }
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            str = str + "[" + it.next().mPosition + ad.f20407t + decimalFormat.format(r3.mValue) + "] ";
        }
        return str;
    }
