...
class RequestExecutor {
    ...
    static ThreadPoolExecutor createDefaultExecutor(@NonNull String str, int i2, @IntRange(from = 0) int i3) {
    ...
    static <T> T submit(@NonNull ExecutorService executorService, @NonNull Callable<T> callable, @IntRange(from = 0) int i2) throws InterruptedException {
        try {
