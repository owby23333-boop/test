...
class FragmentLifecycleCallbacksDispatcher {
    ...
    void dispatchOnFragmentActivityCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z2) {
    ...
    void dispatchOnFragmentAttached(@NonNull Fragment fragment, boolean z2) {
    ...
    void dispatchOnFragmentCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentDestroyed(@NonNull Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentDetached(@NonNull Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentPaused(@NonNull Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentPreAttached(@NonNull Fragment fragment, boolean z2) {
        Context context = this.mFragmentManager.getHost().getContext();
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentPreCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentResumed(@NonNull Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentSaveInstanceState(@NonNull Fragment fragment, @NonNull Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentStarted(@NonNull Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentStopped(@NonNull Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentViewCreated(@NonNull Fragment fragment, @NonNull View view, @Nullable Bundle bundle, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
    ...
    void dispatchOnFragmentViewDestroyed(@NonNull Fragment fragment, boolean z2) {
        Fragment parent = this.mFragmentManager.getParent();
        if (parent != null) {
