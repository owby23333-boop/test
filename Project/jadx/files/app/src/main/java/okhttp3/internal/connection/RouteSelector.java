...
public final class RouteSelector {
    ...
    private List<? extends Proxy> proxies = k.a();
    private List<? extends InetSocketAddress> inetSocketAddresses = k.a();
    ...
    public final Selection next() throws IOException {
        ...
        if (arrayList.isEmpty()) {
            p.a(arrayList, this.postponedRoutes);
