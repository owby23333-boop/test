...
public final class Hpack {
    ...
    static {
        ...
        INSTANCE = hpack;
        STATIC_HEADER_TABLE = new Header[]{new Header(Header.TARGET_AUTHORITY, ""), new Header(Header.TARGET_METHOD, "GET"), new Header(Header.TARGET_METHOD, "POST"), new Header(Header.TARGET_PATH, "/"), new Header(Header.TARGET_PATH, "/index.html"), new Header(Header.TARGET_SCHEME, "http"), new Header(Header.TARGET_SCHEME, "https"), new Header(Header.RESPONSE_STATUS, "200"), new Header(Header.RESPONSE_STATUS, "204"), new Header(Header.RESPONSE_STATUS, "206"), new Header(Header.RESPONSE_STATUS, "304"), new Header(Header.RESPONSE_STATUS, "400"), new Header(Header.RESPONSE_STATUS, ch.b), new Header(Header.RESPONSE_STATUS, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header(ParallelUploader.Params.ACCEPT, ""), new Header("access-control-allow-origin", ""), new Header(ATCustomRuleKeys.AGE, ""), new Header("allow", ""), new Header("authorization", ""), new Header(SpJsonConstants.CACHE_CONTROL, ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header(Params.CONTENT_TYPE, ""), new Header("cookie", ""), new Header("date", ""), new Header("etag", ""), new Header("expect", ""), new Header("expires", ""), new Header("from", ""), new Header(Constants.KEY_HOST, ""), new Header("if-match", ""), new Header(DownloadUtils.IF_MODIFIED_SINCE, ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header("refresh", ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
    ...
    private final Map<ByteString, Integer> nameToFirstIndex() {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (!linkedHashMap.containsKey(STATIC_HEADER_TABLE[i2].name)) {
    ...
    public static final class Reader {
        ...
        private final void clearDynamicTable() {
            f.a(this.dynamicTable, (Object) null, 0, 0, 6, (Object) null);
            this.nextHeaderIndex = this.dynamicTable.length - 1;
            this.headerCount = 0;
        ...
        private final void insertIntoDynamicTable(int index, Header entry) {
            ...
            if (index != -1) {
                i2 -= this.dynamicTable[dynamicTableIndex(index)].hpackSize;
            }
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> listD = s.d((Iterable) this.headerList);
        ...
        public final void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                if ((iAnd & 128) == 128) {
                    ...
                    this.maxDynamicTableByteCount = readInt(iAnd, 31);
                    int i2 = this.maxDynamicTableByteCount;
        ...
        public /* synthetic */ Reader(Source source, int i2, int i3, int i4, kotlin.jvm.internal.f fVar) {
