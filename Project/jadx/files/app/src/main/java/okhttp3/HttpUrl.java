...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public static final class Companion {
            ...
            public final int schemeDelimiterOffset(String input, int pos, int limit) {
                ...
                char cCharAt = input.charAt(pos);
                if ((i.a(cCharAt, 97) >= 0 && i.a(cCharAt, 122) <= 0) || (i.a(cCharAt, 65) >= 0 && i.a(cCharAt, 90) <= 0)) {
                    while (true) {
                        pos++;
                        if (pos >= limit) {
                            break;
        ...
        private final int effectivePort() {
            int i2 = this.port;
            return i2 != -1 ? i2 : HttpUrl.INSTANCE.defaultPort(this.scheme);
        }

        private final boolean isDot(String input) {
            return i.a((Object) input, (Object) ".") || n.b(input, "%2e", true);
        }

        private final boolean isDotDot(String input) {
            return i.a((Object) input, (Object) "..") || n.b(input, "%2e.", true) || n.b(input, ".%2e", true) || n.b(input, "%2e%2e", true);
        }
        ...
        private final void push(String input, int pos, int limit, boolean addTrailingSlash, boolean alreadyEncoded) {
            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, HttpUrl.PATH_SEGMENT_ENCODE_SET, alreadyEncoded, false, false, false, null, TbsListener.ErrorCode.TPATCH_VERSION_FAILED, null);
        ...
        private final void removeAllCanonicalQueryParameters(String canonicalName) {
            IntProgression intProgressionA = g.a(g.c(this.encodedQueryNamesAndValues.size() - 2, 0), 2);
            ...
            while (true) {
                if (i.a((Object) canonicalName, (Object) this.encodedQueryNamesAndValues.get(f20969s))) {
                    this.encodedQueryNamesAndValues.remove(f20969s + 1);
                    this.encodedQueryNamesAndValues.remove(f20969s);
        ...
        public final Builder addEncodedQueryParameter(@NotNull String encodedName, @Nullable String encodedValue) {
            ...
            this.encodedQueryNamesAndValues.add(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedName, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, 211, null));
            this.encodedQueryNamesAndValues.add(encodedValue != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedValue, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, 211, null) : null);
            return this;
        }
        ...
        public final Builder addQueryParameter(@NotNull String name, @Nullable String value) {
            ...
            this.encodedQueryNamesAndValues.add(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, TbsListener.ErrorCode.RENAME_EXCEPTION, null));
            this.encodedQueryNamesAndValues.add(value != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, value, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, TbsListener.ErrorCode.RENAME_EXCEPTION, null) : null);
            return this;
        }
        ...
        public final Builder parse$okhttp(@Nullable HttpUrl base, @NotNull String input) {
            ...
            if (iSchemeDelimiterOffset != -1) {
                if (n.a(input, "https:", iIndexOfFirstNonAsciiWhitespace$default, true)) {
                    this.scheme = "https";
                    iIndexOfFirstNonAsciiWhitespace$default += 6;
                } else {
                    if (!n.a(input, "http:", iIndexOfFirstNonAsciiWhitespace$default, true)) {
                        throw new IllegalArgumentException("Expected URL scheme 'http' or 'https' but was '" + input.substring(0, iSchemeDelimiterOffset) + "'");
                    }
                    this.scheme = "http";
            ...
            byte b3 = 35;
            if (iSlashCount >= 2 || base == null || (!i.a((Object) base.scheme(), (Object) this.scheme))) {
                ...
                while (true) {
                    ...
                    if (bCharAt != 64) {
                        ...
                        if (z2) {
                            ...
                            sb.append("%40");
                            i5 = iDelimiterOffset;
                            sb.append(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i6, iDelimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, TbsListener.ErrorCode.TPATCH_VERSION_FAILED, null));
                            this.encodedPassword = sb.toString();
                        } else {
                            int iDelimiterOffset2 = Util.delimiterOffset(input, ':', i6, iDelimiterOffset);
                            i4 = iIndexOfLastNonAsciiWhitespace$default;
                            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i6, iDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, TbsListener.ErrorCode.TPATCH_VERSION_FAILED, null);
                            if (z3) {
                            ...
                            if (iDelimiterOffset2 != iDelimiterOffset) {
                                this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset2 + 1, iDelimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, TbsListener.ErrorCode.TPATCH_VERSION_FAILED, null);
                                z2 = true;
                            }
                            i5 = iDelimiterOffset;
                            z3 = true;
                ...
                i3 = iDelimiterOffset;
                int iPortColonOffset = INSTANCE.portColonOffset(input, i6, i3);
                ...
                if (i7 < i3) {
                    ...
                    this.port = INSTANCE.parsePort(input, i7, i3);
                    if (!(this.port != -1)) {
                        throw new IllegalArgumentException(("Invalid URL port: \"" + input.substring(i7, i3) + '\"').toString());
                    }
                } else {
                    this.host = HostnamesKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.INSTANCE, input, i6, iPortColonOffset, false, 4, null));
                ...
                if (!(this.host != null)) {
                    throw new IllegalArgumentException(("Invalid URL host: \"" + input.substring(i6, iPortColonOffset) + '\"').toString());
                }
            } else {
                ...
                i2 = iIndexOfLastNonAsciiWhitespace$default;
                i3 = iIndexOfFirstNonAsciiWhitespace$default;
            }
            int i8 = i2;
            int iDelimiterOffset3 = Util.delimiterOffset(input, "?#", i3, i8);
            resolvePath(input, i3, iDelimiterOffset3);
            if (iDelimiterOffset3 < i8 && input.charAt(iDelimiterOffset3) == '?') {
                ...
                this.encodedQueryNamesAndValues = companion.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(companion, input, iDelimiterOffset3 + 1, iDelimiterOffset4, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, 208, null));
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            this.host = str != null ? new Regex("[\"<>^`{|}]").a(str, "") : null;
            int size = this.encodedPathSegments.size();
            for (int i2 = 0; i2 < size; i2++) {
                List<String> list = this.encodedPathSegments;
                list.set(i2, Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, list.get(i2), 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, true, true, false, false, null, TbsListener.ErrorCode.HOST_CONTEXT_IS_NULL, null));
            }
            List<String> list2 = this.encodedQueryNamesAndValues;
            if (list2 != null) {
            ...
            this.encodedFragment = str3 != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, str3, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET_URI, true, true, false, true, null, ISchedulers.SUB_STOP, null) : null;
            return this;
        }
        ...
        public final Builder removeAllQueryParameters(@NotNull String name) {
            ...
            removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, TbsListener.ErrorCode.RENAME_EXCEPTION, null));
            return this;
        }
        ...
        public final Builder scheme(@NotNull String scheme) {
            if (n.b(scheme, "http", true)) {
                this.scheme = "http";
            } else {
                if (!n.b(scheme, "https", true)) {
        ...
        */
        private final void writeCanonicalized(okio.Buffer r15, java.lang.String r16, int r17, int r18, java.lang.String r19, boolean r20, boolean r21, boolean r22, boolean r23, java.nio.charset.Charset r24) {
            ...
            L4c:
                ...
                r11 = 2
                r12 = r19
                boolean r8 = kotlin.text.f.a(r12, r8, r10, r11, r4)
                if (r8 != 0) goto L6a
                if (r7 != r9) goto L65
                if (r20 == 0) goto L6a
                if (r21 == 0) goto L65
        ...
        public final HttpUrl m250deprecated_get(@NotNull String url) {
            return get(url);
        }
        ...
        public final HttpUrl m253deprecated_parse(@NotNull String url) {
            return parse(url);
        }
        ...
        */
        public final java.lang.String canonicalize$okhttp(@org.jetbrains.annotations.NotNull java.lang.String r14, int r15, int r16, @org.jetbrains.annotations.NotNull java.lang.String r17, boolean r18, boolean r19, boolean r20, boolean r21, @org.jetbrains.annotations.Nullable java.nio.charset.Charset r22) {
            ...
            L18:
                ...
                r7 = 0
                r8 = r17
                boolean r1 = kotlin.text.f.a(r8, r1, r5, r6, r7)
                if (r1 != 0) goto L42
                r1 = 37
                if (r0 != r1) goto L34
                if (r18 == 0) goto L42
        ...
        public final List<String> toQueryNamesAndValues$okhttp(@NotNull String str) {
            ...
            int i2 = 0;
            while (i2 <= str.length()) {
                int iA = StringsKt__StringsKt.a((CharSequence) str, '&', i2, false, 4, (Object) null);
                if (iA == -1) {
                    iA = str.length();
                }
                int i3 = iA;
                int iA2 = StringsKt__StringsKt.a((CharSequence) str, '=', i2, false, 4, (Object) null);
                if (iA2 == -1 || iA2 > i3) {
                    arrayList.add(str.substring(i2, i3));
                    arrayList.add(null);
                } else {
                    arrayList.add(str.substring(i2, iA2));
                    arrayList.add(str.substring(iA2 + 1, i3));
                }
                i2 = i3 + 1;
            }
            return arrayList;
        ...
        public final void toQueryString$okhttp(@NotNull List<String> list, @NotNull StringBuilder sb) {
            IntProgression intProgressionA = g.a(g.d(0, list.size()), 2);
            int f20969s = intProgressionA.getF20969s();
            int f20970t = intProgressionA.getF20970t();
            int f20971u = intProgressionA.getF20971u();
            if (f20971u >= 0) {
            ...
            while (true) {
                String str = list.get(f20969s);
                String str2 = list.get(f20969s + 1);
                if (f20969s > 0) {
                    sb.append('&');
                }
                sb.append(str);
        ...
        @Nullable
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m252deprecated_get(@NotNull URL url) {
            return get(url);
        }
        ...
        @Nullable
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m251deprecated_get(@NotNull URI uri) {
            return get(uri);
        }
    ...
    public HttpUrl(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4, int i2, @NotNull List<String> list, @Nullable List<String> list2, @Nullable String str5, @NotNull String str6) {
        ...
        this.fragment = str5;
        this.url = str6;
        this.isHttps = i.a((Object) this.scheme, (Object) "https");
    }
    ...
    public final String m231deprecated_encodedFragment() {
    ...
    public final String m232deprecated_encodedPassword() {
    ...
    public final String m233deprecated_encodedPath() {
        return encodedPath();
    }
    ...
    public final List<String> m234deprecated_encodedPathSegments() {
    ...
    public final String m235deprecated_encodedQuery() {
        return encodedQuery();
    }
    ...
    public final String m236deprecated_encodedUsername() {
    ...
    public final List<String> m240deprecated_pathSegments() {
    ...
    public final int m241deprecated_pathSize() {
        return pathSize();
    }
    ...
    public final String m243deprecated_query() {
        return query();
    }
    ...
    public final Set<String> m244deprecated_queryParameterNames() {
    ...
    public final int m245deprecated_querySize() {
        return querySize();
    }
    ...
    public final URI m247deprecated_uri() {
        return uri();
    }
    ...
    public final URL m248deprecated_url() {
        return url();
    }
    ...
    public final String encodedFragment() {
        ...
        int iA = StringsKt__StringsKt.a((CharSequence) this.url, '#', 0, false, 6, (Object) null) + 1;
        String str = this.url;
        if (str != null) {
            return str.substring(iA);
        }
        throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
    }
    ...
    public final String encodedPassword() {
        ...
        int iA = StringsKt__StringsKt.a((CharSequence) this.url, ':', this.scheme.length() + 3, false, 4, (Object) null) + 1;
        int iA2 = StringsKt__StringsKt.a((CharSequence) this.url, '@', 0, false, 6, (Object) null);
        String str = this.url;
        if (str != null) {
            return str.substring(iA, iA2);
        }
        throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
    }
    ...
    public final String encodedPath() {
        int iA = StringsKt__StringsKt.a((CharSequence) this.url, '/', this.scheme.length() + 3, false, 4, (Object) null);
        String str = this.url;
        int iDelimiterOffset = Util.delimiterOffset(str, "?#", iA, str.length());
        String str2 = this.url;
        if (str2 != null) {
            return str2.substring(iA, iDelimiterOffset);
        }
        throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
    }
    ...
    public final List<String> encodedPathSegments() {
        ...
        while (iA < iDelimiterOffset) {
            ...
            arrayList.add(str2.substring(i2, iDelimiterOffset2));
            iA = iDelimiterOffset2;
        }
        return arrayList;
    }
    ...
    public final String encodedUsername() {
        ...
        String str2 = this.url;
        if (str2 != null) {
            return str2.substring(length, iDelimiterOffset);
        }
        throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
    }

    public boolean equals(@Nullable Object other) {
        return (other instanceof HttpUrl) && i.a((Object) ((HttpUrl) other).url, (Object) this.url);
    }
    ...
    public final String queryParameter(@NotNull String name) {
        ...
        if (f20971u < 0 ? f20969s >= f20970t : f20969s <= f20970t) {
            while (!i.a((Object) name, (Object) this.queryNamesAndValues.get(f20969s))) {
                if (f20969s != f20970t) {
                    f20969s += f20971u;
                }
            }
            return this.queryNamesAndValues.get(f20969s + 1);
        }
        return null;
    }
    ...
    public final Set<String> queryParameterNames() {
        ...
        IntProgression intProgressionA = g.a(g.d(0, this.queryNamesAndValues.size()), 2);
        int f20969s = intProgressionA.getF20969s();
        int f20970t = intProgressionA.getF20970t();
        int f20971u = intProgressionA.getF20971u();
        if (f20971u < 0 ? f20969s >= f20970t : f20969s <= f20970t) {
            while (true) {
                linkedHashSet.add(this.queryNamesAndValues.get(f20969s));
                if (f20969s == f20970t) {
                    break;
                }
                f20969s += f20971u;
    ...
    public final List<String> queryParameterValues(@NotNull String name) {
        ...
        if (f20971u < 0 ? f20969s >= f20970t : f20969s <= f20970t) {
            while (true) {
                if (i.a((Object) name, (Object) this.queryNamesAndValues.get(f20969s))) {
                    arrayList.add(this.queryNamesAndValues.get(f20969s + 1));
                }
                if (f20969s == f20970t) {
                    break;
                }
    ...
    public final URI uri() {
        ...
        try {
            ...
            try {
                return URI.create(new Regex("[\\u0000-\\u001F\\u007F-\\u009F\\p{javaWhitespace}]").a(string, ""));
