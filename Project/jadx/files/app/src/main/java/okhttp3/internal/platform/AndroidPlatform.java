...
public final class AndroidPlatform extends Platform {
    ...
    public static final /* data */ class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public String toString() {
            return "CustomTrustRootIndex(trustManager=" + this.trustManager + ", findByIssuerAndSignatureMethod=" + this.findByIssuerAndSignatureMethod + ad.f20406s;
        }
    }
