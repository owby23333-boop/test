...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> actualSSLSocketClass) {
            ...
            while (superclass != null && (!i.a((Object) superclass.getSimpleName(), (Object) "OpenSSLSocketImpl"))) {
        ...
        public final DeferredSocketAdapter.Factory factory(@NotNull final String packageName) {
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public boolean matchesSocket(@NotNull SSLSocket sslSocket) {
                    return n.b(sslSocket.getClass().getName(), packageName + '.', false, 2, null);
                }
            };
        }
    ...
    public AndroidSocketAdapter(@NotNull Class<? super SSLSocket> cls) {
        ...
        this.setUseSessionTickets = this.sslSocketClass.getDeclaredMethod("setUseSessionTickets", Boolean.TYPE);
    ...
    public String getSelectedProtocol(@NotNull SSLSocket sslSocket) {
        ...
        try {
            ...
            if (i.a((Object) e3.getMessage(), (Object) "ssl == null")) {
                return null;
            }
            throw e3;
