...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m290addInterceptor(@NotNull final l<? super Interceptor.Chain, Response> lVar) {
        ...
        public final Builder m291addNetworkInterceptor(@NotNull final l<? super Interceptor.Chain, Response> lVar) {
        ...
        public final Builder connectionSpecs(@NotNull List<ConnectionSpec> connectionSpecs) {
            if (!i.a(connectionSpecs, this.connectionSpecs)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder pingInterval(long interval, @NotNull TimeUnit unit) {
            this.pingInterval = Util.checkDuration(am.aU, interval, unit);
            return this;
        }

        @NotNull
        public final Builder protocols(@NotNull List<? extends Protocol> protocols) {
            List listA = s.a((Collection) protocols);
            if (!(listA.contains(Protocol.H2_PRIOR_KNOWLEDGE) || listA.contains(Protocol.HTTP_1_1))) {
                throw new IllegalArgumentException(("protocols must contain h2_prior_knowledge or http/1.1: " + listA).toString());
            }
            if (!(!listA.contains(Protocol.H2_PRIOR_KNOWLEDGE) || listA.size() <= 1)) {
                throw new IllegalArgumentException(("protocols containing h2_prior_knowledge cannot use other protocols: " + listA).toString());
            }
            if (!(!listA.contains(Protocol.HTTP_1_0))) {
                throw new IllegalArgumentException(("protocols must not contain http/1.0: " + listA).toString());
            }
            if (listA == null) {
            ...
            listA.remove(Protocol.SPDY_3);
            if (!i.a(listA, this.protocols)) {
                this.routeDatabase = null;
            }
            this.protocols = Collections.unmodifiableList(listA);
            return this;
        }
        ...
        public final Builder proxyAuthenticator(@NotNull Authenticator proxyAuthenticator) {
            if (!i.a(proxyAuthenticator, this.proxyAuthenticator)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder sslSocketFactory(@NotNull SSLSocketFactory sslSocketFactory) {
            ...
            if (x509TrustManagerTrustManager != null) {
                ...
                this.certificateChainCleaner = Platform.INSTANCE.get().buildCertificateChainCleaner(this.x509TrustManagerOrNull);
                return this;
            }
        ...
        public final Builder sslSocketFactory(@NotNull SSLSocketFactory sslSocketFactory, @NotNull X509TrustManager trustManager) {
            if ((!i.a(sslSocketFactory, this.sslSocketFactoryOrNull)) || (!i.a(trustManager, this.x509TrustManagerOrNull))) {
                this.routeDatabase = null;
            }
            this.sslSocketFactoryOrNull = sslSocketFactory;
        ...
        public Builder(@NotNull OkHttpClient okHttpClient) {
            ...
            p.a(this.interceptors, okHttpClient.interceptors());
            p.a(this.networkInterceptors, okHttpClient.networkInterceptors());
    ...
    public OkHttpClient(@NotNull Builder builder) {
        ...
        if (z2) {
            ...
            this.sslSocketFactoryOrNull = Platform.INSTANCE.get().newSslSocketFactory(this.x509TrustManager);
            this.certificateChainCleaner = CertificateChainCleaner.INSTANCE.get(this.x509TrustManager);
            this.certificatePinner = builder.getCertificatePinner().withCertificateChainCleaner$okhttp(this.certificateChainCleaner);
        }
        verifyClientState();
    }
    ...
    public final List<ConnectionSpec> m270deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public final List<Interceptor> m278deprecated_interceptors() {
        return this.interceptors;
    }
    ...
    public final List<Interceptor> m279deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final List<Protocol> m281deprecated_protocols() {
        return this.protocols;
    }
    ...
    public final SSLSocketFactory m288deprecated_sslSocketFactory() {
