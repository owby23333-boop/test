...
public final class CipherSuite {
    ...
    private static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
        ...
        public int compare(@NotNull String a, @NotNull String b) {
            ...
            for (int i2 = 4; i2 < iMin; i2++) {
                ...
                char cCharAt2 = b.charAt(i2);
                if (cCharAt != cCharAt2) {
                    return i.a(cCharAt, cCharAt2) < 0 ? -1 : 1;
                }
            }
            int length = a.length();
    ...
    @JvmField
    @NotNull
    public static final CipherSuite TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = INSTANCE.init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", TbsListener.ErrorCode.DOWNLOAD_CDN_URL_IS_NULL);
    ...
    @JvmField
    @NotNull
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = INSTANCE.init("TLS_RSA_WITH_SEED_CBC_SHA", TbsListener.ErrorCode.STARTDOWNLOAD_API_LEVEL_BELOW_FROYO);
    ...
    @JvmField
    @NotNull
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = INSTANCE.init("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", ISchedulers.SUB_STOP);
    ...
    @JvmField
    @NotNull
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_GCM_SHA384 = INSTANCE.init("TLS_DH_anon_WITH_AES_256_GCM_SHA384", ISchedulers.SUB_COMPLETE);
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String javaName) {
            if (n.b(javaName, "TLS_", false, 2, null)) {
                StringBuilder sb = new StringBuilder();
                sb.append("SSL_");
                if (javaName == null) {
                    throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
                }
                sb.append(javaName.substring(4));
                return sb.toString();
            }
            if (!n.b(javaName, "SSL_", false, 2, null)) {
                return javaName;
            }
            ...
            sb2.append(javaName.substring(4));
            return sb2.toString();
        }
