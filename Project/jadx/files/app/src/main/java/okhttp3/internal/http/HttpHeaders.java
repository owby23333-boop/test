...
public final class HttpHeaders {
    ...
    public static final List<Challenge> parseChallenges(@NotNull Headers headers, @NotNull String str) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            if (n.b(str, headers.name(i2), true)) {
                try {
    ...
    public static final boolean promisesBody(@NotNull Response response) {
        if (i.a((Object) response.request().method(), (Object) "HEAD")) {
            return false;
        }
        int iCode = response.code();
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && Util.headersContentLength(response) == -1 && !n.b(DownloadUtils.VALUE_CHUNKED, Response.header$default(response, DownloadUtils.TRANSFER_ENCODING, null, 2, null), true)) ? false : true;
    }
    ...
    */
    private static final void readChallengeHeader(okio.Buffer r7, java.util.List<okhttp3.Challenge> r8) throws java.io.EOFException {
        ...
        L1f:
            ...
            java.util.Map r0 = kotlin.collections.v.a()
            r7.<init>(r1, r0)
            r8.add(r7)
            return
        L2c:
        ...
        L41:
            ...
            r4.append(r3)
            java.lang.String r3 = "="
            java.lang.String r3 = kotlin.text.f.a(r3, r5)
            r4.append(r3)
