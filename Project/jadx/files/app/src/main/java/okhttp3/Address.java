...
public final class Address {
    ...
    public Address(@NotNull String str, int i2, @NotNull Dns dns, @NotNull SocketFactory socketFactory, @Nullable SSLSocketFactory sSLSocketFactory, @Nullable HostnameVerifier hostnameVerifier, @Nullable CertificatePinner certificatePinner, @NotNull Authenticator authenticator, @Nullable Proxy proxy, @NotNull List<? extends Protocol> list, @NotNull List<ConnectionSpec> list2, @NotNull ProxySelector proxySelector) {
        ...
        this.url = new HttpUrl.Builder().scheme(this.sslSocketFactory != null ? "https" : "http").host(str).port(i2).build();
    ...
    public final List<ConnectionSpec> m181deprecated_connectionSpecs() {
    ...
    public final List<Protocol> m184deprecated_protocols() {
    ...
    public final boolean equalsNonHost$okhttp(@NotNull Address that) {
        return i.a(this.dns, that.dns) && i.a(this.proxyAuthenticator, that.proxyAuthenticator) && i.a(this.protocols, that.protocols) && i.a(this.connectionSpecs, that.connectionSpecs) && i.a(this.proxySelector, that.proxySelector) && i.a(this.proxy, that.proxy) && i.a(this.sslSocketFactory, that.sslSocketFactory) && i.a(this.hostnameVerifier, that.hostnameVerifier) && i.a(this.certificatePinner, that.certificatePinner) && this.url.port() == that.url.port();
    }
