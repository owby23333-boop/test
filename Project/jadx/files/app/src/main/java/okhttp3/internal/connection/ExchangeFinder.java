...
public final class ExchangeFinder {
    ...
    */
    ...
    public final ExchangeCodec find(@NotNull OkHttpClient client, @NotNull RealInterceptorChain chain) {
        try {
            return findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis(), chain.getWriteTimeoutMillis(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !i.a((Object) chain.getRequest().method(), (Object) "GET")).newCodec$okhttp(client, chain);
    ...
    public final boolean sameHostAndPort(@NotNull HttpUrl url) {
        ...
        return url.port() == httpUrlUrl.port() && i.a((Object) url.host(), (Object) httpUrlUrl.host());
    }
