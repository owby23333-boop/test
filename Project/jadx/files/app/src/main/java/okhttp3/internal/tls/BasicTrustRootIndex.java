...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public boolean equals(@Nullable Object other) {
        return other == this || ((other instanceof BasicTrustRootIndex) && i.a(((BasicTrustRootIndex) other).subjectToCaCerts, this.subjectToCaCerts));
    }
