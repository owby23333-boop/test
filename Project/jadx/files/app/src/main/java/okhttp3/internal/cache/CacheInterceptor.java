...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if ((!n.b("Warning", strName, true) || !n.b(strValue, "1", false, 2, null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isContentSpecificHeader(String fieldName) {
            return n.b("Content-Length", fieldName, true) || n.b("Content-Encoding", fieldName, true) || n.b("Content-Type", fieldName, true);
        }

        private final boolean isEndToEnd(String fieldName) {
            return (n.b("Connection", fieldName, true) || n.b(c.f10570c, fieldName, true) || n.b("Proxy-Authenticate", fieldName, true) || n.b(HttpRequest.HEADER_PROXY_AUTHORIZATION, fieldName, true) || n.b("TE", fieldName, true) || n.b("Trailers", fieldName, true) || n.b(DownloadUtils.TRANSFER_ENCODING, fieldName, true) || n.b("Upgrade", fieldName, true)) ? false : true;
        }
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        if (networkRequest == null && cacheResponse == null) {
            Response responseBuild = new Response.Builder().request(chain.request()).protocol(Protocol.HTTP_1_1).code(TbsListener.ErrorCode.INFO_CODE_MINIQB_STARTMINIQBTOLOADURL_FAILED).message("Unsatisfiable Request (only-if-cached)").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1L).receivedResponseAtMillis(System.currentTimeMillis()).build();
