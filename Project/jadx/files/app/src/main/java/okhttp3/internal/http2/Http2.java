...
public final class Http2 {
    ...
    static {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            strArr[i2] = n.a(Util.format("%8s", Integer.toBinaryString(i2)), ' ', '0', false, 4, (Object) null);
        }
        BINARY = strArr;
        ...
        for (int i3 : iArr) {
            ...
            strArr3[i3 | 8] = i.a(strArr3[i3], (Object) "|PADDED");
        }
        ...
        for (int i4 : new int[]{4, 32, 36}) {
            for (int i5 : iArr) {
                int i6 = i5 | i4;
                FLAGS[i6] = FLAGS[i5] + a.bQ + FLAGS[i4];
                FLAGS[i6 | 8] = FLAGS[i5] + a.bQ + FLAGS[i4] + "|PADDED";
            }
        }
    ...
    public final String formatFlags(int type, int flags) {
        ...
        if (type != 2 && type != 3) {
            ...
            if (type != 7 && type != 8) {
                ...
                return (type != 5 || (flags & 4) == 0) ? (type != 0 || (flags & 32) == 0) ? str : n.a(str, "PRIORITY", "COMPRESSED", false, 4, (Object) null) : n.a(str, "HEADERS", "PUSH_PROMISE", false, 4, (Object) null);
            }
        }
        return BINARY[flags];
    }
