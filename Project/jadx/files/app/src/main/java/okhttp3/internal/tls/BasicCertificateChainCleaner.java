...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    private final boolean verifySignature(X509Certificate toVerify, X509Certificate signingCert) {
        if (!i.a(toVerify.getIssuerDN(), signingCert.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public List<Certificate> clean(@NotNull List<? extends Certificate> chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        for (int i2 = 0; i2 < 9; i2++) {
            ...
            if (arrayList.size() > 1 || (!i.a(x509Certificate, x509CertificateFindByIssuerAndSignature))) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof BasicCertificateChainCleaner) && i.a(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex);
    }
