...
public class AgooService extends TaoBaseService {
    ...
    public void onCreate() {
        ...
        this.f21269c = new AgooFactory();
        this.f21269c.init(getApplicationContext(), null, null);
    }
    ...
    public void onData(String str, String str2, String str3, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
        ...
        k.a("accs", BaseMonitor.COUNT_AGOO_TOTAL_ARRIVE, "total_arrive", PangleAdapterUtils.CPM_DEFLAUT_VALUE);
        try {
            this.f21269c.saveMsg(bArr);
            this.f21269c.msgRecevie(bArr, "accs", extraInfo);
        } catch (Throwable th) {
    ...
    public void onResponse(String str, String str2, int i2, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (i2 == 200 && TextUtils.equals(str, AgooConstants.AGOO_SERVICE_AGOOACK)) {
            ...
            this.f21269c.updateMsg(bArr, true);
        } else {
            if (i2 != 200 && TextUtils.equals(str, AgooConstants.AGOO_SERVICE_AGOOACK)) {
                if (ALog.isPrintLog(ALog.Level.E)) {
                ...
                k.a("accs", BaseMonitor.COUNT_AGOO_FAIL_ACK, String.valueOf(i2), PangleAdapterUtils.CPM_DEFLAUT_VALUE);
                return;
            }
            if (ALog.isPrintLog(ALog.Level.E)) {
    ...
    public void onSendData(String str, String str2, int i2, TaoBaseService.ExtraInfo extraInfo) {
        try {
            ...
            if (TextUtils.equals(AgooConstants.AGOO_SERVICE_AGOOACK, str)) {
                k.a("accs", BaseMonitor.COUNT_AGOO_SUCCESS_ACK, "8/9", PangleAdapterUtils.CPM_DEFLAUT_VALUE);
            }
    ...
    public void onUnbind(String str, int i2, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (b != null && GlobalClientInfo.AGOO_SERVICE_ID.equals(str)) {
            if (i2 == 200) {
                ...
                b.onFailure(String.valueOf(i2), "unbind Agoo service fail");
            }
        }
        b = null;
    }
