...
public class IndependentProcessDownloadHandler implements IDownloadProxy, IDownloadServiceConnectionListener {
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.IDownloadProxy
    public void addDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2) {
        if (this.aidlService == null) {
            return;
        }
        try {
            this.aidlService.addDownloadListener(i2, i3, IPCUtils.convertListenerToAidl(iDownloadListener, listenerType != ListenerType.SUB), listenerType.ordinal(), z2);
        } catch (RemoteException e2) {
            e2.printStackTrace();
        }
    }
    ...
    public void clearDownloadData(int i2, boolean z2) {
        if (this.aidlService == null) {
            this.downloadProxy.clearDownloadData(i2, z2);
            return;
        }
        try {
            this.aidlService.clearDownloadData(i2, z2);
        } catch (RemoteException e2) {
            e2.printStackTrace();
        }
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.IDownloadProxy
    public void removeDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2) {
        if (this.aidlService == null) {
            return;
        }
        try {
            this.aidlService.removeDownloadListener(i2, i3, IPCUtils.convertListenerToAidl(iDownloadListener, listenerType != ListenerType.SUB), listenerType.ordinal(), z2);
        } catch (RemoteException e2) {
            e2.printStackTrace();
        }
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.IDownloadProxy
    public void resetDownloadData(int i2, boolean z2) {
        if (this.aidlService == null) {
            this.downloadProxy.resetDownloadData(i2, z2);
            return;
        }
        try {
            this.aidlService.resetDownloadData(i2, z2);
        } catch (RemoteException e2) {
            e2.printStackTrace();
        }
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.IDownloadProxy
    public void setDownloadWithIndependentProcessStatus(int i2, boolean z2) {
        if (this.aidlService == null) {
            return;
        }
        try {
            this.aidlService.setDownloadWithIndependentProcessStatus(i2, z2);
        } catch (RemoteException e2) {
            e2.printStackTrace();
        }
    }
    ...
    public void stopForeground(boolean z2, boolean z3) {
        ...
        try {
            this.aidlService.stopForeground(z3);
        } catch (RemoteException e2) {
            e2.printStackTrace();
        }
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.IDownloadProxy
    public void addDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2, boolean z3) {
        if (this.aidlService == null) {
            return;
        }
        try {
            this.aidlService.addDownloadListener1(i2, i3, IPCUtils.convertListenerToAidl(iDownloadListener, listenerType != ListenerType.SUB), listenerType.ordinal(), z2, z3);
        } catch (RemoteException e2) {
            e2.printStackTrace();
        }
    }
