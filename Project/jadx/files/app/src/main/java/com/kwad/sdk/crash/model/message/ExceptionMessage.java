...
public abstract class ExceptionMessage implements b, Serializable {
    ...
    public JSONObject toJson() {
        ...
        s.putValue(jSONObject, "mCrashDetail", this.mCrashDetail);
        s.putValue(jSONObject, "mMemoryInfo", this.mMemoryInfo);
        s.putValue(jSONObject, "mDiskInfo", this.mDiskInfo);
        s.putValue(jSONObject, "mProcessName", this.mProcessName);
        s.putValue(jSONObject, "mCrashType", this.mCrashType);
        s.putValue(jSONObject, "mThreadName", this.mThreadName);
        s.putValue(jSONObject, "mIsAppOnForeground", this.mIsAppOnForeground);
        s.putValue(jSONObject, "mLogUUID", this.mLogUUID);
        s.putValue(jSONObject, "mVirtualApp", this.mVirtualApp);
        s.putValue(jSONObject, "mCustomMsg", this.mCustomMsg);
        s.putValue(jSONObject, "mThreadOverflow", this.mThreadOverflow);
        s.putValue(jSONObject, "mFdOverflow", this.mFdOverflow);
        s.putValue(jSONObject, "mTaskId", this.mTaskId);
        s.putValue(jSONObject, "mErrorMessage", this.mErrorMessage);
        s.putValue(jSONObject, "mCurrentTimeStamp", this.mCurrentTimeStamp);
        s.putValue(jSONObject, "mUsageTimeMills", this.mUsageTimeMills);
        s.putValue(jSONObject, "mPid", this.mPid);
        s.putValue(jSONObject, "mTid", this.mTid);
        s.putValue(jSONObject, "mVersionCode", this.mVersionCode);
        s.putValue(jSONObject, "mVersionConflict", this.mVersionConflict);
        s.putValue(jSONObject, "mAppVersionBeforeLastUpload", this.mAppVersionBeforeLastUpload);
        s.putValue(jSONObject, "mJNIError", this.mJNIError);
        s.putValue(jSONObject, "mGCInfo", this.mGCInfo);
        s.putValue(jSONObject, "mLockInfo", this.mLockInfo);
        s.putValue(jSONObject, "mMonitorInfo", this.mMonitorInfo);
        s.putValue(jSONObject, "mSlowLooper", this.mSlowLooper);
        s.putValue(jSONObject, "mSlowOperation", this.mSlowOperation);
        s.putValue(jSONObject, "mBuildConfigInfo", this.mBuildConfigInfo);
        s.putValue(jSONObject, "mAbi", this.mAbi);
        s.putValue(jSONObject, "mDumpsys", this.mDumpsys);
        s.putValue(jSONObject, "mCrashSource", this.mCrashSource);
        return jSONObject;
    }
