...
public class DownloadInfo implements Parcelable {
    ...
    private void convertRetryDelayStatus(int i2) {
        if (i2 == RetryDelayStatus.DELAY_RETRY_WAITING.ordinal()) {
            this.retryDelayStatus = RetryDelayStatus.DELAY_RETRY_WAITING;
            return;
        }
        if (i2 == RetryDelayStatus.DELAY_RETRY_DOWNLOADING.ordinal()) {
            this.retryDelayStatus = RetryDelayStatus.DELAY_RETRY_DOWNLOADING;
        } else if (i2 == RetryDelayStatus.DELAY_RETRY_DOWNLOADED.ordinal()) {
    ...
    private void refreshBackupUrls(boolean z2) {
        ...
        for (?? r3 = z2; r3 < this.forbiddenBackupUrls.size(); r3++) {
    ...
    public synchronized void handleTempSaveCallback(boolean z2, BaseException baseException) {
        ...
        Logger.d(TAG, "handleTempSaveCallback isSuccess " + z2 + " callback size:" + this.tempFileSaveCompleteCallbacks.size());
    ...
    public void setSavePathRedirected(boolean z2) {
        safePutToDBJsonData(DbJsonConstants.DBJSON_KEY_IS_SAVE_PATH_REDIRECTED, Boolean.valueOf(z2));
    }
    ...
    public void updateCurRetryTime(int i2) {
        this.curRetryTime = (this.backUpUrlUsed ? this.backUpUrlRetryCount : this.retryCount) - i2;
    ...
    public static class Builder {
        ...
        public Builder addListenerToSameTask(boolean z2) {
            this.addListenerToSameTask = z2;
            return this;
        }

        public Builder autoResumed(boolean z2) {
            this.autoResumed = z2;
            return this;
        }
        ...
        public Builder deleteCacheIfCheckFailed(boolean z2) {
            this.deleteCacheIfCheckFailed = z2;
            return this;
        }

        public Builder distinctDirectory(boolean z2) {
            this.distinctDirectory = z2;
            return this;
        }
        ...
        public Builder expiredRedownload(boolean z2) {
            this.expiredRedownload = z2;
            return this;
        }
        ...
        public Builder headConnectionAvailable(boolean z2) {
            this.headConnectionAvailable = z2;
            return this;
        }
        ...
        public Builder ignoreDataVerify(boolean z2) {
            this.ignoreDataVerify = z2;
            return this;
        }

        public Builder isOpenLimitSpeed(boolean z2) {
            this.openLimitSpeed = z2;
            return this;
        }
        ...
        public Builder needChunkDowngradeRetry(boolean z2) {
            this.needChunkDowngradeRetry = z2;
            return this;
        }

        public Builder needDefaultHttpServiceBackUp(boolean z2) {
            this.needDefaultHttpServiceBackUp = z2;
            return this;
        }

        public Builder needHttpsToHttpRetry(boolean z2) {
            this.needHttpsToHttpRetry = z2;
            return this;
        }

        public Builder needIndependentProcess(boolean z2) {
            this.needIndependentProcess = z2;
            return this;
        }

        public Builder needPostProgress(boolean z2) {
            this.needPostProgress = z2;
            return this;
        }

        public Builder needRetryDelay(boolean z2) {
            this.needRetryDelay = z2;
            return this;
        }

        public Builder needReuseChunkRunnable(boolean z2) {
            this.needReuseChunkRunnable = z2;
            return this;
        }

        public Builder needReuseFirstConnection(boolean z2) {
            this.needReuseFirstConnection = z2;
            return this;
        }

        public Builder needSDKMonitor(boolean z2) {
            this.needSDKMonitor = z2;
            return this;
        }

        public Builder onlyWifi(boolean z2) {
            this.onlyWifi = z2;
            return this;
        }
        ...
        public Builder showNotificationForAutoResumed(boolean z2) {
            this.showNotificationForAutoResumed = z2;
            return this;
        }
    ...
    private DownloadInfo(Builder builder) {
        ...
        if (TextUtils.isEmpty(this.tempPath) && !DownloadUtils.isSavePathSecurity(downloadPath)) {
    ...
    public DownloadInfo(Cursor cursor) {
        ...
        try {
            ...
            if (columnIndex27 != -1) {
                ...
                if (i2 == RetryDelayStatus.DELAY_RETRY_WAITING.ordinal()) {
                    this.retryDelayStatus = RetryDelayStatus.DELAY_RETRY_WAITING;
                } else if (i2 == RetryDelayStatus.DELAY_RETRY_DOWNLOADING.ordinal()) {
                    this.retryDelayStatus = RetryDelayStatus.DELAY_RETRY_DOWNLOADING;
                } else if (i2 == RetryDelayStatus.DELAY_RETRY_DOWNLOADED.ordinal()) {
                    this.retryDelayStatus = RetryDelayStatus.DELAY_RETRY_DOWNLOADED;
                } else {
