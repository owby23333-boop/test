...
public abstract class GenerateProxyAppCompatActivity extends AppCompatActivity implements b {
    ...
    public boolean moveTaskToBack(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        return generatePluginAppCompatActivity != null ? generatePluginAppCompatActivity.moveTaskToBack(z2) : super.moveTaskToBack(z2);
    }
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i2, boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onApplyThemeResource(theme, i2, z2);
        } else {
    ...
    public void onMultiWindowModeChanged(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onMultiWindowModeChanged(z2);
        } else {
    ...
    public void onPictureInPictureModeChanged(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onPictureInPictureModeChanged(z2);
        } else {
    ...
    public void onTopResumedActivityChanged(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onTopResumedActivityChanged(z2);
        } else {
    ...
    public void onWindowFocusChanged(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onWindowFocusChanged(z2);
        } else {
    ...
    public boolean requestVisibleBehind(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        return generatePluginAppCompatActivity != null ? generatePluginAppCompatActivity.requestVisibleBehind(z2) : super.requestVisibleBehind(z2);
    }
    ...
    public void setFinishOnTouchOutside(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setFinishOnTouchOutside(z2);
        } else {
    ...
    public void setImmersive(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setImmersive(z2);
        } else {
    ...
    public void setInheritShowWhenLocked(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setInheritShowWhenLocked(z2);
        } else {
    ...
    public void setShowWhenLocked(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setShowWhenLocked(z2);
        } else {
    ...
    public boolean setTranslucent(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        return generatePluginAppCompatActivity != null ? generatePluginAppCompatActivity.setTranslucent(z2) : super.setTranslucent(z2);
    }
    ...
    public void setTurnScreenOn(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setTurnScreenOn(z2);
        } else {
    ...
    public void setVisible(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setVisible(z2);
        } else {
            super.setVisible(z2);
        }
    }
    ...
    public void setVrModeEnabled(boolean z2, ComponentName componentName) throws PackageManager.NameNotFoundException {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.setVrModeEnabled(z2, componentName);
        } else {
    ...
    public void startSearch(String str, boolean z2, Bundle bundle, boolean z3) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startSearch(str, z2, bundle, z3);
        } else {
    ...
    public void takeKeyEvents(boolean z2) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.takeKeyEvents(z2);
        } else {
    ...
    public boolean zeusSuperMoveTaskToBack(boolean z2) {
    ...
    protected void zeusSuperOnApplyThemeResource(Resources.Theme theme, int i2, boolean z2) {
        super.onApplyThemeResource(theme, i2, z2);
    }
    ...
    public void zeusSuperOnMultiWindowModeChanged(boolean z2) {
        super.onMultiWindowModeChanged(z2);
    }
    ...
    public void zeusSuperOnPictureInPictureModeChanged(boolean z2) {
        super.onPictureInPictureModeChanged(z2);
    }
    ...
    public void zeusSuperOnTopResumedActivityChanged(boolean z2) {
        super.onTopResumedActivityChanged(z2);
    }
    ...
    public void zeusSuperOnWindowFocusChanged(boolean z2) {
        super.onWindowFocusChanged(z2);
    }
    ...
    public boolean zeusSuperRequestVisibleBehind(boolean z2) {
    ...
    public void zeusSuperSetFinishOnTouchOutside(boolean z2) {
        super.setFinishOnTouchOutside(z2);
    }

    public void zeusSuperSetImmersive(boolean z2) {
        super.setImmersive(z2);
    }

    public void zeusSuperSetInheritShowWhenLocked(boolean z2) {
        super.setInheritShowWhenLocked(z2);
    }
    ...
    public void zeusSuperSetShowWhenLocked(boolean z2) {
        super.setShowWhenLocked(z2);
    }
    ...
    public boolean zeusSuperSetTranslucent(boolean z2) {
        return super.setTranslucent(z2);
    }

    public void zeusSuperSetTurnScreenOn(boolean z2) {
        super.setTurnScreenOn(z2);
    }

    public void zeusSuperSetVisible(boolean z2) {
        super.setVisible(z2);
    }

    public void zeusSuperSetVrModeEnabled(boolean z2, ComponentName componentName) {
        super.setVrModeEnabled(z2, componentName);
    }
    ...
    public void zeusSuperStartSearch(String str, boolean z2, Bundle bundle, boolean z3) {
        super.startSearch(str, z2, bundle, z3);
    }
    ...
    public void zeusSuperTakeKeyEvents(boolean z2) {
        super.takeKeyEvents(z2);
    }
    ...
    public void zeusSuperOnMultiWindowModeChanged(boolean z2, Configuration configuration) {
        super.onMultiWindowModeChanged(z2, configuration);
    }

    public void zeusSuperOnPictureInPictureModeChanged(boolean z2, Configuration configuration) {
    ...
    public void onMultiWindowModeChanged(boolean z2, Configuration configuration) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onMultiWindowModeChanged(z2, configuration);
        } else {
            super.onMultiWindowModeChanged(z2, configuration);
        }
    }
    ...
    public void onPictureInPictureModeChanged(boolean z2, Configuration configuration) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onPictureInPictureModeChanged(z2, configuration);
        } else {
            super.onPictureInPictureModeChanged(z2, configuration);
        }
    }
