...
public class e extends ContextThemeWrapper {
    ...
    public String[] databaseList() {
        ...
        boolean[] zArr = new boolean[strArrDatabaseList.length];
        int i2 = 0;
    ...
    public SQLiteDatabase openOrCreateDatabase(String str, int i2, SQLiteDatabase.CursorFactory cursorFactory, DatabaseErrorHandler databaseErrorHandler) {
        return (i2 != 0 || getPluginDirName() == null) ? super.openOrCreateDatabase(str, i2, cursorFactory, databaseErrorHandler) : super.openOrCreateDatabase(makeSubName(str), i2, cursorFactory, databaseErrorHandler);
    }
}
