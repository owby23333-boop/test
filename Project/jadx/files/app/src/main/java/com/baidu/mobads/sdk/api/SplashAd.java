...
public class SplashAd {
    ...
    public String getBiddingToken() {
        ...
        float fE = ax.e(this.mContext);
        Rect rectA = ax.a(this.mContext);
        ...
        this.mAdProd = new dn(this.mContext, this.mAdPlaceId, i3, i2, this.mTipStyle, this.mTimeout, this.mDisplayDownInfo, this.mPopDialogIfDL.booleanValue(), this.mDisplayClickRegion.booleanValue(), this.mLimitRegionClick.booleanValue());
        this.mAdProd.a(this.mShakeLogoSize);
        this.mAdProd.g(this.mAppSid);
        dn dnVar2 = this.mAdProd;
        dnVar2.f12903p = this.mBidFloor;
        dnVar2.a = true;
        RequestParameters requestParameters2 = this.mParameter;
        if (requestParameters2 != null) {
            dnVar2.a(requestParameters2);
        }
    ...
    public String getECPMLevel() {
        a aVarG;
        dn dnVar = this.mAdProd;
        return (dnVar == null || (aVarG = dnVar.g()) == null) ? "" : aVarG.z();
    }

    public boolean isReady() {
        IAdInterListener iAdInterListener;
        dn dnVar = this.mAdProd;
        if (dnVar == null || (iAdInterListener = dnVar.f12898k) == null) {
            return false;
        }
    ...
    public void loadAndShow(ViewGroup viewGroup) {
        ...
        coVar.a(new co.a() { // from class: com.baidu.mobads.sdk.api.SplashAd.3
            ...
            public void onLayoutComplete(int i2, int i3) {
                ...
                float fE = ax.e(SplashAd.this.mContext);
                if (SplashAd.this.mParameter != null && SplashAd.this.mParameter.isCustomSize()) {
                    if (SplashAd.this.mParameter.getWidth() > 0) {
                        i2 = (int) (SplashAd.this.mParameter.getWidth() * fE);
                    }
                    if (SplashAd.this.mParameter.getHeight() > 0) {
                        i3 = (int) (SplashAd.this.mParameter.getHeight() * fE);
                    }
                }
                int i4 = i2;
                int i5 = i3;
                if (i4 < 200.0f * fE || i5 < fE * 150.0f) {
                    bq.a().c(da.a().a(bm.SHOW_STANDARD_UNFIT, "开屏显示区域太小,宽度至少200dp,高度至少150dp"));
                ...
                splashAd.mAdProd = new dn(splashAd.mContext, SplashAd.this.mAdPlaceId, i4, i5, SplashAd.this.mTipStyle, SplashAd.this.mTimeout, SplashAd.this.mDisplayDownInfo, SplashAd.this.mPopDialogIfDL.booleanValue(), SplashAd.this.mDisplayClickRegion.booleanValue(), SplashAd.this.mLimitRegionClick.booleanValue());
                SplashAd.this.mAdProd.a(coVar);
                SplashAd.this.mAdProd.a(SplashAd.this.mShakeLogoSize);
                SplashAd.this.mAdProd.g(SplashAd.this.mAppSid);
                SplashAd.this.mAdProd.f12903p = SplashAd.this.mBidFloor;
    ...
    public SplashAd(Context context, String str, RequestParameters requestParameters, SplashAdListener splashAdListener) {
        ...
        RequestParameters requestParameters2 = this.mParameter;
        if (requestParameters2 == null || requestParameters2.getExtras() == null) {
            return;
        }
