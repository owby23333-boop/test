...
public class ExpressInterstitialAd {
    ...
    private void initNativeInterstitialAdProd() {
        ...
        if (!TextUtils.isEmpty(this.mAppsid)) {
            this.mNativeInterstitialAdProd.f12902o = this.mAppsid;
        }
        db dbVar = this.mNativeInterstitialAdProd;
        dbVar.f12903p = this.mBidFloor;
        dbVar.f13066q = this.onlyFetchAd;
    ...
    public String getECPMLevel() {
        a aVarW;
        db dbVar = this.mNativeInterstitialAdProd;
        return (dbVar == null || (aVarW = dbVar.w()) == null) ? "" : aVarW.z();
    }

    public boolean isReady() {
        IAdInterListener iAdInterListener;
        db dbVar = this.mNativeInterstitialAdProd;
        if (dbVar == null || (iAdInterListener = dbVar.f12898k) == null) {
            return false;
        }
