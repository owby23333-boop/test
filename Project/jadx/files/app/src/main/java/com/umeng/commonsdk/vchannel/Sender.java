...
public class Sender {
    ...
    public static void handleEvent(Context context, b bVar) {
        ...
        try {
            ...
            UMEnvelopeBuild.buildEnvelopeWithExtHeader(context, jSONObject, jSONObject2, a.f20239c, "v", "1.0.0");
        } catch (Throwable th) {
    ...
    public static void onEvent(Context context, String str, Map<String, Object> map) {
        ...
        bVar.a(map);
        try {
            UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f19983o, com.umeng.commonsdk.internal.b.a(context).a(), bVar);
        } catch (Throwable unused) {
        }
