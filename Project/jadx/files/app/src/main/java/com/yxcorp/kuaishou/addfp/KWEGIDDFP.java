...
public class KWEGIDDFP {
    ...
    private void getEGidImpl(boolean z2) {
        Object obj;
        try {
        ...
        if (TextUtils.isEmpty(this.mEgid)) {
            try {
                ...
                String strA2 = (TextUtils.isEmpty(strA) && g.a(this.mParamContext, new String[]{com.kuaishou.weapon.p0.g.f16729i, "android.permission.WRITE_EXTERNAL_STORAGE"})) ? d.a(this.mParamContext).a("Lm91a2R0ZnQ=") : "";
    ...
    public void getEGidByCallback(Context context, boolean z2, ResponseDfpCallback responseDfpCallback) {
        try {
