...
public class b {
    ...
    final class AnonymousClass2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), b.f8409c);
                if (file.exists()) {
                    file.delete();
                }
                m.a(this.a.getBytes(), file);
            } catch (Exception e2) {
                o.a(b.a, e2.getMessage());
            }
        }
    }
    ...
    private static String e() {
        try {
            File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), f8409c);
            ...
            if (aVarB != null && !TextUtils.isEmpty(aVarB.M())) {
                ...
                if (contextD != null) {
                    ...
                    if (TextUtils.isEmpty(strA) || !strA.equals(strM)) {
                        try {
                            new com.anythink.expressad.d.a.a(contextD).a(strM, (com.anythink.expressad.foundation.g.f.h.b) null, new AnonymousClass1(strM));
                        } catch (Exception e2) {
                            o.d(a, e2.getMessage());
                        }
                    }
