...
public final class f extends b implements bk.a {
    private bk gH;
    ...
    private int kP;
    private HorizontalSwipeLayout kz;
    ...
    private c.a jw = new c.a() { // from class: com.kwad.components.ad.interstitial.c.f.1
        @Override // com.kwad.components.ad.interstitial.c.c.a
        public final void cr() {
            f.this.jA.removeAllViews();
            f.this.dD();
            f.this.jA.setVisibility(8);
            f.this.kz.b(f.this.kR);
        }
    };
    private Runnable kQ = new AnonymousClass3();
    private HorizontalSwipeLayout.a kR = new HorizontalSwipeLayout.a() { // from class: com.kwad.components.ad.interstitial.c.f.4
        ...
        public final void dI() {
            ...
            f.this.jA.setTranslationX(com.kwad.sdk.b.kwai.a.getScreenWidth(f.this.mContext));
            f.this.jq.cY();
            f.this.kz.b(f.this.kR);
        }
        ...
        public final void dJ() {
            ...
            f.this.dD();
            f.this.jA.setAllCorner(false);
            f.this.mLandingPageView.requestLayout();
            f.this.jA.requestLayout();
            com.kwad.sdk.core.report.a.a(f.this.mAdTemplate, 74, (ab.a) null);
            f.this.jq.cZ();
        }
    };
    private com.kwad.sdk.core.webview.c.kwai.b mWebCardCloseListener = new com.kwad.sdk.core.webview.c.kwai.b() { // from class: com.kwad.components.ad.interstitial.c.f.5
        @Override // com.kwad.sdk.core.webview.c.kwai.b
        public final void a(WebCloseStatus webCloseStatus) {
            f.this.jq.hR.dismiss();
        }
    };
    private com.kwad.components.core.page.kwai.a mLandPageViewListener = new com.kwad.components.core.page.kwai.a() { // from class: com.kwad.components.ad.interstitial.c.f.6
    ...
    /* JADX INFO: renamed from: com.kwad.components.ad.interstitial.c.f$3, reason: invalid class name */
    final class AnonymousClass3 implements Runnable {
        ...
        public final void run() {
            f.this.b(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.interstitial.c.f.3.1
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public final void onAnimationCancel(Animator animator) {
                    super.onAnimationCancel(animator);
                    f.this.jA.setTranslationX(com.kwad.sdk.b.kwai.a.getScreenWidth(f.this.mContext));
                    f.this.kA.setTranslationX(com.kwad.sdk.b.kwai.a.a(f.this.mContext, 500.0f));
                    f.this.kB.setTranslationX(com.kwad.sdk.b.kwai.a.a(f.this.mContext, 140.0f));
                    f.this.kA.setAlpha(1.0f);
                    f.this.kB.setAlpha(1.0f);
                    f.this.kC.setVisibility(8);
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public final void onAnimationEnd(Animator animator) {
                    super.onAnimationEnd(animator);
                    f.this.a(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.interstitial.c.f.3.1.1
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    public void a(Animator.AnimatorListener animatorListener) {
        ...
        this.kM = ObjectAnimator.ofFloat(this.jA, View.TRANSLATION_X.getName(), com.kwad.sdk.b.kwai.a.getScreenWidth(this.mContext) - com.kwad.sdk.b.kwai.a.a(this.mContext, 45.0f), com.kwad.sdk.b.kwai.a.getScreenWidth(this.mContext) - com.kwad.sdk.b.kwai.a.a(this.mContext, 30.0f), com.kwad.sdk.b.kwai.a.getScreenWidth(this.mContext) - com.kwad.sdk.b.kwai.a.a(this.mContext, 45.0f));
        this.kM.setDuration(1200L);
        this.kM.setRepeatMode(1);
        this.kM.setRepeatCount(-1);
        this.kM.addListener(animatorListener);
        this.kM.start();
        this.kN = ObjectAnimator.ofFloat(this.kA, View.TRANSLATION_X.getName(), com.kwad.sdk.b.kwai.a.a(this.mContext, 322.0f), com.kwad.sdk.b.kwai.a.a(this.mContext, 500.0f), com.kwad.sdk.b.kwai.a.a(this.mContext, 322.0f));
    ...
    public void b(Animator.AnimatorListener animatorListener) {
        ...
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.jA, View.TRANSLATION_X.getName(), com.kwad.sdk.b.kwai.a.getScreenWidth(this.mContext), com.kwad.sdk.b.kwai.a.getScreenWidth(this.mContext) - com.kwad.sdk.b.kwai.a.a(this.mContext, 45.0f));
        objectAnimatorOfFloat.setDuration(300L);
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(this.kA, View.TRANSLATION_X.getName(), com.kwad.sdk.b.kwai.a.a(this.mContext, 500.0f), com.kwad.sdk.b.kwai.a.a(this.mContext, 322.0f));
        ...
        ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(this.kB, View.TRANSLATION_X.getName(), com.kwad.sdk.b.kwai.a.a(this.mContext, 140.0f), com.kwad.sdk.b.kwai.a.a(this.mContext, 0.0f));
    ...
    private void dE() {
        ...
        this.kA.setTranslationX(com.kwad.sdk.b.kwai.a.a(this.mContext, 500.0f));
        this.kB.setTranslationX(com.kwad.sdk.b.kwai.a.a(this.mContext, 140.0f));
    ...
    private void initContentView() {
        ...
        this.jA.setTranslationX(com.kwad.sdk.b.kwai.a.getScreenWidth(this.mContext));
        this.kA.setTranslationX(com.kwad.sdk.b.kwai.a.a(this.mContext, 500.0f));
        this.kB.setTranslationX(com.kwad.sdk.b.kwai.a.a(this.mContext, 140.0f));
        this.kC.setVisibility(8);
        this.kH.setOnClickListener(new View.OnClickListener() { // from class: com.kwad.components.ad.interstitial.c.f.2
            ...
            public final void onClick(View view) {
                ...
                f.this.jA.requestLayout();
                f.this.jq.cZ();
                com.kwad.sdk.core.report.a.a(f.this.mAdTemplate, 110, (ab.a) null);
                f.this.kz.b(f.this.kR);
            }
        });
        ...
        if (message.what == 6666) {
            ...
            if (view != null) {
                if (view.getVisibility() == 0) {
                    runnable = new Runnable() { // from class: com.kwad.components.ad.interstitial.c.f.7
                        @Override // java.lang.Runnable
                        public final void run() {
                            f.this.kA.setVisibility(4);
                            f.this.kD.setVisibility(4);
                        }
                    };
                } else if (this.kA.getVisibility() == 4) {
                    runnable = new Runnable() { // from class: com.kwad.components.ad.interstitial.c.f.8
                        @Override // java.lang.Runnable
                        public final void run() {
                            f.this.kA.setVisibility(0);
                            f.this.kD.setVisibility(0);
                        }
                    };
                }
    ...
    public final void onCreate() {
        ...
        this.kz = (HorizontalSwipeLayout) findViewById(R.id.ksad_swipe);
        ...
        this.kH = findViewById(R.id.ksad_interstitial_guide_click_layout);
