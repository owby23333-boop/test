...
public abstract class GeneratePluginActivity extends Activity implements IPluginActivity {
    ...
    public boolean moveTaskToBack(boolean z2) {
        return this.mProxyActivity.zeusSuperMoveTaskToBack(z2);
    }
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i2, boolean z2) {
        this.mProxyActivity.zeusSuperOnApplyThemeResource(theme, i2, z2);
    }
    ...
    public void onMultiWindowModeChanged(boolean z2) {
        this.mProxyActivity.zeusSuperOnMultiWindowModeChanged(z2);
    }
    ...
    public void onPictureInPictureModeChanged(boolean z2) {
        this.mProxyActivity.zeusSuperOnPictureInPictureModeChanged(z2);
    }
    ...
    public void onTopResumedActivityChanged(boolean z2) {
        this.mProxyActivity.zeusSuperOnTopResumedActivityChanged(z2);
    }
    ...
    public void onWindowFocusChanged(boolean z2) {
        this.mProxyActivity.zeusSuperOnWindowFocusChanged(z2);
    }
    ...
    public boolean requestVisibleBehind(boolean z2) {
        return this.mProxyActivity.zeusSuperRequestVisibleBehind(z2);
    }
    ...
    public void setFinishOnTouchOutside(boolean z2) {
        this.mProxyActivity.zeusSuperSetFinishOnTouchOutside(z2);
    }

    @Override // android.app.Activity
    public void setImmersive(boolean z2) {
        this.mProxyActivity.zeusSuperSetImmersive(z2);
    }

    @Override // android.app.Activity
    public void setInheritShowWhenLocked(boolean z2) {
        this.mProxyActivity.zeusSuperSetInheritShowWhenLocked(z2);
    }
    ...
    public void setShowWhenLocked(boolean z2) {
        this.mProxyActivity.zeusSuperSetShowWhenLocked(z2);
    }
    ...
    public boolean setTranslucent(boolean z2) {
        return this.mProxyActivity.zeusSuperSetTranslucent(z2);
    }

    @Override // android.app.Activity
    public void setTurnScreenOn(boolean z2) {
        this.mProxyActivity.zeusSuperSetTurnScreenOn(z2);
    }

    @Override // android.app.Activity
    public void setVisible(boolean z2) {
        this.mProxyActivity.zeusSuperSetVisible(z2);
    }

    @Override // android.app.Activity
    public void setVrModeEnabled(boolean z2, ComponentName componentName) {
        this.mProxyActivity.zeusSuperSetVrModeEnabled(z2, componentName);
    }
    ...
    public void startSearch(String str, boolean z2, Bundle bundle, boolean z3) {
        this.mProxyActivity.zeusSuperStartSearch(str, z2, bundle, z3);
    }
    ...
    public void takeKeyEvents(boolean z2) {
        this.mProxyActivity.zeusSuperTakeKeyEvents(z2);
    }
    ...
    public void onMultiWindowModeChanged(boolean z2, Configuration configuration) {
        this.mProxyActivity.zeusSuperOnMultiWindowModeChanged(z2, configuration);
    }

    @Override // android.app.Activity
    public void onPictureInPictureModeChanged(boolean z2, Configuration configuration) {
        this.mProxyActivity.zeusSuperOnPictureInPictureModeChanged(z2, configuration);
    }
