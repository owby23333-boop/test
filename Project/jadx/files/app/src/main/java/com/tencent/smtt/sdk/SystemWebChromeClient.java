...
class SystemWebChromeClient extends android.webkit.WebChromeClient {
    ...
    private static class a implements ConsoleMessage {
        ...
        a(android.webkit.ConsoleMessage consoleMessage) {
            ...
            this.f18864c = consoleMessage.sourceId();
            this.f18865d = consoleMessage.lineNumber();
        }
    ...
    public void onConsoleMessage(String str, int i2, String str2) {
        this.a.onConsoleMessage(new a(str, str2, i2));
    }
    ...
    public boolean onCreateWindow(android.webkit.WebView webView, boolean z2, boolean z3, final Message message) {
        ...
        return this.a.onCreateWindow(this.b, z2, z3, messageObtain);
    }
    ...
    public void onExceededDatabaseQuota(String str, String str2, long j2, long j3, long j4, WebStorage.QuotaUpdater quotaUpdater) {
        this.a.onExceededDatabaseQuota(str, str2, j2, j3, j4, new f(quotaUpdater));
    }
    ...
    public void onReachedMaxAppCacheSize(long j2, long j3, WebStorage.QuotaUpdater quotaUpdater) {
        this.a.onReachedMaxAppCacheSize(j2, j3, new f(quotaUpdater));
    }
    ...
    public void onReceivedTouchIconUrl(android.webkit.WebView webView, String str, boolean z2) {
        this.b.a(webView);
        this.a.onReceivedTouchIconUrl(this.b, str, z2);
    }
