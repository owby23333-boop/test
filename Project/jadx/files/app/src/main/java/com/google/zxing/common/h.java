...
public abstract class h {
    ...
    public abstract b a(b bVar, int i2, int i3, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17) throws NotFoundException;

    public abstract b a(b bVar, int i2, int i3, j jVar) throws NotFoundException;
