...
abstract class DelegateFragment extends Fragment implements IDelegateFragment {
    ...
    public Animation onCreateAnimation(int i2, boolean z2, int i3) {
        return this.mBase.onCreateAnimation(i2, z2, i3);
    }

    @Override // androidx.fragment.app.Fragment
    public Animator onCreateAnimator(int i2, boolean z2, int i3) {
        return this.mBase.onCreateAnimator(i2, z2, i3);
    }
    ...
    public void onMultiWindowModeChanged(boolean z2) {
        ...
        this.mBase.onMultiWindowModeChanged(z2);
    }
    ...
    public void onPictureInPictureModeChanged(boolean z2) {
        ...
        this.mBase.onPictureInPictureModeChanged(z2);
    }
