...
public final class ar implements com.kwad.sdk.core.d<com.kwad.components.core.webview.a.a.b> {
    private static void a(com.kwad.components.core.webview.a.a.b bVar, JSONObject jSONObject) {
        if (jSONObject == null) {
            return;
        }
        bVar.UO = jSONObject.optInt("hasInstalled");
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.a.a.b bVar, JSONObject jSONObject) {
        ...
        int i2 = bVar.UO;
        if (i2 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "hasInstalled", i2);
        }
        return jSONObject;
    }
