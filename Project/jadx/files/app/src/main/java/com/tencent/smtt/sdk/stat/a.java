...
public class a {
    ...
    public static final byte[] f19078c = {37, -110, 60, 127, 42, -27, -17, -110};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final byte[] f19079d = {-122, -8, -23, -84, -125, 113, 84, 99};

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final byte[] f19080e = "AL!#$AC9Ahg@KLJ1".getBytes();
    ...
    private static void a(int[] iArr, int i2, int i3, int[][] iArr2) {
        ...
        for (int i6 = 0; i6 < 8; i6++) {
            ...
            iArr9[i6] = f19087l[i6][(iArr8[i6][0] << 1) + iArr8[i6][5]][(iArr8[i6][1] << 3) + (iArr8[i6][2] << 2) + (iArr8[i6][3] << 1) + iArr8[i6][4]];
    ...
    private static void a(int[] iArr, int[][] iArr2) {
        ...
        for (int i2 = 0; i2 < 56; i2++) {
            iArr3[i2] = iArr[f19083h[i2] - 1];
        }
        for (int i3 = 0; i3 < 16; i3++) {
            a(iArr3, f19088m[i3]);
            for (int i4 = 0; i4 < 48; i4++) {
                iArr2[i3][i4] = iArr3[f19084i[i4] - 1];
            }
        }
    }
