...
public interface KsVideoPlayConfig extends Serializable {
    ...
    public static class Builder {
        ...
        @KsAdSdkApi
        @Keep
        public Builder showLandscape(boolean z2) {
        ...
        @KsAdSdkApi
        @Keep
        public Builder skipThirtySecond(boolean z2) {
            this.skipLongTime = z2;
            return this;
        }

        @KsAdSdkApi
        @Keep
        public Builder videoSoundEnable(boolean z2) {
    ...
    @KsAdSdkApi
    @Keep
    void setShowLandscape(boolean z2);
    ...
    @KsAdSdkApi
    @Keep
    void setSkipThirtySecond(boolean z2);
