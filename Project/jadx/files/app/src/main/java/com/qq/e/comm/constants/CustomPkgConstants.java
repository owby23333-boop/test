...
public class CustomPkgConstants {
    ...
    private static final String f17793c = PortraitADActivity.class.getName();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f17794d = RewardvideoPortraitADActivity.class.getName();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final String f17795e = LandscapeADActivity.class.getName();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final String f17796f = RewardvideoLandscapeADActivity.class.getName();
    ...
    public static String getLandscapeADActivityName() {
        ...
        return !TextUtils.isEmpty(customLandscapeActivityClassName) ? customLandscapeActivityClassName : f17795e;
    }

    public static String getPortraitADActivityName() {
        String customPortraitActivityClassName = GlobalSetting.getCustomPortraitActivityClassName();
        return !TextUtils.isEmpty(customPortraitActivityClassName) ? customPortraitActivityClassName : f17793c;
    }
    ...
    public static String getRewardvideoLandscapeADActivityName() {
        ...
        return !TextUtils.isEmpty(customRewardvideoLandscapeActivityClassName) ? customRewardvideoLandscapeActivityClassName : f17796f;
    }
    ...
    public static String getRewardvideoPortraitADActivityName() {
        ...
        return !TextUtils.isEmpty(customRewardvideoPortraitActivityClassName) ? customRewardvideoPortraitActivityClassName : f17794d;
    }
}
