...
public final class g implements b {
    ...
    public final void b(Object obj, String str) {
        if (obj instanceof a) {
            ...
            if (TextUtils.isEmpty(str)) {
                String.format("javascript:window.MvBridge.onFailure(%s,'');", aVar.f8314g);
            } else {
                str = n.c(str);
            }
            String str2 = String.format("javascript:window.MvBridge.onFailure(%s,'%s');", aVar.f8314g, str);
    ...
    public final void a(Object obj, String str) {
        if (obj instanceof a) {
            a aVar = (a) obj;
            String str2 = TextUtils.isEmpty(str) ? String.format("javascript:window.OW.onSuccess(%s,'');", aVar.f8314g) : String.format("javascript:window.OW.onSuccess(%s,'%s');", aVar.f8314g, n.c(str));
            WindVaneWebView windVaneWebView = aVar.a;
            if (windVaneWebView != null) {
                try {
                    windVaneWebView.loadUrl(str2);
