...
final class g {
    ...
    private synchronized void a() {
        if (this.a.isEmpty()) {
            ...
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            a(new int[]{TbsListener.ErrorCode.INFO_CODE_BASE, 440}, "DE");
            a(new int[]{450, 459}, "JP");
            a(new int[]{460, 469}, "RU");
            a(new int[]{471}, com.anythink.expressad.video.dynview.a.a.ad);
            a(new int[]{474}, "EE");
            a(new int[]{475}, "LV");
            a(new int[]{476}, "AZ");
            a(new int[]{477}, "LT");
            ...
            a(new int[]{486}, "GE");
            a(new int[]{487}, "KZ");
            a(new int[]{489}, com.anythink.expressad.video.dynview.a.a.ae);
            a(new int[]{490, 499}, "JP");
            a(new int[]{500, TbsListener.ErrorCode.INFO_CODE_FILEREADER_OPENFILEREADER_FILEPATHISNULL}, "GB");
            a(new int[]{520}, "GR");
            a(new int[]{528}, "LB");
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
            ...
            a(new int[]{TbsMediaPlayer.TbsMediaPlayerListener.MEDIA_INFO_BAD_INTERLEAVING, 839}, "IT");
