...
public class ZeusTransformUtils {
    ...
    public static View inflate(LayoutInflater layoutInflater, int i2, ViewGroup viewGroup, boolean z2, String str) {
    ...
    public static Object preCheckCast(Object obj, Class cls, String str) {
        ...
        if ((obj instanceof PluginContext) && z2) {
            return ((PluginContext) obj).mOriginContext;
        }
        if (!(obj instanceof PluginFragmentActivityWrapper) || !z2) {
            return ((obj instanceof PluginActivityWrapper) && z2) ? ((PluginActivityWrapper) obj).mOriginActivity : ((obj instanceof PluginApplicationWrapper) && z2) ? ((PluginApplicationWrapper) obj).mOriginApplication : ((obj instanceof GenerateProxyActivity) && z2) ? ((GenerateProxyActivity) obj).mTargetActivity : obj;
        }
        try {
            try {
    ...
    public static View inflate(LayoutInflater layoutInflater, XmlPullParser xmlPullParser, ViewGroup viewGroup, boolean z2, String str) {
        Context context = layoutInflater.getContext();
        if (!(context instanceof PluginContext) && !(context instanceof PluginActivityWrapper) && ((isSupportLibIso(str) || !(context instanceof PluginFragmentActivityWrapper)) && !(context instanceof PluginApplicationWrapper))) {
        ...
        clearConstructorCache();
        View viewInflate = layoutInflater2.inflate(xmlPullParser, viewGroup, z2);
        clearConstructorCache();
        return viewInflate;
    }
