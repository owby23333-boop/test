...
public final class aj {
    ...
    public static int ad(String str, String str2) {
        ...
        long jL = x.L(context, str);
        String strM = x.M(context, str);
        if (TextUtils.isEmpty(strM) || jL <= 0) {
                    ...
                    if (!file.exists()) {
                        ...
                        if (TextUtils.isEmpty(strM)) {
                            ...
                            if (!TextUtils.isEmpty(fileMD5)) {
                                return strM.equalsIgnoreCase(fileMD5) ? 2 : 1;
                            }
    ...
    public static int ai(@Nullable Context context, String str) {
        if (context == null || str == null || c.bH(context) || ContextCompat.checkSelfPermission(context, com.kuaishou.weapon.p0.g.f16729i) != 0) {
            return -1;
        }
