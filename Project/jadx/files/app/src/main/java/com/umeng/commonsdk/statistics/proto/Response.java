...
public class Response implements av<Response, e>, Serializable, Cloneable {
    ...
    private static final Map<Class<? extends cc>, cd> schemes = new HashMap();
    ...
    static {
        schemes.put(ce.class, new b());
        schemes.put(cf.class, new d());
        ...
        bh.a(Response.class, metaDataMap);
    }
    ...
    public enum e implements bc {
        ...
        private static final Map<String, e> f20116d = new HashMap();

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private final short f20118e;
