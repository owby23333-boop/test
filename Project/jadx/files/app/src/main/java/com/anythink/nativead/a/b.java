...
public final class b implements ATNativeMaterial {
    ...
    public final double getAppPrice() {
        CustomNativeAd customNativeAd = this.a;
        return customNativeAd != null ? customNativeAd.getAppPrice() : PangleAdapterUtils.CPM_DEFLAUT_VALUE;
    }
    ...
    public final View getShakeView(int i2, int i3, ATShakeViewListener aTShakeViewListener) {
        CustomNativeAd customNativeAd = this.a;
        if (customNativeAd != null) {
            return customNativeAd.getShakeView(i2, i3, aTShakeViewListener);
        }
        return null;
    }
    ...
    public final double getVideoDuration() {
        CustomNativeAd customNativeAd = this.a;
        return customNativeAd != null ? customNativeAd.getVideoDuration() : PangleAdapterUtils.CPM_DEFLAUT_VALUE;
    }
