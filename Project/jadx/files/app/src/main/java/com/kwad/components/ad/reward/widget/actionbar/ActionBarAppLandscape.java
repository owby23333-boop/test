...
public class ActionBarAppLandscape extends LinearLayout implements c {
    ...
    private void b(View view, final boolean z2) {
        com.kwad.components.core.d.b.a.a(new a.C0395a(view.getContext()).J(this.mAdTemplate).b(this.mApkDownloadHelper).al(view == this.Bd).ap(view == this.Be ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.2
            @Override // com.kwad.components.core.d.b.a.b
            public final void onAdClicked() {
                if (ActionBarAppLandscape.this.Bf != null) {
                    ActionBarAppLandscape.this.Bf.R(z2);
                }
            }
        }));
    }
        ...
        if (this.cE == null) {
            this.cE = new com.kwad.sdk.core.download.kwai.a() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.1
                ...
                public final void onDownloadFailed() {
                    ActionBarAppLandscape.this.Bd.f(com.kwad.sdk.core.response.a.a.ax(ActionBarAppLandscape.this.mAdInfo), 0);
                    ActionBarAppLandscape.this.Be.setVisibility(0);
                }

                @Override // com.kwad.sdk.api.KsAppDownloadListener
                public final void onDownloadFinished() {
                    ActionBarAppLandscape.this.Bd.f(com.kwad.sdk.core.response.a.a.aI(ActionBarAppLandscape.this.mAdTemplate), 0);
                    ActionBarAppLandscape.this.Be.setVisibility(0);
                }
                ...
                public final void onInstalled() {
                    ActionBarAppLandscape.this.Bd.f(com.kwad.sdk.core.response.a.a.U(ActionBarAppLandscape.this.mAdInfo), 0);
                    ActionBarAppLandscape.this.Be.setVisibility(0);
                }

                @Override // com.kwad.sdk.core.download.kwai.a
                public final void onPaused(int i2) {
                    ActionBarAppLandscape.this.Bd.f(com.kwad.sdk.core.response.a.a.bv(i2), i2);
                    ActionBarAppLandscape.this.Be.setVisibility(8);
                }

                @Override // com.kwad.sdk.api.KsAppDownloadListener
                public final void onProgressUpdate(int i2) {
                    ActionBarAppLandscape.this.Bd.f(com.kwad.sdk.core.response.a.a.bu(i2), i2);
                    ActionBarAppLandscape.this.Be.setVisibility(8);
                }
            };
        }
    ...
    private void initView() {
        com.kwad.sdk.i.a.inflate(getContext(), R.layout.ksad_video_actionbar_app_landscape, this);
    ...
    private void kv() {
        ...
        boolean zIsEmpty = true ^ TextUtils.isEmpty(strAs);
        if (zIsEmpty) {
