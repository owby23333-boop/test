...
public final class b {
    ...
    private c.b QR = new c.b() { // from class: com.kwad.components.core.video.b.4
        ...
        public final void on() {
            ...
            b bVar = b.this;
            bVar.onPlayStateChanged(bVar.QD);
            com.kwad.sdk.core.video.kwai.kwai.a.cu("videoFinishPlay");
        }
    };
    private c.InterfaceC0446c QS = new c.InterfaceC0446c() { // from class: com.kwad.components.core.video.b.5
        ...
        public final boolean j(int i2, int i3) {
            ...
            b bVar = b.this;
            bVar.onPlayStateChanged(bVar.QD);
            com.kwad.sdk.core.video.kwai.kwai.a.cu("videoPlayError");
        ...
        public final boolean k(int i2, int i3) {
            ...
            if (i2 != 3) {
                if (i2 == 701) {
                    ...
                    com.kwad.sdk.core.d.b.i(str2, str3);
                    b bVar = b.this;
                    bVar.onPlayStateChanged(bVar.QD);
                } else if (i2 == 702) {
                    if (b.this.QD == 6) {
                    ...
                    if (b.this.QD == 7) {
                        ...
                        com.kwad.sdk.core.d.b.i(str, string);
                    }
                } else if (i2 != 10001) {
                    if (i2 == 801) {
                        str = b.this.TAG;
    ...
    private void a(@NonNull com.kwad.sdk.contentalliance.kwai.kwai.b bVar, boolean z2, @NonNull DetailVideoView detailVideoView, @NonNull com.kwad.sdk.core.video.kwai.c cVar) {
    ...
    public final void a(@NonNull com.kwad.sdk.contentalliance.kwai.kwai.b bVar, boolean z2, boolean z3, @NonNull DetailVideoView detailVideoView) {
        com.kwad.sdk.core.d.b.i(this.TAG, "initMediaPlayer enablePreLoad:" + z2);
        if (bVar == null || detailVideoView == null) {
            return;
        }
        com.kwad.sdk.core.video.kwai.c cVarA = com.kwad.sdk.core.video.kwai.e.a(this.mContext, z2, com.kwad.sdk.core.config.d.sK(), com.kwad.sdk.core.config.d.sL());
        cVarA.setLooping(false);
        a(bVar, z3, detailVideoView, cVarA);
    }
    ...
    public final boolean pause() {
        ...
        if (this.QD == 4) {
            ...
            com.kwad.sdk.core.video.kwai.kwai.a.cu("videoPausePlay");
            z2 = true;
        } else {
            z2 = false;
        }
                    ...
                    public final void run() {
                        ...
                        try {
                            synchronized (b.this.QE) {
                                b.this.a(b.this.QI);
                                zPrepareAsync = b.this.QE.prepareAsync();
                                com.kwad.sdk.core.d.b.i(b.this.TAG, "prepareAsync:" + b.getStateString(b.this.QD) + "->STATE_PREPARING, success: " + zPrepareAsync);
                                b.this.QD = 1;
                            }
                            if (zPrepareAsync) {
    ...
    public final com.kwad.sdk.core.video.kwai.c qw() {
        return this.QE;
    }
    ...
    public final void resume() {
        ...
        if (this.QD == 5) {
            ...
            onPlayStateChanged(this.QD);
            setPlayType(2);
            com.kwad.sdk.core.video.kwai.kwai.a.cu("videoResumePlay");
            return;
        }
        if (this.QD != 7) {
            if (this.QD != 1) {
    ...
    */
    public final void start() {
        ...
        L45:
            ...
            r0.start()
            com.kwad.sdk.core.video.kwai.kwai.a.cu(r1)
        L4d:
            return
        L4e:
            int r0 = r7.QD
