...
public class DownloadComponentManager {
    ...
    public static IDownloadHttpConnection downloadWithConnection(boolean z2, int i2, String str, List<HttpHeader> list) throws Exception {
        return downloadWithConnection(z2, i2, str, null, list, 0, false, null);
    }
    ...
    */
    private static com.ss.android.socialbase.downloader.network.IDownloadHttpConnection downloadWithConnection2(int r11, java.lang.String r12, java.lang.String r13, java.util.List<com.ss.android.socialbase.downloader.model.HttpHeader> r14, int r15, boolean r16, com.ss.android.socialbase.downloader.model.DownloadInfo r17) throws java.lang.Throwable {
        ...
        L22:
            ...
            r2 = r11
            r3 = r12
            com.ss.android.socialbase.downloader.network.IDownloadHttpConnection r0 = r0.downloadWithConnection(r11, r12, r14)     // Catch: java.lang.Throwable -> L40 java.io.IOException -> L42
            if (r16 == 0) goto L3f
    ...
    */
    ...
    public static void ensureOPPO() {
        if (TextUtils.isEmpty(DownloadConstants.LOWER_OPPO)) {
            DownloadConstants.LOWER_OPPO = AgooConstants.MESSAGE_SYSTEM_SOURCE_OPPO;
    ...
    static synchronized void initComponent(DownloaderBuilder downloaderBuilder) {
        ...
        if (downloadInMultiProcess && !z2 && !DownloadUtils.isDownloaderProcess()) {
    ...
    private static void needAutoRefreshUnSuccessTask(boolean z2) {
        needAutoRefreshUnSuccessTask = z2;
    }
    ...
    public static void setNotAutoRebootService(boolean z2) {
        notAutoRebootService = z2;
    }
    ...
    public static IDownloadHttpConnection downloadWithConnection(boolean z2, int i2, String str, String str2, List<HttpHeader> list, int i3, boolean z3, DownloadInfo downloadInfo) throws Exception {
        ...
        for (int i5 : downloadNetLibs) {
            try {
                iDownloadHttpConnectionDownloadWithConnection2 = downloadWithConnection2(i2, str, str2, list2, i5, z3, downloadInfo);
            } catch (Exception e2) {
    ...
    public static IDownloadHeadHttpConnection downloadWithHeadConnection(String str, List<HttpHeader> list, int i2, boolean z2, DownloadInfo downloadInfo) throws Exception {
        IDownloadHeadHttpConnection iDownloadHeadHttpConnectionDownloadWithHeadConnection2;
        Exception e2 = null;
        for (int i3 : getDownloadNetLibs(i2)) {
            try {
                iDownloadHeadHttpConnectionDownloadWithHeadConnection2 = downloadWithHeadConnection2(str, list, i3, z2, downloadInfo);
            } catch (Exception e3) {
                e2 = e3;
            }
    ...
    public static void submitCPUTask(Runnable runnable, boolean z2) {
        if (runnable == null) {
            return;
        }
        if (!z2 || DownloadUtils.isMainThread()) {
    ...
    public static void submitIOTask(Runnable runnable, boolean z2) {
        if (runnable == null) {
            return;
        }
        if (!z2 || DownloadUtils.isMainThread()) {
