...
public final class j extends h {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && j.class == obj.getClass()) {
            j jVar = (j) obj;
            if (af.a((Object) this.b, (Object) jVar.b) && Arrays.equals(this.f9113c, jVar.f9113c)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        String str = this.b;
        return (((str != null ? str.hashCode() : 0) + 527) * 31) + Arrays.hashCode(this.f9113c);
    }

    @Override // com.anythink.expressad.exoplayer.g.b.h
    public final String toString() {
        return this.f9110g + ": owner=" + this.b;
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i2) {
        parcel.writeString(this.b);
        parcel.writeByteArray(this.f9113c);
    }

    j(Parcel parcel) {
        super(a);
        this.b = parcel.readString();
        this.f9113c = parcel.createByteArray();
    }
}
