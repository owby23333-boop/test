...
public class TTAdConstant {
    ...
    public static String ox(String str) {
        return TextUtils.isEmpty(str) ? "" : str.contains("KLLK") ? str.replace("KLLK", "OPPO") : str.contains(DownloadSettingKeys.oppo) ? str.replace(DownloadSettingKeys.oppo, AgooConstants.MESSAGE_SYSTEM_SOURCE_OPPO) : "";
    }
}
