...
public class ZeusProviderTransform {
    ...
    public static int delete(Object obj, Uri uri, String str, String[] strArr, String str2) {
        ...
        try {
            return ((Integer) MethodUtils.invokeMethod(obj, b.az, new Object[]{uri, str, strArr}, new Class[]{Uri.class, String.class, String[].class})).intValue();
        } catch (Exception e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    public static void registerContentObserver(Object obj, Uri uri, boolean z2, ContentObserver contentObserver, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).registerContentObserver(a.a(uri, str), z2, contentObserver);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "registerContentObserver", new Object[]{uri, Boolean.valueOf(z2), contentObserver}, new Class[]{Uri.class, Boolean.TYPE, ContentObserver.class});
        } catch (Exception e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    public static int delete(Object obj, Uri uri, Bundle bundle, String str) {
        ...
        try {
            return ((Integer) MethodUtils.invokeMethod(obj, b.az, new Object[]{uri, bundle}, new Class[]{Uri.class, Bundle.class})).intValue();
        } catch (Exception e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    public static void notifyChange(Object obj, Uri uri, ContentObserver contentObserver, boolean z2, String str) {
        if (obj instanceof ContentResolver) {
            ((ContentResolver) obj).notifyChange(a.a(uri, str), contentObserver, z2);
            return;
        }
        try {
            MethodUtils.invokeMethod(obj, "notifyChange", new Object[]{uri, contentObserver, Boolean.valueOf(z2)}, new Class[]{Uri.class, ContentObserver.class, Boolean.TYPE});
        } catch (Exception e2) {
            throw new RuntimeException(e2);
        }
    }
