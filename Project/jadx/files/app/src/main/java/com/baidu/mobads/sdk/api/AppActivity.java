...
public class AppActivity extends Activity {
    ...
    public static void setIsShowActionBarTitle(boolean z2) {
        mIsShowActionBarTitle = z2;
    }
    ...
    protected void onCreate(Bundle bundle) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        ...
        try {
            this.mLoader = bp.a(this);
            if (intent != null) {
                intent.setExtrasClassLoader(this.mLoader);
            }
            String stringExtra = intent != null ? intent.getStringExtra("activityImplName") : "";
            Object objNewInstance = null;
            if (!TextUtils.isEmpty(stringExtra) && (clsA = ar.a(stringExtra, this.mLoader)) != null) {
                try {
