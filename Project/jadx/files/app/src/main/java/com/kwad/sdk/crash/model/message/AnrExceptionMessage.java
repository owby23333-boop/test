...
public final class AnrExceptionMessage extends ExceptionMessage {
    ...
    public final JSONObject toJson() {
        ...
        s.putValue(json, "mReason", this.mReason);
        s.putValue(json, "mMessageQueueDetail", this.mMessageQueueDetail);
        s.putValue(json, "mThreadDetail", this.mThreadDetail);
        s.putValue(json, "mThreadStatus", this.mThreadStatus);
        return json;
    }
