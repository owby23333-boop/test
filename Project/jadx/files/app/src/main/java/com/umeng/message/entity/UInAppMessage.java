...
public class UInAppMessage {
    ...
    public UInAppMessage(JSONObject jSONObject) throws JSONException {
        ...
        this.display_name = jSONObject2.optString(am.f19459s, "");
        ...
        if (i2 == 5 || i2 == 6) {
            ...
            this.plainTextActionType = jSONObject3.optString(MsgConstant.KEY_ACTION_TYPE);
            this.plainTextActivity = jSONObject3.optString("activity", "");
            this.plainTextUrl = jSONObject3.optString("url", "");
        }
        if (jSONObject2.has(c.C0205c.f10205e)) {
            JSONObject jSONObject4 = jSONObject2.getJSONObject(c.C0205c.f10205e);
            this.image_url = jSONObject4.getString("imageurl");
            this.width = jSONObject4.getInt("width");
            this.height = jSONObject4.getInt("height");
            this.action_type = jSONObject4.optString(MsgConstant.KEY_ACTION_TYPE);
        ...
        if (jSONObject2.has("bottom_image")) {
            ...
            this.bottom_action_type = jSONObject5.optString(MsgConstant.KEY_ACTION_TYPE);
        ...
        if (jSONObject2.has("custom_button")) {
            ...
            this.customButtonActionType = jSONObject6.optString(MsgConstant.KEY_ACTION_TYPE);
        ...
        this.expire_time = jSONObject7.getString(j.a.f7047g);
    }
