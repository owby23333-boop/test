...
public class OfflineMemExceptionMessage extends ExceptionMessage {
    ...
    public JSONObject toJson() {
        ...
        s.putValue(json, REASON, this.mReason);
        s.putValue(json, MSG_QUEUE_DETAIL, this.mMessageQueueDetail);
        s.putValue(json, THREAD_DETAIL, this.mThreadDetail);
        s.putValue(json, THREAD_STATUS, this.mThreadStatus);
        return json;
    }
}
