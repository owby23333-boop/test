...
public class DownloadProcessDispatcher {
    ...
    public void addDownloadListener(int i2, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2) {
        ...
        downloadHandler.addDownloadListener(i2, iDownloadListener.hashCode(), iDownloadListener, listenerType, z2);
    }
    ...
    public void clearDownloadData(int i2, boolean z2) {
        ...
        downloadHandler.clearDownloadData(i2, z2);
    }
    ...
    public void recordTaskProcessIndependent(int i2) {
        ...
        setDownloadIndependentProcessStatus(i2, Boolean.TRUE.booleanValue());
        IDownloadProxy iDownloadProxy = DownloadProxy.get(true);
        if (iDownloadProxy == null) {
            return;
        }
    ...
    public void removeDownloadListener(int i2, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2) {
        ...
        downloadHandler.removeDownloadListener(i2, iDownloadListener == null ? 0 : iDownloadListener.hashCode(), iDownloadListener, listenerType, z2);
    }
    ...
    public synchronized void setDownloadIndependentProcessStatus(int i2, boolean z2) {
        this.independentMap.put(i2, z2 ? Boolean.TRUE : Boolean.FALSE);
    }
    ...
    public void addDownloadListener(int i2, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2, boolean z3) {
        IDownloadProxy downloadHandler = getDownloadHandler(i2);
        if (downloadHandler == null) {
            return;
        }
        downloadHandler.addDownloadListener(i2, iDownloadListener.hashCode(), iDownloadListener, listenerType, z2, z3);
    }
