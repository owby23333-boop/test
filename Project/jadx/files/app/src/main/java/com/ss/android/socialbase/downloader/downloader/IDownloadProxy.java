...
public interface IDownloadProxy {
    ...
    void addDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2);

    void addDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2, boolean z3);

    void addProcessCallback(ProcessCallback processCallback);

    boolean canResume(int i2);

    void cancel(int i2, boolean z2);

    void clearData();

    void clearDownloadData(int i2, boolean z2);
    ...
    void removeDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2);

    boolean removeDownloadTaskData(int i2);

    void resetDownloadData(int i2, boolean z2);
    ...
    void setDownloadWithIndependentProcessStatus(int i2, boolean z2);
    ...
    void stopForeground(boolean z2, boolean z3);
