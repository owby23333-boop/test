...
public interface IDownloadRunnableCallback {
    ...
    void handleFirstConnection(String str, IDownloadHeadHttpConnection iDownloadHeadHttpConnection, long j2) throws RetryThrowable, BaseException;

    void onAllChunkRetryWithReset(BaseException baseException, boolean z2);
