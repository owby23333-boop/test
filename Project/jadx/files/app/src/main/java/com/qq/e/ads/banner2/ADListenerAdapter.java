...
class ADListenerAdapter implements ADListener {
    ...
    private ADRewardListener f17699c;
    ...
    public void onADEvent(ADEvent aDEvent) {
        ...
        switch (type) {
            case 103:
                ...
                break;
            case 104:
                if (this.f17699c != null && (str = (String) aDEvent.getParam(String.class)) != null) {
                    HashMap map = new HashMap();
                    map.put("transId", str);
                    this.f17699c.onReward(map);
                    break;
                }
                break;
            case 105:
