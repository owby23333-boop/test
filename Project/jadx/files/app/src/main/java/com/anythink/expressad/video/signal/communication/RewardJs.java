...
public class RewardJs extends BaseRewardJs implements IRewardBridge {
    ...
    private Handler f11979j = new Handler(Looper.getMainLooper());
    ...
    public void cai(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.9
    ...
    public void getEndScreenInfo(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.1
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void gial(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.10
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void handlerPlayableException(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.7
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void install(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.2
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void notifyCloseBtn(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.3
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void openURL(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.8
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void setOrientation(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.6
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void toggleCloseBtn(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.4
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void triggerCloseBtn(final Object obj, final String str) {
        if (t.b()) {
            ...
            this.f11979j.post(new Runnable() { // from class: com.anythink.expressad.video.signal.communication.RewardJs.5
                @Override // java.lang.Runnable
                public void run() {
                    RewardJs.super.getEndScreenInfo(obj, str);
                }
