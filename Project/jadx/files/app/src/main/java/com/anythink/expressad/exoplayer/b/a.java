...
public final class a {
    ...
    private static final int f8505c = 256;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int f8506d = 1536;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final int[] f8507e = {1, 2, 3, 6};

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final int[] f8508f = {48000, 44100, 32000};

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final int[] f8509g = {24000, 22050, 16000};

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private static final int[] f8510h = {2, 1, 2, 3, 3, 4, 4, 5};

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private static final int[] f8511i = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, TbsListener.ErrorCode.EXCEED_INCR_UPDATE, 256, TbsListener.ErrorCode.ERROR_SDKENGINE_INIT_THROWABLE, 384, m.a.a, 512, 576, 640};

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private static final int[] f8512j = {69, 87, 104, 121, 139, 174, 208, 243, com.anythink.expressad.foundation.g.a.aS, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static final class C0182a {
        ...
        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public static final int f8513c = 1;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public static final int f8514d = 2;
        ...
        /* synthetic */ C0182a(String str, int i2, int i3, int i4, int i5, int i6, byte b2) {
            this(str, i2, i3, i4, i5, i6);
        }

        private C0182a(String str, int i2, int i3, int i4, int i5, int i6) {
            this.f8515e = str;
            this.f8516f = i2;
            this.f8518h = i3;
            this.f8517g = i4;
    ...
    public static com.anythink.expressad.exoplayer.m a(com.anythink.expressad.exoplayer.k.s sVar, String str, String str2, com.anythink.expressad.exoplayer.d.e eVar) {
        int i2 = f8508f[(sVar.d() & 192) >> 6];
        int iD = sVar.d();
        int i3 = f8510h[(iD & 56) >> 3];
        if ((iD & 4) != 0) {
            i3++;
        }
        return com.anythink.expressad.exoplayer.m.a(str, com.anythink.expressad.exoplayer.k.o.f9881z, null, -1, i3, i2, null, eVar, str2);
    }
    ...
    private static C0182a a(com.anythink.expressad.exoplayer.k.r rVar) {
        String str;
        int i2;
        int i3;
        int i4;
        ...
        if (z2) {
            ...
            int i14 = f8508f[iC8];
            int i15 = f8510h[iC9] + (rVar.d() ? 1 : 0);
            str = com.anythink.expressad.exoplayer.k.o.f9881z;
            i2 = iA;
            i3 = i14;
            i4 = i15;
            i5 = -1;
        ...
        return new C0182a(str, i5, i4, i3, i2, i6, (byte) 0);
    }
    ...
    public static int a(ByteBuffer byteBuffer) {
        return (((byteBuffer.get(byteBuffer.position() + 4) & 192) >> 6) != 3 ? f8507e[(byteBuffer.get(byteBuffer.position() + 4) & 48) >> 4] : 6) * 256;
    }
