...
public abstract class AbsNotificationItem {
    ...
    public void refreshStatus(int i2, BaseException baseException, boolean z2) {
        refreshStatus(i2, baseException, z2, false);
    }
    ...
    protected void setOngoing(boolean z2) {
        this.ongoing = z2;
    }
    ...
    public void refreshStatus(int i2, BaseException baseException, boolean z2, boolean z3) {
        if (z3 || this.status != i2) {
            this.status = i2;
