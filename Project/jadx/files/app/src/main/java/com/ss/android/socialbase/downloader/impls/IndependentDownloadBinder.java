...
public class IndependentDownloadBinder extends IDownloadAidlService.Stub {
    ...
    public void addDownloadListener(int i2, int i3, IDownloadAidlListener iDownloadAidlListener, int i4, boolean z2) throws RemoteException {
        ...
        iDownloadProxy.addDownloadListener(i2, i3, IPCUtils.convertListenerFromAidl(iDownloadAidlListener), DownloadUtils.convertListenerType(i4), z2);
    }
    ...
    public void addDownloadListener1(int i2, int i3, IDownloadAidlListener iDownloadAidlListener, int i4, boolean z2, boolean z3) throws RemoteException {
        ...
        iDownloadProxy.addDownloadListener(i2, i3, IPCUtils.convertListenerFromAidl(iDownloadAidlListener), DownloadUtils.convertListenerType(i4), z2, z3);
    }
    ...
    public void clearDownloadData(int i2, boolean z2) throws RemoteException {
        ...
        iDownloadProxy.clearDownloadData(i2, z2);
    }
    ...
    public void removeDownloadListener(int i2, int i3, IDownloadAidlListener iDownloadAidlListener, int i4, boolean z2) throws RemoteException {
        ...
        iDownloadProxy.removeDownloadListener(i2, i3, IPCUtils.convertListenerFromAidl(iDownloadAidlListener), DownloadUtils.convertListenerType(i4), z2);
    }
    ...
    public void setDownloadWithIndependentProcessStatus(int i2, boolean z2) throws RemoteException {
        DownloadProcessDispatcher.getInstance().setDownloadIndependentProcessStatus(i2, z2);
    }
    ...
    public void stopForeground(boolean z2) throws RemoteException {
        ...
        iDownloadProxy.stopForeground(true, z2);
    }
