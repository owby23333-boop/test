...
public final class t extends a implements View.OnClickListener, com.kwad.components.ad.reward.d.m, com.kwad.sdk.core.f.b {
    ...
    @Nullable
    private Animator hi;
    private com.kwad.components.ad.reward.d.f mPlayEndPageListener = new com.kwad.components.ad.reward.d.a() { // from class: com.kwad.components.ad.reward.presenter.t.1
        ...
        public final void bM() {
            ...
            if (t.this.hg != null) {
                t.this.hg.setVisibility(8);
            }
            if (t.this.ee != null) {
                t.this.ee.bj(t.this.getContext());
            }
            if (t.this.hi != null) {
                t.this.hi.cancel();
                t.this.hi = null;
    ...
    public Animator a(float f2, float f3) {
        ...
        Animator animatorA = com.kwad.components.core.r.o.a((View) this.hd, (Interpolator) null, 100L, 16.0f);
        animatorA.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.reward.presenter.t.7
            ...
            public final void onAnimationStart(Animator animator) {
                ...
                t.this.hd.setPivotX(t.this.hd.getWidth());
                t.this.hd.setPivotY(t.this.hd.getHeight());
            }
        });
        ...
        valueAnimatorOfFloat.addUpdateListener(new com.kwad.components.ad.widget.a(this.hf) { // from class: com.kwad.components.ad.reward.presenter.t.8
        ...
        valueAnimatorOfFloat2.addUpdateListener(new com.kwad.components.ad.widget.a(this.hd) { // from class: com.kwad.components.ad.reward.presenter.t.9
            @Override // com.kwad.components.ad.widget.a
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
                float fFloatValue = ((Float) obj).floatValue();
                if (layoutParams != null) {
        ...
        valueAnimatorOfArgb.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.reward.presenter.t.10
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                try {
                    ...
                    GradientDrawable gradientDrawable = (GradientDrawable) t.this.hf.getBackground();
                    gradientDrawable.mutate();
                    gradientDrawable.setColor(iIntValue);
                    if (iIntValue == color2) {
                        gradientDrawable.setStroke(dimensionPixelSize, -1);
                    }
                    t.this.hf.setBackground(gradientDrawable);
                } catch (Throwable th) {
        ...
        valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.reward.presenter.t.11
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                try {
                    ...
                    t.this.hb.setAlpha(fFloatValue);
                    t.this.hc.setAlpha(fFloatValue);
                } catch (Throwable th) {
                    com.kwad.sdk.core.d.b.printStackTrace(th);
                }
            }
        ...
        valueAnimatorOfFloat4.addUpdateListener(new com.kwad.components.ad.widget.a(this.hb) { // from class: com.kwad.components.ad.reward.presenter.t.12
            @Override // com.kwad.components.ad.widget.a
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
        ...
        valueAnimatorOfFloat5.addUpdateListener(new com.kwad.components.ad.widget.a(this.hc) { // from class: com.kwad.components.ad.reward.presenter.t.13
            @Override // com.kwad.components.ad.widget.a
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
                layoutParams.height = (int) ((Float) obj).floatValue();
            }
        ...
        animatorClone.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.reward.presenter.t.2
            ...
            public final void onAnimationStart(Animator animator) {
                super.onAnimationStart(animator);
                t.this.hd.setPivotX(dimension2);
                t.this.hd.setPivotY(dimension2);
            }
        });
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.reward.presenter.t.3
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                try {
                    t.this.hg.setVisibility(0);
                    layoutParams.width = (int) ((Float) valueAnimator.getAnimatedValue()).floatValue();
                    t.this.hg.setLayoutParams(layoutParams);
                } catch (Throwable th) {
                    com.kwad.sdk.core.d.b.printStackTrace(th);
                }
            }
    ...
    private static String a(com.kwad.components.ad.reward.j jVar, AdInfo adInfo) {
        String strDk = com.kwad.sdk.core.response.a.b.dk(adInfo);
        com.kwad.components.core.d.b.c cVar = jVar.mApkDownloadHelper;
        if (!com.kwad.sdk.core.response.a.a.ay(adInfo) || cVar == null) {
            return strDk;
        }
        int iNw = cVar.nw();
        AdMatrixInfo.DownloadTexts downloadTextsDm = com.kwad.sdk.core.response.a.b.dm(adInfo);
        return iNw != 8 ? iNw != 12 ? downloadTextsDm.adActionDescription : downloadTextsDm.openAppLabel : downloadTextsDm.installAppLabel;
    }

    private void a(AdInfo adInfo) {
        String strDi = com.kwad.sdk.core.response.a.b.di(adInfo);
        TextView textView = this.hb;
        if (textView != null) {
            textView.setText(strDi);
        }
        TextView textView2 = this.hh;
        if (textView2 != null) {
            textView2.setText(strDi);
        }
    ...
    private void ci() {
        ...
        final int dimensionPixelSize2 = this.qS.mScreenOrientation == 1 ? resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_icon_marginBottom) + com.kwad.sdk.b.kwai.a.a(getContext(), 50.0f) : resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_icon_marginBottom);
        int dimensionPixelSize3 = this.qS.mScreenOrientation == 1 ? resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_title_marginBottom) + com.kwad.sdk.b.kwai.a.a(getContext(), 50.0f) : resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_title_marginBottom);
        ...
        this.ha.post(new Runnable() { // from class: com.kwad.components.ad.reward.presenter.t.6
            @Override // java.lang.Runnable
            public final void run() {
                int height = adBaseFrameLayout.getHeight();
                t tVar = t.this;
                tVar.hi = tVar.a(dimensionPixelSize, height - dimensionPixelSize2);
                if (t.this.hi != null) {
                    t.this.hi.start();
                }
            }
    ...
    public final void a(double d2) {
        ...
        if (com.kwad.components.core.d.a.b.na() || !z2) {
            bh.a(new Runnable() { // from class: com.kwad.components.ad.reward.presenter.t.4
                @Override // java.lang.Runnable
                public final void run() {
                    t.this.ee.xP();
                }
        ...
        com.kwad.sdk.core.response.a.d.cb(this.qS.mAdTemplate);
        if (this.qS.gp()) {
            return;
        }
    ...
    public final void ar() {
        ...
        initView();
        a(adInfoCb);
        float fDg = com.kwad.sdk.core.response.a.b.dg(adInfoCb);
        com.kwad.sdk.core.f.d dVar = this.ee;
        if (dVar == null) {
            this.ee = new com.kwad.sdk.core.f.d(fDg);
            this.ee.a(this);
        } else {
            dVar.e(fDg);
        }
    ...
    public final int ch() {
        return com.kwad.sdk.b.kwai.a.g(getContext(), R.dimen.ksad_reward_shake_tips_title_marginBottom) + com.kwad.sdk.b.kwai.a.g(getContext(), R.dimen.ksad_reward_shake_tips_height);
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        if (com.kwad.sdk.core.response.a.b.de(com.kwad.sdk.core.response.a.d.cb(this.qS.mAdTemplate))) {
