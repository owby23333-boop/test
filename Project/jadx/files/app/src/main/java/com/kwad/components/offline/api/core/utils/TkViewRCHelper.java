...
public class TkViewRCHelper {
    ...
    public static class CornerConf {
        ...
        public CornerConf setBottomLeft(boolean z2) {
            this.bottomLeft = z2;
            return this;
        }

        public CornerConf setLeftTop(boolean z2) {
            this.leftTop = z2;
            return this;
        }

        public CornerConf setRightBottom(boolean z2) {
            this.rightBottom = z2;
            return this;
        }

        public CornerConf setTopRight(boolean z2) {
            this.topRight = z2;
            return this;
        }
    }
