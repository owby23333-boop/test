...
public class BaseDownloader {
    ...
    public boolean isDownloading(int i2) {
        ...
        synchronized (this) {
            zIsDownloading = DownloadProcessDispatcher.getInstance().isDownloading(i2);
        }
    ...
    public void cancel(int i2, boolean z2) {
        DownloadProcessDispatcher.getInstance().cancel(i2, z2);
    }

    public void clearDownloadData(int i2, boolean z2) {
        DownloadProcessDispatcher.getInstance().clearDownloadData(i2, z2);
    }
    ...
    public void setMainThreadListener(int i2, IDownloadListener iDownloadListener, boolean z2) {
        ...
        DownloadProcessDispatcher.getInstance().addDownloadListener(i2, iDownloadListener, ListenerType.MAIN, true, z2);
    }
}
