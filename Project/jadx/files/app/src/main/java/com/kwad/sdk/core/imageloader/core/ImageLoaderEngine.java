...
class ImageLoaderEngine {
    ...
    void denyNetworkDownloads(boolean z2) {
    ...
    void handleSlowNetwork(boolean z2) {
    ...
    void submit(final LoadAndDisplayImageTask loadAndDisplayImageTask) {
        this.taskDistributor.execute(new Runnable() { // from class: com.kwad.sdk.core.imageloader.core.ImageLoaderEngine.1
            ...
            public void run() {
                ...
                (z2 ? ImageLoaderEngine.this.taskExecutorForCachedImages : ImageLoaderEngine.this.taskExecutor).execute(loadAndDisplayImageTask);
            }
        });
    }
