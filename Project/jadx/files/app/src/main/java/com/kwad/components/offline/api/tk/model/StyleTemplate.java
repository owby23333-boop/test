...
public class StyleTemplate extends BaseOfflineCompoJsonParse<StyleTemplate> implements Serializable {
    ...
    public JSONObject toJson(StyleTemplate styleTemplate, JSONObject jSONObject) {
        ...
        if (str != null && !str.equals("")) {
            s.putValue(jSONObject, "templateId", styleTemplate.templateId);
        }
        String str2 = styleTemplate.templateUrl;
        if (str2 != null && !str2.equals("")) {
            s.putValue(jSONObject, "templateUrl", styleTemplate.templateUrl);
        }
        String str3 = styleTemplate.templateVersion;
        if (str3 != null && !str3.equals("")) {
            s.putValue(jSONObject, "templateVersion", styleTemplate.templateVersion);
        }
        int i2 = styleTemplate.templateVersionCode;
        if (i2 != 0) {
            s.putValue(jSONObject, "templateVersionCode", i2);
        }
        String str4 = styleTemplate.templateMd5;
        if (str4 != null && !str4.equals("")) {
            s.putValue(jSONObject, "templateMd5", styleTemplate.templateMd5);
        }
        return jSONObject;
    }
}
