...
public final class ft implements com.kwad.sdk.core.d<PhotoInfo> {
    ...
    private static JSONObject b(PhotoInfo photoInfo, JSONObject jSONObject) {
        ...
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "mOriginJString", photoInfo.mOriginJString);
        }
        com.kwad.sdk.utils.s.a(jSONObject, "baseInfo", photoInfo.baseInfo);
        com.kwad.sdk.utils.s.a(jSONObject, "videoInfo", photoInfo.videoInfo);
        return jSONObject;
    }
