...
public class GDTApkManager {
    ...
    private boolean f17722c = false;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private AtomicInteger f17723d = new AtomicInteger(0);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private Context f17724e;
    ...
    private void a(Context context, String str, final IGDTApkListener iGDTApkListener) {
        if (TextUtils.isEmpty(str) || context == null) {
            ...
            b.f17802g.execute(new Runnable() { // from class: com.qq.e.ads.dfa.GDTApkManager.1
                            ...
                            public void run() {
                                try {
                                    if (pOFactory != null) {
                                        ...
                                        GDTApkManager.this.f17722c = true;
                                        while (GDTApkManager.this.f17723d.getAndDecrement() > 0) {
    ...
    public final void startInstall(GDTApk gDTApk) {
        DFA dfa = this.a;
        if (dfa != null) {
            dfa.startInstall(this.f17724e, gDTApk);
        }
    }
}
