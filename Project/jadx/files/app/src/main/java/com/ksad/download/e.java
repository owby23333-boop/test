...
public final class e {
    public static PendingIntent a(File file, int i2, boolean z2) {
        ...
        return PendingIntent.getActivity(context, i2, intent, Build.VERSION.SDK_INT >= 31 ? 201326592 : DownloadExpSwitchCode.BUGFIX_SIGBUS_24_25);
    }
    ...
    public static PendingIntent e(String str, int i2) {
        ...
        return PendingIntent.getActivity(context, i2, launchIntentForPackage, Build.VERSION.SDK_INT >= 31 ? 201326592 : DownloadExpSwitchCode.BUGFIX_SIGBUS_24_25);
    }
