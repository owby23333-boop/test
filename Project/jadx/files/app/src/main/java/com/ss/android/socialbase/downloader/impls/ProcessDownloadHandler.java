...
public class ProcessDownloadHandler implements IDownloadProxy {
    ...
    public void addDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2) {
        ...
        if (absDownloadEngine != null) {
            absDownloadEngine.addDownloadListener(i2, i3, iDownloadListener, listenerType, z2);
        }
    }
    ...
    public void cancel(int i2, boolean z2) {
        AbsDownloadEngine absDownloadEngine = this.downloadEngine;
        if (absDownloadEngine != null) {
            absDownloadEngine.cancel(i2, z2);
        }
    }
    ...
    public void clearDownloadData(int i2, boolean z2) {
        AbsDownloadEngine absDownloadEngine = this.downloadEngine;
        if (absDownloadEngine != null) {
            absDownloadEngine.clearDownloadData(i2, z2);
        }
    }
    ...
    public void removeDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2) {
        AbsDownloadEngine absDownloadEngine = this.downloadEngine;
        if (absDownloadEngine != null) {
            absDownloadEngine.removeDownloadListener(i2, i3, iDownloadListener, listenerType, z2);
        }
    }
    ...
    public void resetDownloadData(int i2, boolean z2) {
        AbsDownloadEngine absDownloadEngine = this.downloadEngine;
        if (absDownloadEngine != null) {
            absDownloadEngine.resetDownloadData(i2, z2);
        }
    }
    ...
    public void setDownloadWithIndependentProcessStatus(int i2, boolean z2) {
        DownloadProcessDispatcher.getInstance().setDownloadWithIndependentProcessStatus(i2, z2);
    }
    ...
    public ProcessDownloadHandler(boolean z2) {
    ...
    public void addDownloadListener(int i2, int i3, IDownloadListener iDownloadListener, ListenerType listenerType, boolean z2, boolean z3) {
        AbsDownloadEngine absDownloadEngine = this.downloadEngine;
        if (absDownloadEngine != null) {
            absDownloadEngine.addDownloadListener(i2, i3, iDownloadListener, listenerType, z2, z3);
        }
    }
