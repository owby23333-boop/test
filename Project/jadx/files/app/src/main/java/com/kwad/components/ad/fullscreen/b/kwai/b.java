...
public final class b extends com.kwad.components.ad.reward.presenter.a implements View.OnClickListener, com.kwad.components.core.webview.a.d.b {
    ...
    private void cc() {
        ...
        this.gM = com.kwad.sdk.core.response.a.c.bO(this.mAdTemplate);
    ...
    public void notifyAdClick() {
        com.kwad.sdk.core.report.a.a(this.mAdTemplate, 40, this.qS.mRootContainer.getTouchCoords(), this.qS.mReportExtData);
    ...
    public final void ar() {
        super.ar();
        this.gO = com.kwad.components.ad.reward.j.c(this.qS);
        if (this.gO) {
    ...
    public final void onClick(View view) {
        if (view == this.gL) {
            com.kwad.components.core.d.b.a.a(new a.C0395a(view.getContext()).J(this.mAdTemplate).b(this.mApkDownloadHelper).ao(40).an(1).al(false).am(this.qS.fY()).ap(1).a(new a.b() { // from class: com.kwad.components.ad.fullscreen.b.kwai.b.3
