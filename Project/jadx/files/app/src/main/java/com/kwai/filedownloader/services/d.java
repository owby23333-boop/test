...
public final class d extends b.a implements e.b, i {
    private final RemoteCallbackList<com.kwai.filedownloader.b.a> aHE = new RemoteCallbackList<>();
    private final g aHF;
    ...
    private synchronized int v(MessageSnapshot messageSnapshot) {
        ...
        iBeginBroadcast = this.aHE.beginBroadcast();
        for (int i2 = 0; i2 < iBeginBroadcast; i2++) {
            try {
                try {
                    ((com.kwai.filedownloader.b.a) this.aHE.getBroadcastItem(i2)).q(messageSnapshot);
