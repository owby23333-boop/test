...
public final class d extends a {
    ...
    private d(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, null);
        this.jG = -1;
        this.jz = new com.kwad.components.core.webview.a.d.b() { // from class: com.kwad.components.ad.interstitial.e.d.1
            @Override // com.kwad.components.core.webview.a.d.b
            public final void u(String str) {
                if (com.kwad.components.core.webview.a.i.b("ksad-interstitial-card", d.this.mAdTemplate).equals(str)) {
                    d.a(d.this, false);
                    com.kwad.components.ad.interstitial.c.b bVar = d.this.lS;
                    if (bVar != null) {
                        bVar.ko();
                    }
                    d dVar = d.this;
