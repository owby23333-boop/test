...
public abstract class GenerateProxyActivity extends Activity implements b {
    ...
    public boolean moveTaskToBack(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        return generatePluginActivity != null ? generatePluginActivity.moveTaskToBack(z2) : super.moveTaskToBack(z2);
    }
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i2, boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onApplyThemeResource(theme, i2, z2);
        } else {
    ...
    public void onMultiWindowModeChanged(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onMultiWindowModeChanged(z2);
        } else {
    ...
    public void onPictureInPictureModeChanged(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onPictureInPictureModeChanged(z2);
        } else {
    ...
    public void onTopResumedActivityChanged(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onTopResumedActivityChanged(z2);
        } else {
    ...
    public void onWindowFocusChanged(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onWindowFocusChanged(z2);
        } else {
    ...
    public boolean requestVisibleBehind(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        return generatePluginActivity != null ? generatePluginActivity.requestVisibleBehind(z2) : super.requestVisibleBehind(z2);
    }
    ...
    public void setFinishOnTouchOutside(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.setFinishOnTouchOutside(z2);
        } else {
    ...
    public void setImmersive(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.setImmersive(z2);
        } else {
    ...
    public void setInheritShowWhenLocked(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.setInheritShowWhenLocked(z2);
        } else {
    ...
    public void setShowWhenLocked(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.setShowWhenLocked(z2);
        } else {
    ...
    public boolean setTranslucent(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        return generatePluginActivity != null ? generatePluginActivity.setTranslucent(z2) : super.setTranslucent(z2);
    }
    ...
    public void setTurnScreenOn(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.setTurnScreenOn(z2);
        } else {
    ...
    public void setVisible(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.setVisible(z2);
        } else {
            super.setVisible(z2);
        }
    }
    ...
    public void setVrModeEnabled(boolean z2, ComponentName componentName) throws PackageManager.NameNotFoundException {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.setVrModeEnabled(z2, componentName);
        } else {
    ...
    public void startSearch(String str, boolean z2, Bundle bundle, boolean z3) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.startSearch(str, z2, bundle, z3);
        } else {
    ...
    public void takeKeyEvents(boolean z2) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.takeKeyEvents(z2);
        } else {
    ...
    public void onMultiWindowModeChanged(boolean z2, Configuration configuration) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onMultiWindowModeChanged(z2, configuration);
        } else {
            super.onMultiWindowModeChanged(z2, configuration);
        }
    }
    ...
    public void onPictureInPictureModeChanged(boolean z2, Configuration configuration) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onPictureInPictureModeChanged(z2, configuration);
        } else {
            super.onPictureInPictureModeChanged(z2, configuration);
        }
    }
