...
public class KsFragment extends AbstractIFragmentLifecycle implements IFragment, IFragmentLifecycle {
    ...
    @Override // com.kwad.sdk.api.core.fragment.AbstractIFragmentLifecycle, com.kwad.sdk.api.core.fragment.IFragmentLifecycle
    public /* bridge */ /* synthetic */ Animator onCreateAnimator(int i2, boolean z2, int i3) {
    ...
    @Override // com.kwad.sdk.api.core.fragment.AbstractIFragmentLifecycle, com.kwad.sdk.api.core.fragment.IFragmentLifecycle
    public /* bridge */ /* synthetic */ void onPictureInPictureModeChanged(boolean z2) {
    ...
    public final void setAllowEnterTransitionOverlap(boolean z2) {
        this.mBase.setAllowEnterTransitionOverlap(z2);
    }
    ...
    public final void setAllowReturnTransitionOverlap(boolean z2) {
        this.mBase.setAllowReturnTransitionOverlap(z2);
    }
    ...
    public final void setHasOptionsMenu(boolean z2) {
        this.mBase.setHasOptionsMenu(z2);
    }
    ...
    public final void setMenuVisibility(boolean z2) {
        this.mBase.setMenuVisibility(z2);
    }
    ...
    public final void setRetainInstance(boolean z2) {
        this.mBase.setRetainInstance(z2);
    }
    ...
    public void setUserVisibleHint(boolean z2) {
        this.mBase.setUserVisibleHint(z2);
    }
    ...
    @KsAdSdkDynamicApi
    @Keep
    public final void startIntentSenderForResult(IntentSender intentSender, int i2, @Nullable Intent intent, int i3, int i4, int i5, Bundle bundle) throws IntentSender.SendIntentException {
