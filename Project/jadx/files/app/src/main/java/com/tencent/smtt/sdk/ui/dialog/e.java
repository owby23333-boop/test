...
public class e {
    public static String[][] a = {new String[]{".3gp", o.f9862g}, new String[]{com.anythink.china.common.a.a.f6395g, "application/vnd.Android.package-archive"}, new String[]{".asf", "video/x-ms-asf"}, new String[]{".avi", "video/x-msvideo"}, new String[]{".bin", HttpClientUtil.APPLICATION_OCTET_STREAM}, new String[]{".bmp", "image/bmp"}, new String[]{".c", am.f12848e}, new String[]{".class", HttpClientUtil.APPLICATION_OCTET_STREAM}, new String[]{".conf", am.f12848e}, new String[]{".cpp", am.f12848e}, new String[]{".doc", "application/msword"}, new String[]{".docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"}, new String[]{".xls", "application/vnd.ms-excel"}, new String[]{".xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}, new String[]{".exe", HttpClientUtil.APPLICATION_OCTET_STREAM}, new String[]{".gif", "image/gif"}, new String[]{".gtar", "application/x-gtar"}, new String[]{com.kuaishou.weapon.p0.d.b, "application/x-gzip"}, new String[]{".h", am.f12848e}, new String[]{".htm", "text/html"}, new String[]{".html", "text/html"}, new String[]{".jar", "application/java-archive"}, new String[]{".java", am.f12848e}, new String[]{".jpeg", "image/jpeg"}, new String[]{".jpg", "image/jpeg"}, new String[]{".js", "application/x-javascript"}, new String[]{com.anythink.china.common.a.a.f6394f, am.f12848e}, new String[]{".m3u", "audio/x-mpegurl"}, new String[]{".m4a", o.f9873r}, new String[]{".m4b", o.f9873r}, new String[]{".m4p", o.f9873r}, new String[]{".m4u", "video/vnd.mpegurl"}, new String[]{".m4v", "video/x-m4v"}, new String[]{".mov", "video/quicktime"}, new String[]{".mp2", "audio/x-mpeg"}, new String[]{".mp3", "audio/x-mpeg"}, new String[]{".mp4", o.f9860e}, new String[]{".mpc", "application/vnd.mpohun.certificate"}, new String[]{".mpe", o.f9868m}, new String[]{".mpeg", o.f9868m}, new String[]{".mpg", o.f9868m}, new String[]{".mpg4", o.f9860e}, new String[]{".mpga", o.f9875t}, new String[]{".msg", "application/vnd.ms-outlook"}, new String[]{".ogg", "audio/ogg"}, new String[]{".pdf", "application/pdf"}, new String[]{".png", "image/png"}, new String[]{".pps", "application/vnd.ms-powerpoint"}, new String[]{".ppt", "application/vnd.ms-powerpoint"}, new String[]{".pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation"}, new String[]{".prop", am.f12848e}, new String[]{".rc", am.f12848e}, new String[]{".rmvb", "audio/x-pn-realaudio"}, new String[]{".rtf", "application/rtf"}, new String[]{".sh", am.f12848e}, new String[]{".tar", "application/x-tar"}, new String[]{".tgz", "application/x-compressed"}, new String[]{".txt", am.f12848e}, new String[]{".wav", "audio/x-wav"}, new String[]{".wma", "audio/x-ms-wma"}, new String[]{".wmv", "audio/x-ms-wmv"}, new String[]{".wps", "application/vnd.ms-works"}, new String[]{".xml", am.f12848e}, new String[]{".z", "application/x-compress"}, new String[]{".zip", "application/zip"}, new String[]{".7z", "application/7z"}, new String[]{"", "*/*"}};
    ...
    public static Drawable a(String str) {
        ...
        if ("x5_tbs_activity_picker_check".equals(str)) {
            return new BitmapDrawable(c(f19134c));
        }
        return null;
    }
    ...
    public static String d(String str) {
        ...
        String strSubstring = str.substring(str.lastIndexOf(".") + 1, str.length());
        ...
        while (true) {
            ...
            if (str2.equalsIgnoreCase(strArr[i2][0])) {
                mimeTypeFromExtension = a[i2][1];
                break;
            }
            i2++;
        }
        if ("*/*".equalsIgnoreCase(mimeTypeFromExtension)) {
        ...
        map.put("3gp", o.f9862g);
        map.put("chm", am.f12848e);
