...
public final class cv implements com.kwad.sdk.core.d<AdStyleInfo.ExtraDisplayInfo> {
    private static void a(AdStyleInfo.ExtraDisplayInfo extraDisplayInfo, JSONObject jSONObject) {
        ...
        if (jSONArrayOptJSONArray != null) {
            for (int i2 = 0; i2 < jSONArrayOptJSONArray.length(); i2++) {
                ...
                exposeTagInfo.parseJson(jSONArrayOptJSONArray.optJSONObject(i2));
    ...
    private static JSONObject b(AdStyleInfo.ExtraDisplayInfo extraDisplayInfo, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.s.putValue(jSONObject, "exposeTagInfoList", extraDisplayInfo.exposeTagInfoList);
        return jSONObject;
    }
