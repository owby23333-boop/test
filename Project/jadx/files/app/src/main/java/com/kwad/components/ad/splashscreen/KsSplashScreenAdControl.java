...
public class KsSplashScreenAdControl extends AbstrackKsSplashScreenAd implements com.kwad.components.core.internal.api.a {
    ...
    private com.kwad.sdk.core.g.b cb = new com.kwad.sdk.core.g.b() { // from class: com.kwad.components.ad.splashscreen.KsSplashScreenAdControl.1
        @Override // com.kwad.sdk.core.g.b
        public final void ap() {
            KsSplashScreenAdControl.this.ch.a(KsSplashScreenAdControl.this);
        }

        @Override // com.kwad.sdk.core.g.b
        public final void aq() {
            KsSplashScreenAdControl.this.ch.b(KsSplashScreenAdControl.this);
        }
    };
    ...
    protected KsFragment getFragment2(KsSplashScreenAd.SplashScreenAdInteractionListener splashScreenAdInteractionListener) {
        ...
        if (aVar != null) {
            return aVar.a(this.BM, this.cb, splashScreenAdInteractionListener);
        }
        return null;
    }
    ...
    public View getView2(Context context, KsSplashScreenAd.SplashScreenAdInteractionListener splashScreenAdInteractionListener) {
        ...
        KSLoggerReporter.ReportClient.CORE_CONVERT.buildMethodCheck(BusinessType.AD_SPLASH, "callShow").report();
        return c.a(context, this.BM, this.cb, splashScreenAdInteractionListener);
    }
    ...
    public boolean isAdEnable() {
        ...
        return SplashPreloadManager.g(this.BM);
    }

    @Override // com.kwad.sdk.api.KsSplashScreenAd
    public boolean isVideo() {
        return com.kwad.sdk.core.response.a.a.aV(com.kwad.sdk.core.response.a.d.cb(this.BM.getAdTemplateList().get(0)));
    }
