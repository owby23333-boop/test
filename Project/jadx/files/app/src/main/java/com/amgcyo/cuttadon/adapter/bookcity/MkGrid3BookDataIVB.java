...
public class MkGrid3BookDataIVB extends me.drakeet.multitype.b<ItemsGrid3Book, ViewHolder> {
    ...
    public MkGrid3BookDataIVB(me.jessyan.art.c.e.c cVar) {
        this.b = cVar;
    }
    ...
    public ViewHolder a(@NonNull LayoutInflater layoutInflater, @NonNull ViewGroup viewGroup) {
        return new ViewHolder(layoutInflater.inflate(R.layout.book_city_end_book, viewGroup, false));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // me.drakeet.multitype.b
    public void a(@NonNull ViewHolder viewHolder, @NonNull final ItemsGrid3Book itemsGrid3Book) {
        final Context context = viewHolder.itemView.getContext();
        this.b.a(context, ImageConfigImpl.builder().imageRadius(8).url(String.format("%s%s", com.amgcyo.cuttadon.utils.otherutils.g.e(itemsGrid3Book.getForm()), itemsGrid3Book.getImage())).imageView(viewHolder.iv_bookImg).build());
        viewHolder.tv_bookName.setText(itemsGrid3Book.getName());
        String author = itemsGrid3Book.getAuthor();
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.amgcyo.cuttadon.adapter.bookcity.i
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Context context2 = context;
                ItemsGrid3Book itemsGrid3Book2 = itemsGrid3Book;
                r0.a(context2, itemsGrid3Book2.getBook_id(), itemsGrid3Book2.getForm());
            }
        });
    }
}
