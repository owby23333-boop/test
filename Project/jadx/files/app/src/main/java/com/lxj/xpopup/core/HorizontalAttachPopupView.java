    ...
    public void y() {
        ...
        if (bVar.f17416k != null) {
            ...
            if (zD) {
                ...
                f2 = B() ? (this.f17361s.f17416k.x - measuredWidth) - this.O : this.f17361s.f17416k.x + this.O;
            }
            fHeight = (this.f17361s.f17416k.y - (measuredHeight * 0.5f)) + this.N;
        } else {
            int[] iArr = new int[2];
            ...
            f2 = i2;
            fHeight = rect.top + ((rect.height() - measuredHeight) / 2) + this.N;
        }
