...
public class UMCrashManager {
        ...
        try {
            synchronized (mObject) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    String str2 = context.getFilesDir() + File.separator + com.umeng.commonsdk.stateless.a.f20031f;
    ...
    public static void reportCrash(Context context, Throwable th) {
        synchronized (mObject) {
            if (!isReportCrash) {
                isReportCrash = true;
                UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f19989u, b.a(context).a(), a.a(th));
            }
        }
    }
}
