...
public final class di implements com.kwad.sdk.core.d<AdMatrixInfo.FullScreenInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.FullScreenInfo fullScreenInfo, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.s.a(jSONObject, "interactionInfo", fullScreenInfo.interactionInfo);
        return jSONObject;
    }
