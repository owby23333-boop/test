...
public abstract class AbsNotificationListener extends AbsDownloadListener implements IDownloadExtListener {
    ...
    private void updateNotification(int i2, DownloadInfo downloadInfo, BaseException baseException, boolean z2) {
        ...
        notificationItem.refreshStatus(i2, baseException, z2);
    }
