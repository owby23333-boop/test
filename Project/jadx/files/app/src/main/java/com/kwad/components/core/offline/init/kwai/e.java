...
final class e implements IImageLoader {
    ...
    /* JADX INFO: renamed from: com.kwad.components.core.offline.init.kwai.e$2, reason: invalid class name */
    final class AnonymousClass2 implements ImageLoadingListener {
        final /* synthetic */ ImageView CK;
        final /* synthetic */ IImageLoader.ImageLoadingListener Kn;
        final /* synthetic */ IImageLoader.DisplayImageOptionsCompat Kp;
        ...
        public final boolean onDecode(String str, InputStream inputStream, DecodedResult decodedResult) {
            return this.Kn.onDecode(str, inputStream, decodedResult == null ? null : decodedResult.mBitmap);
        }
            ...
            if (displayImageOptionsCompat == null || displayImageOptionsCompat.getBlurRadius() <= 0 || decodedResult == null || decodedResult.mBitmap == null) {
                ...
                com.kwad.sdk.core.threads.b.yc().submit(new Runnable() { // from class: com.kwad.components.core.offline.init.kwai.e.2.1
                    ...
                    public final void run() {
                        final Bitmap bitmapStackBlur = BlurUtils.stackBlur(decodedResult.mBitmap, AnonymousClass2.this.Kp.getBlurRadius(), false);
                        bh.runOnUiThread(new Runnable() { // from class: com.kwad.components.core.offline.init.kwai.e.2.1.1
                            @Override // java.lang.Runnable
                            public final void run() {
                                Bitmap bitmap;
                                AnonymousClass2.this.CK.setImageBitmap(bitmapStackBlur);
