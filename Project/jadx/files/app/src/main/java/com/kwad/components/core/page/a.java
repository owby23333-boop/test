...
public class a extends com.kwad.components.core.l.a implements a.InterfaceC0385a, z.b {
    ...
    private void oq() {
        this.mTitleBarHelper = new com.kwad.components.core.a.a(this.mRootContainer);
    ...
    public final void a(z.a aVar) {
        ...
        if (aVar.status != 1 || (aVar2 = this.py) == null) {
            return;
        }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        oq();
        this.py = new com.kwad.components.core.playable.a(ksAdWebView);
        this.py.a(this.mAdTemplate, this.mRootContainer, this.mApkDownloadHelper);
        this.py.a(this);
        this.py.po();
    }
    ...
    public final void v(View view) {
        com.kwad.sdk.core.report.a.b(this.mAdTemplate, new i().bg(6), (JSONObject) null);
        finish();
    }
}
