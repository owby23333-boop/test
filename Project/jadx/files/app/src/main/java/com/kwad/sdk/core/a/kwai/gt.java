...
public final class gt implements com.kwad.sdk.core.d<SDKInitMsg> {
    ...
    private static JSONObject b(SDKInitMsg sDKInitMsg, JSONObject jSONObject) {
        ...
        if (j2 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "init_launch_interval_time", j2);
        }
        long j3 = sDKInitMsg.totalDurationTime;
        if (j3 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "init_total_duration_time", j3);
        }
        com.kwad.sdk.utils.s.putValue(jSONObject, "init_status", sDKInitMsg.initStatus);
        String str = sDKInitMsg.errorReason;
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "error_reason", sDKInitMsg.errorReason);
        }
        int i2 = sDKInitMsg.initCount;
        if (i2 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "init_count", i2);
        }
        int i3 = sDKInitMsg.initProcess;
        if (i3 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "init_process", i3);
        }
        int i4 = sDKInitMsg.initThread;
        if (i4 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "init_thread", i4);
        }
        int i5 = sDKInitMsg.intDynamicSDK;
        if (i5 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "init_dynamic_sdk", i5);
        }
        int i6 = sDKInitMsg.intBuildNumber;
        if (i6 != 0) {
            com.kwad.sdk.utils.s.putValue(jSONObject, "init_build_number", i6);
        }
        return jSONObject;
    }
