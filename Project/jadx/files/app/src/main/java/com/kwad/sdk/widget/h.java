...
public final class h {
    ...
    public static class a {
        ...
        public final void setAllCorner(boolean z2) {
            this.leftTop = z2;
            this.topRight = z2;
            this.rightBottom = z2;
            this.bottomLeft = z2;
    ...
    public final void initAttrs(Context context, @Nullable AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            this.mRadius = typedArrayObtainStyledAttributes.getDimensionPixelOffset(Arrays.binarySearch(iArr, i2), 0);
            this.mClipBackground = typedArrayObtainStyledAttributes.getBoolean(Arrays.binarySearch(iArr, i3), true);
