...
public class c {
    ...
    private static final String f12237c = "RewardSettingManager";

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static Map<String, d> f12238e = new HashMap(3);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static volatile c f12239f;
    public a b;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private Object f12240d = new Object();
    ...
    public final d a(String str, String str2) {
        synchronized (this.f12240d) {
            ...
            if (f12238e.containsKey(str3)) {
                return f12238e.get(str3);
            }
            d dVarC = d.c(com.anythink.expressad.foundation.a.a.a.a().a(str3));
            f12238e.put(str3, dVarC);
            return dVarC;
        }
    }

    public final d a(String str, String str2, boolean z2) {
        d dVarA;
        synchronized (this.f12240d) {
            String str3 = "reward_" + str + "_" + str2;
            dVarA = f12238e.get(str3);
            if (dVarA == null) {
                dVarA = a(z2);
                f12238e.put(str3, dVarA);
            }
        }
        return dVarA;
    }
    ...
    public final void a(String str, boolean z2) {
        ...
        String strJ = a().a(com.anythink.expressad.foundation.b.a.b().e(), str, z2) != null ? d.J() : "";
