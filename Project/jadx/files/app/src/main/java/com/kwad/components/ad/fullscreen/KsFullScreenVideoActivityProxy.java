...
public class KsFullScreenVideoActivityProxy extends com.kwad.components.core.j.b<j> implements OnAdLiveResumeInterceptor {
    ...
    private void initVideoPlayConfig(@NonNull KsVideoPlayConfig ksVideoPlayConfig) {
        ...
        s.putValue(this.mReportExtData, "ext_showscene", ksVideoPlayConfig.getShowScene());
    }
    ...
    public boolean handledAdLiveOnResume() {
        return ((j) this.mCallerContext).fX();
    }
    ...
    public j onCreateCallerContext() {
        ...
        jVar.pz = new RewardActionBarControl(jVar, this.mContext, this.mAdTemplate);
        jVar.b(this.mPlayEndPageListener);
        if (com.kwad.sdk.core.response.a.b.bf(this.mAdTemplate)) {
            jVar.pA = new com.kwad.components.ad.reward.l(jVar, this.mReportExtData, null);
        }
        if (com.kwad.sdk.core.response.a.a.bu(this.mAdInfo)) {
        ...
        if (com.kwad.sdk.core.response.a.a.am(this.mAdInfo)) {
            jVar.pC = new com.kwad.components.ad.i.a().ah(false);
        }
        jVar.pN = false;
        jVar.qg = com.kwad.sdk.core.response.a.a.bu(this.mAdInfo) ? com.kwad.sdk.core.response.a.a.aj(this.mAdInfo) : com.kwad.sdk.core.response.a.a.ae(this.mAdInfo);
    ...
    public Presenter onCreatePresenter() {
        ...
        getActivity();
        this.mFullScreenPresenter = new com.kwad.components.ad.fullscreen.b.b(this, this.mRootContainer, bVar, (j) this.mCallerContext);
    ...
    public void onDestroy() {
        ...
        if (adInfo != null) {
            String strE = com.kwad.sdk.core.response.a.a.E(adInfo);
