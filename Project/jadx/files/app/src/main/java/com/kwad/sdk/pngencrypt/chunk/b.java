...
public final class b {
    public static final byte[] avU = dT("IHDR");
    public static final byte[] avV = dT("PLTE");
    public static final byte[] avW = dT("IDAT");
    public static final byte[] avX = dT("IEND");
    private static byte[] avY = new byte[4096];
    public static Pattern avZ = Pattern.compile("[a-zA-Z][a-zA-Z][A-Z][a-zA-Z]");
    ...
    public static String d(byte[] bArr, int i2, int i3) {
        return new String(bArr, i2, i3, com.kwad.sdk.pngencrypt.n.avC);
    }

    public static byte[] dT(String str) {
        return str.getBytes(com.kwad.sdk.pngencrypt.n.avC);
    }
    ...
    public static String e(byte[] bArr, int i2, int i3) {
        return new String(bArr, i2, i3, com.kwad.sdk.pngencrypt.n.avD);
    }

    public static String i(byte[] bArr) {
        return new String(bArr, com.kwad.sdk.pngencrypt.n.avC);
    }
    ...
    private static void i(InputStream inputStream, OutputStream outputStream) {
        synchronized (avY) {
            while (true) {
                int i2 = inputStream.read(avY);
                if (i2 > 0) {
                    outputStream.write(avY, 0, i2);
                }
            }
        }
    }
    ...
    public static String j(byte[] bArr) {
        return new String(bArr, com.kwad.sdk.pngencrypt.n.avD);
    }
}
