...
public abstract class GenerateFragmentActivityWrapper extends FragmentActivity implements a {
    ...
    public boolean moveTaskToBack(boolean z2) {
        return this.mOriginActivity.moveTaskToBack(z2);
    }
    ...
    public void onMultiWindowModeChanged(boolean z2, Configuration configuration) {
        this.mOriginActivity.onMultiWindowModeChanged(z2, configuration);
    }
    ...
    public void onPictureInPictureModeChanged(boolean z2, Configuration configuration) {
        this.mOriginActivity.onPictureInPictureModeChanged(z2, configuration);
    }
    ...
    public void onTopResumedActivityChanged(boolean z2) {
        this.mOriginActivity.onTopResumedActivityChanged(z2);
    }
    ...
    public void onWindowFocusChanged(boolean z2) {
        this.mOriginActivity.onWindowFocusChanged(z2);
    }
    ...
    public boolean requestVisibleBehind(boolean z2) {
        return this.mOriginActivity.requestVisibleBehind(z2);
    }
    ...
    public void setFinishOnTouchOutside(boolean z2) {
        this.mOriginActivity.setFinishOnTouchOutside(z2);
    }

    @Override // android.app.Activity
    public void setImmersive(boolean z2) {
        this.mOriginActivity.setImmersive(z2);
    }

    @Override // android.app.Activity
    public void setInheritShowWhenLocked(boolean z2) {
        this.mOriginActivity.setInheritShowWhenLocked(z2);
    }
    ...
    public void setShowWhenLocked(boolean z2) {
        this.mOriginActivity.setShowWhenLocked(z2);
    }
    ...
    public boolean setTranslucent(boolean z2) {
        return this.mOriginActivity.setTranslucent(z2);
    }

    @Override // android.app.Activity
    public void setTurnScreenOn(boolean z2) {
        this.mOriginActivity.setTurnScreenOn(z2);
    }

    @Override // android.app.Activity
    public void setVisible(boolean z2) {
        this.mOriginActivity.setVisible(z2);
    }

    @Override // android.app.Activity
    public void setVrModeEnabled(boolean z2, ComponentName componentName) throws PackageManager.NameNotFoundException {
        this.mOriginActivity.setVrModeEnabled(z2, componentName);
    }
    ...
    public void startSearch(String str, boolean z2, Bundle bundle, boolean z3) {
        this.mOriginActivity.startSearch(str, z2, bundle, z3);
    }
    ...
    public void takeKeyEvents(boolean z2) {
        this.mOriginActivity.takeKeyEvents(z2);
    }
    ...
    public void onMultiWindowModeChanged(boolean z2) {
        this.mOriginActivity.onMultiWindowModeChanged(z2);
    }

    @Override // androidx.fragment.app.FragmentActivity, android.app.Activity
    public void onPictureInPictureModeChanged(boolean z2) {
        this.mOriginActivity.onPictureInPictureModeChanged(z2);
    }
