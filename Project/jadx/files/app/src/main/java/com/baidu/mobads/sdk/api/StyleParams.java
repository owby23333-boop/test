...
public class StyleParams {
    ...
    public static class Builder {
        ...
        public Builder setRegionClick(boolean z2) {
            this.mIsRegionClick = z2;
            return this;
        }

        public Builder setShowActionButton(boolean z2) {
            this.mIsShowActionButton = z2;
            return this;
        }

        public Builder setShowDialogFrame(boolean z2) {
            this.mIsShowDialog = z2;
            return this;
        }

        public Builder setShowDownloadInfo(boolean z2) {
            this.mIsShowDownloadInfo = z2;
            return this;
        }
