...
public class MkAuthorResultActivity extends BaseRefreshMoreRecyclerActivity<SearchPresenter> implements BaseQuickAdapter.g {
    ...
    public void handleMessage(@NonNull Message message) {
        ...
        if (message.f21197s == 825) {
            this.f2771s0 = (List) message.f21202x;
            if (com.amgcyo.cuttadon.utils.otherutils.g.a(this.f2771s0)) {
                showEmpty();
            } else {
                NewApiAd newApiAdA = com.amgcyo.cuttadon.app.o.c.a(n.L);
                if (newApiAdA != null) {
                    try {
                        this.f2771s0.add(2, new MkBook(newApiAdA, 1));
                    } catch (Exception e2) {
                        e2.printStackTrace();
                    }
                }
                this.f2256n0 = new p(this.f2771s0, this.G, true);
    ...
    public void initData(@Nullable Bundle bundle) {
        ...
        this.f2770r0 = extras.getString("book_author");
        int i2 = extras.getInt("form", 1);
        this.B.setText(String.format("%s · 的相关作品", this.f2770r0));
        ((SearchPresenter) this.f2276v).c(Message.a(this, new Object[]{this.f2770r0, Integer.valueOf(i2)}));
    }
    ...
    public void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
        ...
        try {
            MkBook mkBook = this.f2771s0.get(i2);
            if (mkBook == null) {
                return;
            }
