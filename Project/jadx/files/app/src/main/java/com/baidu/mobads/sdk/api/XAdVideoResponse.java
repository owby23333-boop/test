...
public class XAdVideoResponse implements PrerollVideoResponse {
    ...
    /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$baidu$mobads$sdk$api$NativeResponse$MaterialType = new int[NativeResponse.MaterialType.values().length];

        static {
            try {
                $SwitchMap$com$baidu$mobads$sdk$api$NativeResponse$MaterialType[NativeResponse.MaterialType.VIDEO.ordinal()] = 1;
