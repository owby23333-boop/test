...
public final class l extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void c(View view, final int i2) {
        if (view == this.eB) {
            ...
            com.kwad.components.core.d.b.a.a(new a.C0395a(com.kwad.sdk.b.kwai.a.C(this)).J(this.mAdTemplate).an(5).ao(i2).b(this.mApkDownloadHelper).ap(view == this.eG ? 1 : 2).al(view == this.eG).a(new a.b() { // from class: com.kwad.components.ad.feed.a.l.1
    ...
    public final void bindView(@NonNull AdTemplate adTemplate) {
        ...
        bm();
        com.kwad.sdk.b.kwai.a.a(this, this.ez, this.ft, this.eG, this.eB);
