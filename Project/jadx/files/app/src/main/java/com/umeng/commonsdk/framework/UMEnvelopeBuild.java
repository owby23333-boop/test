...
public class UMEnvelopeBuild {
    ...
    private static JSONObject add2CacheTable(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        ...
        contentValues.put(aq.f19513e, str2);
        contentValues.put(aq.f19514f, iVarA.c(jSONObject.toString()));
        contentValues.put(aq.f19515g, iVarA.c(jSONObject2.toString()));
        contentValues.put(aq.f19516h, String.valueOf(jCurrentTimeMillis));
        contentValues.put(aq.f19517i, uuidRandomUUID.toString());
        contentValues.put(aq.f19518j, str);
        contentValues.put(aq.f19519k, str3);
        ao.a(context).a(aq.f19511c, contentValues);
    ...
    */
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        ...
        if (!UMWorkDispatch.eventHasExist(com.umeng.commonsdk.internal.a.f19988t)) {
            UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f19988t, com.umeng.commonsdk.internal.b.a(context).a(), null);
        }
