...
public class SdkConfig {
    ...
    public static class Builder {
        ...
        @Keep
        @Deprecated
        public Builder canReadICCID(boolean z2) {
            this.canReadICCID = z2;
            return this;
        }
        ...
        @Keep
        @Deprecated
        public Builder canReadMacAddress(boolean z2) {
            this.canReadMacAddress = z2;
            return this;
        }

        @KsAdSdkApi
        @Keep
        public Builder canReadNearbyWifiList(boolean z2) {
            this.canReadNearbyWifiList = z2;
            return this;
        }
    ...
    public static SdkConfig create(String str) {
        ...
        try {
            ...
            builder.appId = jSONObject.optString(com.anythink.expressad.videocommon.e.b.f12231u);
            builder.appName = jSONObject.optString(DispatchConstants.APP_NAME);
            builder.appKey = jSONObject.optString(Constants.KEY_APP_KEY);
    ...
    public String toJson() {
        ...
        try {
            ...
            jSONObject.put(com.anythink.expressad.videocommon.e.b.f12231u, this.appId);
            jSONObject.put(DispatchConstants.APP_NAME, this.appName);
            jSONObject.put(Constants.KEY_APP_KEY, this.appKey);
