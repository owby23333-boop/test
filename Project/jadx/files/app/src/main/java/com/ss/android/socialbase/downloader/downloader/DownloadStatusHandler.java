...
public class DownloadStatusHandler {
    ...
    private boolean handleProgress(long j2, boolean z2) {
        boolean z3 = false;
        ...
        if (this.downloadInfo.isNeedPostProgress() && z2) {
            z3 = true;
        }
        onStatusChanged(4, null, z3);
        return z2;
    }

    private void handleRetry(BaseException baseException, boolean z2) {
        this.downloadCache.OnDownloadTaskRetry(this.downloadInfo.getId());
        onStatusChanged(z2 ? 7 : 5, baseException);
    }
    ...
    public void onRetry(BaseException baseException, boolean z2) {
        this.downloadInfo.setFirstDownload(false);
        this.msgPostDataBuffer.set(0L);
        handleRetry(baseException, z2);
    }

    public void onSingleChunkRetry(DownloadChunk downloadChunk, BaseException baseException, boolean z2) {
        this.downloadInfo.setFirstDownload(false);
        this.msgPostDataBuffer.set(0L);
        this.downloadCache.OnDownloadTaskRetry(this.downloadInfo.getId());
        onStatusChanged(z2 ? 10 : 9, baseException, true);
    }
    ...
    private void onStatusChanged(int i2, BaseException baseException, boolean z2) {
        ...
        if (z2 && this.mainThreadHandler != null && (((sparseArray = this.mainThreadListeners) != null && sparseArray.size() > 0) || ((sparseArray2 = this.notificationListeners) != null && sparseArray2.size() > 0 && (this.downloadInfo.canShowNotification() || this.downloadInfo.isAutoInstallWithoutNotification())))) {
