...
public class CustomNotification {
    ...
    @TargetApi(16)
    public Notification getCustomNotification(Context context, String str, String str2, Bitmap bitmap, String str3, String str4, String str5, boolean z2, int i2, int i3, String str6, PendingIntent pendingIntent) {
        ...
        return builder.setSmallIcon(i3).setOngoing(false).setTicker(str2).setAutoCancel(z2).setWhen(System.currentTimeMillis()).setCustomContentView(remoteViews).build();
    }
}
