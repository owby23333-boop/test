...
public class AdLiveEndResultData extends BaseResultData {
    ...
    public static class AdLivePushEndInfo implements com.kwad.sdk.core.b, Serializable {
        ...
        public JSONObject toJson() {
            ...
            s.putValue(jSONObject, "totalWatchingDuration", this.mTotalWatchingDuration);
            s.putValue(jSONObject, "watchingUserCount", this.mWatchingUserCount);
            s.putValue(jSONObject, "displayWatchingUserCount", this.mDisplayWatchingUserCount);
            s.putValue(jSONObject, "liveDuration", this.mLiveDuration);
            s.putValue(jSONObject, "likeUserCount", this.mLikeUserCount);
            s.putValue(jSONObject, "displayLikeUserCount", this.mDisplayLikeUserCount);
            return jSONObject;
        }
    }
