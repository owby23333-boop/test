...
public final class b {
    ...
    public static com.kwad.sdk.core.network.idc.kwai.a ba(Context context) {
        try {
            return com.kwad.sdk.core.network.idc.kwai.a.bT(h.z(context, "ksad_idc.json"));
    ...
    public static com.kwad.sdk.core.network.idc.kwai.a bb(Context context) {
        return com.kwad.sdk.core.network.idc.kwai.a.bT(x.d(context, "ksadsdk_idc", "idc_data", ""));
    }

    public static Map<String, String> bc(Context context) {
        return s.parseJSON2MapString(x.d(context, "ksadsdk_idc", "idc_current", ""));
    }
}
