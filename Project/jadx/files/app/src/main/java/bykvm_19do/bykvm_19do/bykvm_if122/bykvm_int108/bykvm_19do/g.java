...
public class g extends d {
    ...
    public g(Context context, GMNetworkRequestInfo gMNetworkRequestInfo) {
        ...
        if (gMNetworkRequestInfo != null) {
            this.f1732c = gMNetworkRequestInfo.getAppId();
        }
    }

    @Override // bykvm_19do.bykvm_19do.bykvm_if122.bykvm_int108.bykvm_19do.c
    protected String a() {
        return TextUtils.isEmpty(this.f1732c) ? "appId为空" : "";
    }
    ...
    protected Map<String, Object> d() {
        ...
        map.put("app_id", this.f1732c);
        map.put("app_name", bykvm_19do.bykvm_19do.bykvm_if122.bykvm_19do.b.J().i());
        return map;
    }
}
