...
public final class a {
    ...
    private static Field f1965d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static boolean f1966e;
    ...
    public static int c(Context context) {
        ...
        if (f1965d == null && clsA != null) {
            try {
                f1965d = clsA.getDeclaredField("VERSION_CODE");
    ...
    public static String d(Context context) {
        Class<?> clsA = a(context);
        if (f1964c == null && clsA != null) {
            try {
                f1964c = clsA.getDeclaredField("VERSION_NAME");
            } catch (NoSuchFieldException unused) {
            }
        }
        Field field = f1964c;
                            ...
                            while (true) {
                                if (it.hasNext()) {
                                    ...
                                    if (next.importance == 100) {
                                        zEquals = packageName.equals(next.pkgList[0]);
                                        break;
                                    }
                                }
                            }
    ...
    public static boolean g(Context context) {
        ...
        if (strB == null || !strB.contains(":")) {
            return (strB != null && strB.equals(context.getPackageName())) || (strB != null && strB.equals(context.getApplicationInfo().processName));
        }
        return false;
    }
}
