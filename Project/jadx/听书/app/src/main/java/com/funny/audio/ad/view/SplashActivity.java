...
import com.funny.audio.databinding.ActivitySplashBinding;
...
public final class SplashActivity extends BaseActivity<ActivitySplashBinding> {
    ...
    private String tagName = "SplashActivity";
    ...
    public void initView() {
        ...
        this.codeId = setting.getSplashAd().getCodeId();
        ...
        ViewKt.click$default(qMUIFrameLayout, 0, new Function0<Unit>() { // from class: com.funny.audio.ad.view.SplashActivity.initView.1
            {
                super(0);
            }
    ...
    */
    private final void startTimeoutJob() {
        ...
        L1e:
            ...
            r2 = 0
            r3 = 0
            com.funny.audio.ad.view.SplashActivity$startTimeoutJob$1$newJob$1 r0 = new com.funny.audio.ad.view.SplashActivity$startTimeoutJob$1$newJob$1     // Catch: java.lang.Throwable -> L42
            r4 = 0
        ...
        L42:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.funny.audio.ad.view.SplashActivity.startTimeoutJob():void");
    }
    ...
    */
    private final void startWaitAdInitJob() {
        ...
        L1e:
            ...
            r2 = 0
            r3 = 0
            com.funny.audio.ad.view.SplashActivity$startWaitAdInitJob$1$newJob$1 r0 = new com.funny.audio.ad.view.SplashActivity$startWaitAdInitJob$1$newJob$1     // Catch: java.lang.Throwable -> L42
            r4 = 0
            r0.<init>(r7, r4)     // Catch: java.lang.Throwable -> L42
            r4 = r0
            kotlin.jvm.functions.Function2 r4 = (kotlin.jvm.functions.Function2) r4     // Catch: java.lang.Throwable -> L42
        ...
        L42:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.funny.audio.ad.view.SplashActivity.startWaitAdInitJob():void");
    }
    ...
    public final void loadSplashAd() {
        ...
        UIUtils.getScreenWidthDp(splashActivity);
        UIUtils.px2dip(splashActivity, screenHeightInPx * 1.0f);
        ...
        if (tTAdNative != null) {
            tTAdNative.loadSplashAd(adSlotBuild, new TTAdNative.CSJSplashAdListener() { // from class: com.funny.audio.ad.view.SplashActivity.loadSplashAd.1
                ...
                public void onSplashLoadFail(CSJAdError error) {
                    Log.e(SplashActivity.this.getTagName(), "开屏广告加载失败：" + (error != null ? Integer.valueOf(error.getCode()) : null) + " | " + (error != null ? error.getMsg() : null));
                }

                @Override // com.bytedance.sdk.openadsdk.TTAdNative.CSJSplashAdListener
                public void onSplashRenderSuccess(CSJSplashAd ad) {
                    SplashActivity.this.setSplashAd(ad);
                    SplashActivity.this.showSplashAd(ad);
                }

                @Override // com.bytedance.sdk.openadsdk.TTAdNative.CSJSplashAdListener
                public void onSplashRenderFail(CSJSplashAd ad, CSJAdError error) {
                    Log.e(SplashActivity.this.getTagName(), "开屏广告渲染失败：" + (error != null ? Integer.valueOf(error.getCode()) : null) + " | " + (error != null ? error.getMsg() : null));
                    SplashActivity.this.toMain();
                }
            }, this.AD_TIME_OUT);
        }
    ...
    public final void showSplashAd(CSJSplashAd ad) {
        ...
        ad.setSplashAdListener(new CSJSplashAd.SplashAdListener() { // from class: com.funny.audio.ad.view.SplashActivity.showSplashAd.1
    ...
    public final void toMain() {
        if (this.flag) {
            this.flag = false;
            NavigationUtils.INSTANCE.toMain(this);
