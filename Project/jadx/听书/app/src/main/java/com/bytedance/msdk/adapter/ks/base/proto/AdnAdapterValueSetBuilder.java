...
public class AdnAdapterValueSetBuilder {
    ...
    private final SparseArray<Object> f344a;
    ...
    private static final class ValueSetImpl implements ValueSet {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final SparseArray<Object> f345a;
        private int b;
        ...
        public boolean containsKey(int i) {
            return this.f345a.indexOfKey(i) >= 0;
        }
        ...
        public Set<Integer> keys() {
            ...
            for (int i = 0; i < size; i++) {
                hashSet.add(Integer.valueOf(this.f345a.keyAt(i)));
            }
            this.b = hashSet.size();
            return hashSet;
        }
        ...
        public SparseArray<Object> sparseArray() {
            SparseArray<Object> sparseArray = this.f345a;
    ...
    private AdnAdapterValueSetBuilder(SparseArray<Object> sparseArray) {
        this.f344a = sparseArray == null ? new SparseArray<>() : sparseArray;
    }
