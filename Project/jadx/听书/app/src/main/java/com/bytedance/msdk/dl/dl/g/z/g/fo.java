...
public class fo {
    ...
    public void z(boolean z2, lq lqVar, com.bytedance.sdk.openadsdk.ls.dl.dl.g gVar, final com.bytedance.msdk.dl.dl.g.z.g gVar2) {
        if (lqVar == null || gVar2 == null) {
            return;
        }
        this.z = z2;
        lqVar.z(gVar, new com.bytedance.sdk.openadsdk.tb.z.g.z.m(null) { // from class: com.bytedance.msdk.dl.dl.g.z.g.fo.1
            ...
            public void z(List<v> list) {
                ...
                for (v vVar : list) {
                    if (vVar != null) {
                        arrayList.add(fo.this.new z(vVar));
                    }
                }
                gVar2.z(arrayList);
            }
    ...
    class z extends com.bytedance.msdk.g.dl {
        ...
        com.bytedance.sdk.openadsdk.uf.z.g.z.dl kb;
        com.bytedance.sdk.openadsdk.uf.z.g.z.g uy;
        ...
        z(v vVar) {
            ...
            this.uy = new com.bytedance.sdk.openadsdk.uf.z.g.z.g(function) { // from class: com.bytedance.msdk.dl.dl.g.z.g.fo.z.2
                ...
                public void z(View view, String str, int i) {
                    if (z.this.z instanceof com.bytedance.msdk.api.a.z.e.m) {
                        ((com.bytedance.msdk.api.a.z.e.m) z.this.z).z(view, str, i);
                    }
                }
                ...
                public void z(View view, float f, float f2) {
                    if (z.this.z instanceof com.bytedance.msdk.api.a.z.e.m) {
                        ((com.bytedance.msdk.api.a.z.e.m) z.this.z).z(f, f2);
                    }
                }
            };
            this.kb = new com.bytedance.sdk.openadsdk.uf.z.g.z.dl(function) { // from class: com.bytedance.msdk.dl.dl.g.z.g.fo.z.3
            ...
            wp(this.fo.dl());
            e(true);
            if (fo.this.z && (mapGz = vVar.gz()) != null) {
                double dZ = com.bytedance.msdk.z.dl.g.z(mapGz.get("price"));
                com.bytedance.msdk.z.gc.dl.z("TTMediationSDK_ECMP", "pangle 模板native 返回的 cpm价格：".concat(String.valueOf(dZ)));
                z(dZ <= 0.0d ? 0.0d : dZ);
            }
            z(MediationConstant.EXTRA_ADID, Long.valueOf(gm()));
            z(MediationConstant.EXTRA_CID, Long.valueOf(pd()));
            Map<String, Object> mapGz2 = this.fo.gz();
            if (mapGz2 != null) {
                a(mapGz2);
        ...
        public String mn() {
            v vVar = this.fo;
            if (vVar != null) {
                return com.bytedance.msdk.z.dl.g.dl(vVar.gz());
            }
            return null;
        }
        ...
        public void fv() {
            this.i = true;
            com.bytedance.msdk.z.gc.m.dl(new Runnable() { // from class: com.bytedance.msdk.dl.dl.g.z.g.fo.z.1
        ...
        public void z(Activity activity, com.bytedance.sdk.openadsdk.js.z.g.z.z zVar) {
            if (this.fo != null) {
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "pangle native express:  activity = " + activity + " pluginDislikeInteractionCallback:" + zVar);
                this.fo.z(activity, zVar);
            }
        }
        ...
        public void z(Dialog dialog, Integer[] numArr) {
            if (this.fo != null) {
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "pangle native express:  ttDislikeDialogAbstract = ".concat(String.valueOf(dialog)));
        ...
        public void ti(String str) {
            if (this.fo != null) {
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "pangle native express: uploadDislikeEvent event = ".concat(String.valueOf(str)));
                this.fo.z(str);
            }
        }
