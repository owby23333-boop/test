...
public class AdnAdapterBridgeWrapper extends AdnAdapterBaseFunction {
    ...
    private final Bridge f328a;

    public AdnAdapterBridgeWrapper(Bridge bridge) {
        this.f328a = bridge == null ? AdnAdapterValueSetBuilder.EMPTY_BRIDGE : bridge;
    }
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        return (T) this.f328a.call(i, AdnAdapterValueSetBuilder.create(sparseArray).build(), cls);
    }

    @Override // com.bytedance.msdk.adapter.gdt.base.proto.AdnAdapterBaseFunction
    public SparseArray<Object> get() {
        return AdnAdapterValueSetBuilder.converToSparseArray(this.f328a.values());
    }
