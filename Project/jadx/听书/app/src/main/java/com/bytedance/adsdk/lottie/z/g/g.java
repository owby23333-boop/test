...
public class g extends e<Integer> {
    public g(List<com.bytedance.adsdk.lottie.m.z<Integer>> list) {
        super(list);
    }
     ...
     */
    public int dl(com.bytedance.adsdk.lottie.m.z<Integer> zVar, float f) {
        Integer num;
        ...
        return com.bytedance.adsdk.lottie.gc.dl.z(com.bytedance.adsdk.lottie.gc.gz.g(f, 0.0f, 1.0f), zVar.z.intValue(), zVar.g.intValue());
    }
