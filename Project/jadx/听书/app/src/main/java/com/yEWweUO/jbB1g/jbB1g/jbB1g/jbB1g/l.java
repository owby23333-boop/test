...
public class l extends AdnAdapterBaseFunction implements Bridge {
    ...
    private UnifiedInterstitialAD f2508a;
    private Function<SparseArray<Object>, Object> b;
    private k c;
    private UnifiedInterstitialADListener d = new UnifiedInterstitialADListener() { // from class: com.yEWweUO.jbB1g.jbB1g.jbB1g.jbB1g.l.1
    ...
    private void a(Context context, String str) {
        ...
        if (context instanceof Activity) {
            this.f2508a = new UnifiedInterstitialAD((Activity) context, str, this.d);
    ...
    private void a(Map<String, Object> map) {
        ...
        if (map != null) {
            ...
            if (!(obj instanceof Integer) || (iIntValue = ((Integer) obj).intValue()) <= 0 || (unifiedInterstitialAD = this.f2508a) == null) {
                return;
            }
    ...
    private void c(Map<String, Object> map) {
        ...
        UnifiedInterstitialAD unifiedInterstitialAD = this.f2508a;
