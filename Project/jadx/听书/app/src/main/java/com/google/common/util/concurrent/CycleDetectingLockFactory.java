...
public class CycleDetectingLockFactory {
    ...
    private static String getLockName(Enum<?> r3) {
        ...
        return new StringBuilder(String.valueOf(simpleName).length() + 1 + String.valueOf(strName).length()).append(simpleName).append(FileUtils.FILE_EXTENSION_SEPARATOR).append(strName).toString();
    }
