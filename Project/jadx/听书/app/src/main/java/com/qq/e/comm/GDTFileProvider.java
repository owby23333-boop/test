...
public class GDTFileProvider extends ContentProvider {
    ...
    static class b implements a {
        ...
        public Uri a(File file) {
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.f1940a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(canonicalPath.substring(length), "/")).build();
            } catch (IOException unused) {
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f1939a = b(context, providerInfo.authority);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f1939a.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File fileA = this.f1939a.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.f1939a.a(uri), a(str));
    }
