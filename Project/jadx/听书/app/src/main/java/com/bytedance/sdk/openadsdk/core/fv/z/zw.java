...
public class zw extends com.bytedance.sdk.component.z.gc<JSONObject, JSONObject> {
    ...
    public static void z(com.bytedance.sdk.component.z.p pVar, com.bytedance.sdk.openadsdk.core.mc mcVar, WeakReference<com.bytedance.sdk.openadsdk.core.ugeno.e.g> weakReference) {
        pVar.z("pauseRewardCountDown", (com.bytedance.sdk.component.z.gc<?, ?>) new zw(mcVar, weakReference));
    }

    public zw(com.bytedance.sdk.openadsdk.core.mc mcVar, WeakReference<com.bytedance.sdk.openadsdk.core.ugeno.e.g> weakReference) {
        this.z = mcVar;
