...
public class a {
    ...
    private static Uri a(String str, Uri uri, String str2) {
        ...
        return Uri.parse("content://" + ContentProviderManager.getInstance().getSystemProviderInfoMap().get(pluginProcessNameByAuthority).g + File.separator + "proxy?provider_params=" + uy.z(z.z(pluginProcessNameByAuthority, str, uri)));
    }
    ...
    public static Bundle a(ContentResolver contentResolver, String str, String str2, String str3, Bundle bundle, String str4) {
        ...
        String str5 = ContentProviderManager.getInstance().getSystemProviderInfoMap().get(ContentProviderManager.getInstance().getPluginProcessNameByAuthority(str)).g;
        if (bundle == null) {
            bundle = new Bundle();
        }
