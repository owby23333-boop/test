...
public class dl extends com.bytedance.sdk.component.z.gc<JSONObject, JSONObject> {
    ...
    public static void z(com.bytedance.sdk.component.z.p pVar, SSWebView sSWebView, String str) {
        pVar.z("start_wobble_observer", (com.bytedance.sdk.component.z.gc<?, ?>) new dl(sSWebView, str));
    }
    ...
    public dl(SSWebView sSWebView, String str) {
        this.z = sSWebView;
        this.g = str;
    }
    ...
    public JSONObject dl() {
        ...
        try {
            if (com.bytedance.sdk.openadsdk.core.uy.ls().z(com.bytedance.sdk.openadsdk.core.zw.getContext()) && this.z != null) {
                ...
                this.z.z(1, com.bytedance.sdk.openadsdk.core.uy.ls().gc());
                return jSONObject;
            }
