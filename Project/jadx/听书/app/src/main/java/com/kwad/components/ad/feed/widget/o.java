...
public final class o extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    private void d(View view, final int i) {
        if (view == this.hC) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0333a(getContext()).az(5).aA(i).aB(this.mAdTemplate).b(this.mApkDownloadHelper).aB(view == this.hH ? 1 : 2).aq(view == this.hH).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.o.1
