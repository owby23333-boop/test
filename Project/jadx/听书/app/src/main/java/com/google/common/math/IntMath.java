...
public final class IntMath {
    ...
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, 720, ErrorCode.VIDEO_DURATION_ERROR, 40320, 362880, 3628800, 39916800, 479001600};
    static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_COUNT, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
