...
public final class GroupAlbumAdapter extends BaseQuickAdapter<AlbumInfo, QuickViewHolder> {
    ...
    public QuickViewHolder onCreateViewHolder(Context context, ViewGroup parent, int viewType) {
        ...
        return new QuickViewHolder(R.layout.adapter_group_album, parent);
    }
