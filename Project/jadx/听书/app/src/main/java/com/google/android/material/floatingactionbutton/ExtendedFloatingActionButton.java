...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, MediaFormat.KEY_WIDTH) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.6
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, MediaFormat.KEY_HEIGHT) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.7
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(MediaFormat.KEY_WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(MediaFormat.KEY_WIDTH);
                propertyValues[0].setFloatValues(ExtendedFloatingActionButton.this.getWidth(), this.size.getWidth());
                currentMotionSpec.setPropertyValues(MediaFormat.KEY_WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(MediaFormat.KEY_HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(MediaFormat.KEY_HEIGHT);
                propertyValues2[0].setFloatValues(ExtendedFloatingActionButton.this.getHeight(), this.size.getHeight());
                currentMotionSpec.setPropertyValues(MediaFormat.KEY_HEIGHT, propertyValues2);
            }
