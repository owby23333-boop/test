...
public final class DetailAlbumLikeAdapter extends BaseQuickAdapter<AlbumInfo, QuickViewHolder> {
    ...
    public QuickViewHolder onCreateViewHolder(Context context, ViewGroup parent, int viewType) {
        ...
        return new QuickViewHolder(R.layout.adapter_detail_like_album, parent);
    }
}
