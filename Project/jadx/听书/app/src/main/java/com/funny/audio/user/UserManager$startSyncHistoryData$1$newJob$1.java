...
@DebugMetadata(c = "com.funny.audio.user.UserManager$startSyncHistoryData$1$newJob$1", f = "UserManager.kt", i = {}, l = {104, AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, 112}, m = "invokeSuspend", n = {}, s = {})
final class UserManager$startSyncHistoryData$1$newJob$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;

    UserManager$startSyncHistoryData$1$newJob$1(Continuation<? super UserManager$startSyncHistoryData$1$newJob$1> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new UserManager$startSyncHistoryData$1$newJob$1(continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((UserManager$startSyncHistoryData$1$newJob$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:29:0x007c -> B:31:0x002b). Please report as a decompilation issue!!! */
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r10) {
        ...
        L41:
            ...
            java.lang.Object r1 = com.funny.audio.user.UserManager.access$syncPlayHistoryData(r1, r5)     // Catch: java.lang.Exception -> L4f
            if (r1 != r0) goto L70
            return r0
        L4f:
            r1 = move-exception
        ...
        L54:
            ...
            java.lang.String r7 = "同步用户播放历史数据作业出错: "
            r6.<init>(r7)
        ...
        L70:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.funny.audio.user.UserManager$startSyncHistoryData$1$newJob$1.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
