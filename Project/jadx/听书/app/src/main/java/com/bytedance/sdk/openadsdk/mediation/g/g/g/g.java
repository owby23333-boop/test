...
import com.bytedance.sdk.openadsdk.tb.z.g.z.dl;
...
public abstract class g implements Function<SparseArray<Object>, Object> {
    ...
    public abstract void z(String str, dl dlVar);
    ...
    public Object apply(SparseArray<Object> sparseArray) {
        ...
        if (iIntValue == 270028) {
            z((String) pluginValueSetG.objectValue(0, String.class), new dl((Function) pluginValueSetG.objectValue(1, Function.class)));
        }
        return null;
    }
}
