    ...
    static class AppStatusInfo implements com.kwad.sdk.core.b, Serializable {
        ...
        public void parseJson(JSONObject jSONObject) {
            ...
            try {
                ...
                JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(TypedValues.Attributes.S_TARGET);
        ...
        public JSONObject toJson() {
            ...
            aa.putValue(jSONObject, TypedValues.Attributes.S_TARGET, this.target);
    ...
    public static class Strategy implements com.kwad.sdk.core.b, Serializable {
        ...
        public void parseJson(JSONObject jSONObject) {
            ...
            try {
                ...
                setTarget(com.kwad.sdk.collector.model.c.d(jSONObject.optJSONArray(TypedValues.Attributes.S_TARGET)));
            } catch (Exception e) {
                com.kwad.sdk.core.d.c.printStackTrace(e);
            }
        }
        ...
        public JSONObject toJson() {
            JSONObject jSONObject = new JSONObject();
            aa.putValue(jSONObject, AnalyticsConfig.RTD_START_TIME, this.startTime);
            ...
            aa.putValue(jSONObject, TypedValues.Attributes.S_TARGET, getTarget());
