...
public final class ax {
    ...
    private static final Comparator f2182a = new a();
    ...
    public static int a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int iCompare = f2182a.compare(list.get(i), list2.get(i));
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int iCompare = f2182a.compare(it.next(), it2.next());
            if (iCompare != 0) {
                return iCompare;
            }
        }
