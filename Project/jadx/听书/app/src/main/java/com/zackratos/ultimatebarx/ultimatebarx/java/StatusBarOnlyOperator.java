...
public class StatusBarOnlyOperator extends BaseOperator {
    ...
    public StatusBarOnlyOperator(LifecycleOwner lifecycleOwner) {
        this(lifecycleOwner, BarConfig.INSTANCE.newInstance());
    }

    public StatusBarOnlyOperator(LifecycleOwner lifecycleOwner, BarConfig barConfig) {
    ...
    protected void applyActivity(FragmentActivity fragmentActivity) {
        UltimateBarXKt.statusBarOnly(fragmentActivity, this.config, (Function1<? super BarConfig, Unit>) null);
    }

    @Override // com.zackratos.ultimatebarx.ultimatebarx.java.BaseOperator
    protected void applyFragment(Fragment fragment) {
        UltimateBarXKt.statusBarOnly(fragment, this.config, (Function1<? super BarConfig, Unit>) null);
    }
}
