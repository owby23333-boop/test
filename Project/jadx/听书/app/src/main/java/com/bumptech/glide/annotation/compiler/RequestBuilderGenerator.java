...
final class RequestBuilderGenerator {
    ...
    TypeSpec generate(String str, Set<String> set, TypeSpec typeSpec) {
        ...
        this.generatedRequestBuilderOfTranscodeType = ParameterizedTypeName.get(className, this.transcodeTypeName);
        ...
        ParameterizedTypeName parameterizedTypeName = ParameterizedTypeName.get(ClassName.get("com.bumptech.glide", "RequestBuilder", new String[0]), this.transcodeTypeName);
