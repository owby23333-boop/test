...
public class e extends MediationNativeAd {
    ...
    private NativeExpressADView f1670a;
    ...
    public e(k kVar, GdtNativeLoader gdtNativeLoader, Function<SparseArray<Object>, Object> function, NativeExpressADView nativeExpressADView, boolean z) {
        ...
        this.b = false;
        this.e = new NativeExpressMediaListener() { // from class: com.jbB1g.jbB1g.jbB1g.jbB1g.e.1
        ...
        this.f1670a = nativeExpressADView;
        this.c = kVar;
        this.d = z;
        b();
    }
    ...
    private void a(Object obj) {
        ...
        if (this.d) {
            n.a(new Runnable() { // from class: com.jbB1g.jbB1g.jbB1g.jbB1g.e.6
                @Override // java.lang.Runnable
                public void run() {
                    e.this.f1670a.sendLossNotification(0, iA, null);
                }
            });
        } else {
            this.f1670a.sendLossNotification(0, iA, null);
        }
    }
    ...
    */
    private void b() {
        /*
            ...
            r0.<init>()
            com.qq.e.ads.nativ.NativeExpressADView r1 = r9.f1670a
            ...
            if (r2 != r3) goto L2e
            com.qq.e.ads.nativ.NativeExpressADView r2 = r9.f1670a
        ...
        L8e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jbB1g.jbB1g.jbB1g.jbB1g.e.b():void");
    }
    ...
    private String d() {
        try {
            return (String) n.a(new Callable<String>() { // from class: com.jbB1g.jbB1g.jbB1g.jbB1g.e.2
    ...
    public String e() {
        Object obj;
        try {
            NativeExpressADView nativeExpressADView = this.f1670a;
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        if (i == 6083) {
            if (this.d) {
                n.b(new Runnable() { // from class: com.jbB1g.jbB1g.jbB1g.jbB1g.e.3
                    @Override // java.lang.Runnable
                    public void run() {
                        if (e.this.f1670a != null) {
                            e.this.f1670a.render();
                        }
                    }
                });
            } else {
            ...
            if (i == 6081) {
                if (isServerBidding()) {
                    NativeExpressADView nativeExpressADView2 = this.f1670a;
                    nativeExpressADView2.setBidECPM(nativeExpressADView2.getECPM());
                }
                return (T) this.f1670a;
            }
            if (i == 8135) {
                return (T) true;
            }
            if (i == 8109) {
                this.b = true;
                if (this.c.a() != null) {
                    this.c.a().remove(this.f1670a);
                }
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.jbB1g.jbB1g.jbB1g.jbB1g.e.4
                    @Override // java.lang.Runnable
                    public void run() {
                        if (e.this.f1670a != null) {
                            e.this.f1670a.destroy();
                        }
                    }
                });
            } else {
                ...
                try {
                    if (i == 8142) {
                        NativeExpressADView nativeExpressADView3 = this.f1670a;
                        if (nativeExpressADView3 != null) {
                            if (this.d) {
                                n.a(new Runnable() { // from class: com.jbB1g.jbB1g.jbB1g.jbB1g.e.5
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        e.this.f1670a.sendWinNotification((int) e.this.getCpm());
                                    }
                                });
                            } else {
