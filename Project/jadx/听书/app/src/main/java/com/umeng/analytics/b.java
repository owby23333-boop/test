...
public class b implements n, t {
    ...
    private static Context f2154a = null;
    ...
    static {
        ...
        if (appContext != null) {
            f2154a = appContext.getApplicationContext();
        }
    }
    ...
    public void a(Context context) {
        ...
        try {
            ...
            if (UMUtils.isMainProgress(f2154a)) {
                ...
                UMWorkDispatch.registerConnStateObserver(CoreProtocol.getInstance(f2154a));
            }
    ...
    void a(Context context, Throwable th) {
        ...
        try {
            ...
            a(f2154a, DataHelper.convertExceptionToString(th));
        } catch (Exception e) {
            if (MLog.DEBUG) {
                MLog.e(e);
            }
    ...
    public void b(Context context, String str) {
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                map.put(d.aE, str);
                a(f2154a, d.aD, (Map<String, Object>) map, -1L, false);
                return;
            }
            UMLog.aq(j.O, 0, "\\|");
        } catch (Throwable th) {
    ...
    public void a(Context context, String str, String str2, long j, int i2) {
        ...
        try {
            ...
            s.a(f2154a).a(str, str2, j, i2, string);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    private void a(Context context, String str, Map<String, Object> map, long j, boolean z2) {
        try {
            ...
            s.a(f2154a).a(str, map, j, string, z2);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    void d(Context context) {
        ...
        try {
            ...
            if (context2 != null) {
                ...
                PreferenceWrapper.getDefault(f2154a).edit().commit();
            }
        } catch (Throwable unused) {
        }
    }
    ...
    public void a(Throwable th) {
        try {
            ...
            if (AnalyticsConfig.enable) {
                ...
                u uVar = this.f;
                if (uVar != null) {
                    uVar.c(f2154a, Long.valueOf(System.currentTimeMillis()));
                }
                if (th != null) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put("ts", System.currentTimeMillis());
                    ...
                    i.a(f2154a).a(this.f.c(), jSONObject.toString(), 1);
                }
                o.a(f2154a).d();
                v.a(f2154a);
                if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION == MobclickAgent.PageMode.AUTO) {
    ...
    void a(double d, double d2) {
        ...
        if (AnalyticsConfig.f2146a == null) {
            AnalyticsConfig.f2146a = new double[2];
        }
        AnalyticsConfig.f2146a[0] = d;
        AnalyticsConfig.f2146a[1] = d2;
    }
    ...
    void a(Context context, MobclickAgent.EScenarioType eScenarioType) {
        ...
        if (eScenarioType != null) {
            a(f2154a, eScenarioType.toValue());
        }
        if (this.j && this.n) {
            return;
        }
    ...
    public synchronized void a(Object obj) {
        ...
        if (obj != null) {
            ...
            SharedPreferences.Editor editorEdit = PreferenceWrapper.getDefault(f2154a).edit();
