...
public class LottieAnimationView extends AppCompatImageView {
        ...
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return this.f$0.m458lambda$fromRawRes$1$comairbnblottieLottieAnimationView(i);
                }
            }, true);
        }
    ...
    /* synthetic */ LottieResult m458lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
    ...
    private LottieTask<LottieComposition> fromAssets(final String str) {
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda2
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return this.f$0.m457lambda$fromAssets$2$comairbnblottieLottieAnimationView(str);
                }
            }, true);
        }
    ...
    /* synthetic */ LottieResult m457lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {
