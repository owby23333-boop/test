...
public abstract class GenerateProxyAppCompatActivity extends AppCompatActivity implements g {
    public Plugin mPlugin;
    public GeneratePluginAppCompatActivity mTargetActivity;

    @Override // com.bytedance.pangle.activity.g
    ...
    @Override // android.app.Activity, com.bytedance.pangle.activity.g
    public void finish() {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
