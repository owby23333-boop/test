...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(MediaFormat.KEY_WIDTH)) {
            arrayList.add(motionSpec.getAnimator(MediaFormat.KEY_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(MediaFormat.KEY_HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(MediaFormat.KEY_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
