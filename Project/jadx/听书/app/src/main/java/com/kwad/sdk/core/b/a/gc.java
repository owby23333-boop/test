...
public final class gc implements com.kwad.sdk.core.d<com.kwad.components.ad.interstitial.c.a> {
    ...
    private static void a(com.kwad.components.ad.interstitial.c.a aVar, JSONObject jSONObject) {
        ...
        aVar.lV = jSONObject.optInt("aggregateAdShowCount");
    }
    ...
    private static JSONObject b(com.kwad.components.ad.interstitial.c.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.lV != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "aggregateAdShowCount", aVar.lV);
        }
        return jSONObject;
    }
}
