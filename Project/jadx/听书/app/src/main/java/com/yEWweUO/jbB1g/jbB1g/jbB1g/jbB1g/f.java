...
public class f extends AdnAdapterBaseFunction implements Bridge {
    ...
    private NativeUnifiedADData f2498a;
    private Function<SparseArray<Object>, Object> b;
    private volatile boolean c = false;
    private NativeADMediaListener d = new NativeADMediaListener() { // from class: com.yEWweUO.jbB1g.jbB1g.jbB1g.jbB1g.f.1
    ...
    public f(NativeUnifiedADData nativeUnifiedADData) {
        this.f2498a = nativeUnifiedADData;
    }

    private void a(int i) {
        NativeUnifiedADData nativeUnifiedADData = this.f2498a;
    ...
    private void a(Map<String, Object> map) {
        int iA;
        if (map == null || this.f2498a == null || (iA = com.jbB1g.jbB1g.jbB1g.jbB1g.a.a(map.get(MediationConstant.BIDDING_LOSE_REASON))) <= 0) {
            return;
        }
        this.f2498a.sendLossNotification(0, iA, null);
    }
    ...
    private void i() {
        this.f2498a.setNativeAdEventListener(new NativeADEventListener() { // from class: com.yEWweUO.jbB1g.jbB1g.jbB1g.jbB1g.f.2
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        ...
        if (i == 40048) {
            NativeUnifiedADData nativeUnifiedADData2 = this.f2498a;
        ...
        if (i == 40049) {
            NativeUnifiedADData nativeUnifiedADData3 = this.f2498a;
        ...
        if (i == 40050) {
            NativeUnifiedADData nativeUnifiedADData4 = this.f2498a;
        ...
        if (i == 40051) {
            NativeUnifiedADData nativeUnifiedADData5 = this.f2498a;
        ...
        if (i == 40052) {
            NativeUnifiedADData nativeUnifiedADData6 = this.f2498a;
        ...
        if (i == 40010) {
            NativeUnifiedADData nativeUnifiedADData10 = this.f2498a;
        ...
        if (i == 40055) {
            ...
            NativeUnifiedADData nativeUnifiedADData11 = this.f2498a;
            ...
            if ((viewGroup2 instanceof MediaView) && (nativeUnifiedADData = this.f2498a) != null) {
            ...
            NativeUnifiedADData nativeUnifiedADData12 = this.f2498a;
            ...
            if (i == 40021) {
                NativeUnifiedADData nativeUnifiedADData13 = this.f2498a;
            ...
            if (i == 40061) {
                t.a("onResume");
                NativeUnifiedADData nativeUnifiedADData14 = this.f2498a;
                if (nativeUnifiedADData14 != null) {
                    nativeUnifiedADData14.resume();
                }
            } else if (i == 40062) {
                t.a("onPause");
                NativeUnifiedADData nativeUnifiedADData15 = this.f2498a;
                ...
                if (i == 40063) {
                    ...
                    NativeUnifiedADData nativeUnifiedADData16 = this.f2498a;
                    if (nativeUnifiedADData16 != null) {
                        nativeUnifiedADData16.pauseAppDownload();
                    }
                } else if (i == 40064) {
                    t.a("resumeAppDownload");
                    NativeUnifiedADData nativeUnifiedADData17 = this.f2498a;
                    ...
                    NativeUnifiedADData nativeUnifiedADData18 = this.f2498a;
                    if (nativeUnifiedADData18 != null) {
                        nativeUnifiedADData18.negativeFeedback();
                    }
                } else if (i == 40007 && this.f2498a != null) {
                    ...
                    this.f2498a.setBidECPM(iIntValue2);
                }
            }
        }
        return null;
