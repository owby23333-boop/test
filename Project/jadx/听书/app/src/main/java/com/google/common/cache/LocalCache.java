...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  (r0v0 com.google.common.cache.LocalCache$EntryFactory) from 0x0056: FILLED_NEW_ARRAY 
  (r0v0 com.google.common.cache.LocalCache$EntryFactory)
  (r1v1 com.google.common.cache.LocalCache$EntryFactory)
  (r2v2 com.google.common.cache.LocalCache$EntryFactory)
  ...
  (r6v2 com.google.common.cache.LocalCache$EntryFactory)
        ...
        V waitForLoadingValue(ReferenceEntry<K, V> referenceEntry, K k, ValueReference<K, V> valueReference) throws ExecutionException {
            ...
            try {
                ...
                if (vWaitForValue == null) {
                    ...
                    throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(String.valueOf(strValueOf).length() + 35).append("CacheLoader returned null for key ").append(strValueOf).append(FileUtils.FILE_EXTENSION_SEPARATOR).toString());
                }
