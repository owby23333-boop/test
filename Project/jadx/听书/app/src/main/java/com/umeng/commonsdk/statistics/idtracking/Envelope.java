    ...
    public void export(Context context) {
        ...
        try {
            ...
            if (strImprintProperty != null) {
                jSONObject.put(an.g, strImprintProperty);
            }
            jSONObject.put("signature", hexString);
            jSONObject.put("checksum", hexString2);
            File file = new File(context.getFilesDir(), z.b().b(z.b));
            if (!file.exists()) {
                file.mkdir();
            }
        ...
        try {
            ...
            if (strImprintProperty != null) {
                jSONObject2.put(an.g, HelperUtils.getUmengMD5(strImprintProperty));
            }
            HelperUtils.writeFile(new File(context.getFilesDir(), z.b().b(z.h)), jSONObject2.toString());
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
    }
