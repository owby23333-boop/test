...
public class fo implements TTFeedAd {
    private ValueSet g;
    ...
    public View getAdView() {
        View view = (View) this.g.objectValue(140016, View.class);
        com.bytedance.sdk.openadsdk.api.m.gc("wzj", "1-ApiFeed:view=".concat(String.valueOf(view)));
        return view;
    }
