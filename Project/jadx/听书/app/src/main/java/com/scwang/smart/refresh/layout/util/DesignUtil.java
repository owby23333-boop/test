            ...
            if (view instanceof CoordinatorLayout) {
                ...
                for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                    ...
                    if (childAt instanceof AppBarLayout) {
                        ((AppBarLayout) childAt).addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() { // from class: com.scwang.smart.refresh.layout.util.DesignUtil$$ExternalSyntheticLambda0
