...
public final class CategoryAlbumAdapter extends BaseQuickAdapter<AlbumInfo, QuickViewHolder> {
    ...
    public QuickViewHolder onCreateViewHolder(Context context, ViewGroup parent, int viewType) {
        ...
        return new QuickViewHolder(R.layout.adapter_category_album, parent);
    }
}
