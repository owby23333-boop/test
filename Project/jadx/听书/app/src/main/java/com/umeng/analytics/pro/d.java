...
public class d {
    ...
    public static final String f2216a = "appkey";
    ...
    public static final String al = z.b().b("bl");
    public static final String am = z.b().b(z.u);
    ...
    public static final String[] aH = {as, at, "_$!du", "_$!c", Y, "_$!sp", "event_name", "token", "time", "ip", an.O, TtmlNode.TAG_REGION, "city", "browser", an.x, an.F, "device_version", an.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", "hour", "minute", "app_version", "sp"};
}
