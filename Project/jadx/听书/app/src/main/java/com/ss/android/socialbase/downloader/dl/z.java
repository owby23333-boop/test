...
public class z extends SQLiteOpenHelper {
    ...
    private z() {
        super(new com.bytedance.sdk.openadsdk.api.plugin.z(com.ss.android.socialbase.downloader.downloader.dl.xl()), "downloader.db", (SQLiteDatabase.CursorFactory) null, 15);
        this.g = false;
    }
    ...
    public SQLiteDatabase getReadableDatabase() {
        ...
        if (!this.g && contextXl != null) {
            try {
                File file = new File("/data/data/" + contextXl.getPackageName() + "/database/main/");
                if (!file.exists()) {
                    file.mkdir();
                }
    ...
    public void onConfigure(SQLiteDatabase sQLiteDatabase) {
        ...
        if (com.ss.android.socialbase.downloader.i.z.dl().g("disable_sqlite_wal") <= 0 || Build.VERSION.SDK_INT != 28) {
            return;
        }
    ...
    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (com.ss.android.socialbase.downloader.m.z.z()) {
            com.ss.android.socialbase.downloader.m.z.z("onDowngrade");
        }
    }
}
