...
public class dl implements com.bytedance.sdk.component.kb.z.z.dl {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @com.bytedance.sdk.component.kb.g.z(z = "permission_popup_listener")
    private m.z f1043a;
    ...
    public boolean z(Map<String, Object> map, Map<String, Object> map2, com.bytedance.sdk.component.kb.z.z zVar) {
        ...
        TTDelegateActivity.z(this.z, this.dl, this.gc);
        zVar.z(map2);
        return true;
    }

    private m.z z() {
        return new m.z() { // from class: com.bytedance.sdk.openadsdk.core.fo.z.g.dl.1
            @Override // com.bytedance.sdk.openadsdk.core.un.m.z
            public void onDialogBtnYes() {
                if (dl.this.f1043a == null) {
                    return;
                }
                dl.this.f1043a.onDialogBtnYes();
                dl dlVar = dl.this;
                dlVar.z(dlVar.m);
            }
