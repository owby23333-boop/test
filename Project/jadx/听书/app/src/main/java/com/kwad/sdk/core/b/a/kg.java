...
public final class kg implements com.kwad.sdk.core.d<com.kwad.components.ad.splashscreen.local.a> {
    ...
    private static JSONObject b(com.kwad.components.ad.splashscreen.local.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.jD != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "currentDailyCount", aVar.jD);
        }
        return jSONObject;
    }
}
