...
class GradientStrokeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", "g", "o", an.aI, "s", "e", "w", "lc", "lj", "ml", LiveConfigKey.HIGH, "d");
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.of("p", t.f1872a);
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.of(t.h, "v");
