...
public interface i extends IInterface {
    ...
    public static abstract class z extends Binder implements i {
        ...
        private static class C0176z implements i {
            public static i z;
            private IBinder g;
            ...
            public void z() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.g.transact(1, parcelObtain, parcelObtain2, 0) && z.a() != null) {
                        z.a().z();
                    } else {
            ...
            public void g() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.core.ICommonDialogListener");
                    if (!this.g.transact(2, parcelObtain, parcelObtain2, 0) && z.a() != null) {
                        z.a().g();
                    } else {
                        parcelObtain2.readException();
                    }
            ...
            public void dl() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.core.ICommonDialogListener");
                    if (!this.g.transact(3, parcelObtain, parcelObtain2, 0) && z.a() != null) {
                        z.a().dl();
                    } else {
                        parcelObtain2.readException();
                    }
