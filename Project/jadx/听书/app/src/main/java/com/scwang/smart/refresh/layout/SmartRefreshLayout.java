...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent {
    ...
    */
    ...
    protected ValueAnimator animSpinner(int i, int i2, Interpolator interpolator, int i3) {
        ...
        this.reboundAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m621x7b8cf7a8(valueAnimator2);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$animSpinner$0$com-scwang-smart-refresh-layout-SmartRefreshLayout, reason: not valid java name */
    /* synthetic */ void m621x7b8cf7a8(ValueAnimator valueAnimator) {
        this.mKernel.moveSpinner(((Integer) valueAnimator.getAnimatedValue()).intValue(), false);
    }
    ...
    protected void overSpinner() {
        ...
        } else if (this.mState == RefreshState.LoadFinish) {
    ...
    protected void moveSpinnerInfinitely(float f) {
        ...
        this.mHandler.postDelayed(new Runnable() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m626xe1aac566();
            }
        }, this.mReboundDuration);
    }

    /* JADX INFO: renamed from: lambda$moveSpinnerInfinitely$1$com-scwang-smart-refresh-layout-SmartRefreshLayout, reason: not valid java name */
    /* synthetic */ void m626xe1aac566() {
        OnLoadMoreListener onLoadMoreListener = this.mLoadMoreListener;
        if (onLoadMoreListener != null) {
            onLoadMoreListener.onLoadMore(this);
        } else if (this.mOnMultiListener == null) {
    ...
    public RefreshLayout finishRefresh(int i, final boolean z, final Boolean bool) {
        final int i2 = i >> 16;
        int i3 = (i << 16) >> 16;
        Runnable runnable = new Runnable() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout.4
            int count = 0;
    ...
    /* JADX INFO: renamed from: com.scwang.smart.refresh.layout.SmartRefreshLayout$5, reason: invalid class name */
    class AnonymousClass5 implements Runnable {
        ...
        public void run() {
            ...
            if (iOnFinish < Integer.MAX_VALUE) {
                ...
                final boolean z = this.val$noMoreData;
                handler.postDelayed(new Runnable() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout$5$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m627x2fa6c816(iMax, z);
                    }
                }, SmartRefreshLayout.this.mSpinner < 0 ? iOnFinish : 0L);
            }
        }

        /* JADX INFO: renamed from: lambda$run$0$com-scwang-smart-refresh-layout-SmartRefreshLayout$5, reason: not valid java name */
        /* synthetic */ void m627x2fa6c816(int i, final boolean z) {
            ...
            if (!SmartRefreshLayout.this.mEnableScrollContentWhenLoaded || i >= 0) {
            ...
            AnimatorListenerAdapter animatorListenerAdapter = new AnimatorListenerAdapter() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout.5.1
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    if (animator == null || animator.getDuration() != 0) {
                        SmartRefreshLayout.this.mFooterLocked = false;
            ...
            if (SmartRefreshLayout.this.mSpinner > 0) {
                ...
                if (animatorUpdateListenerScrollContentWhenFinished != null || SmartRefreshLayout.this.mSpinner == 0) {
                    ...
                    SmartRefreshLayout.this.mKernel.moveSpinner(0, false);
                    SmartRefreshLayout.this.mKernel.setState(RefreshState.None);
                } else if (z && SmartRefreshLayout.this.mEnableFooterFollowWhenNoMoreData) {
    ...
    public RefreshLayout finishLoadMore(int i, boolean z, boolean z2) {
        int i2 = i >> 16;
        int i3 = (i << 16) >> 16;
        AnonymousClass5 anonymousClass5 = new AnonymousClass5(i2, z2, z);
        if (i3 > 0) {
            this.mHandler.postDelayed(anonymousClass5, i3);
        } else {
            anonymousClass5.run();
        }
        return this;
    ...
    public boolean autoRefresh() {
        return autoRefresh(this.mAttachedToWindow ? 0 : MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL, this.mReboundDuration, (this.mHeaderMaxDragRate + this.mHeaderTriggerRate) / 2.0f, false);
    }
    ...
    public boolean autoRefreshAnimationOnly() {
        return autoRefresh(this.mAttachedToWindow ? 0 : MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL, this.mReboundDuration, (this.mHeaderMaxDragRate + this.mHeaderTriggerRate) / 2.0f, true);
    }
    ...
    public boolean autoRefresh(int i, final int i2, final float f, final boolean z) {
        ...
        Runnable runnable = new Runnable() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m625xe5f385e1(i2, f, z);
            }
        };
    ...
    /* JADX INFO: renamed from: lambda$autoRefresh$3$com-scwang-smart-refresh-layout-SmartRefreshLayout, reason: not valid java name */
    /* synthetic */ void m625xe5f385e1(int i, float f, final boolean z) {
        ...
        this.mKernel.setState(RefreshState.PullDownToRefresh);
        RefreshComponent refreshComponent = this.mRefreshHeader;
        if (refreshComponent == null || !refreshComponent.autoOpen(i, f, z)) {
            int i2 = this.mHeaderHeight;
            float f2 = i2 == 0 ? this.mHeaderTriggerRate : i2;
            if (f < 10.0f) {
                f *= f2;
            }
            ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(this.mSpinner, (int) f);
            this.reboundAnimator = valueAnimatorOfInt;
            valueAnimatorOfInt.setDuration(i);
            this.reboundAnimator.setInterpolator(new SmartUtil(SmartUtil.INTERPOLATOR_VISCOUS_FLUID));
            this.reboundAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout$$ExternalSyntheticLambda3
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    this.f$0.m624xb81aeb82(valueAnimator2);
                }
            });
            this.reboundAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout.6
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    /* JADX INFO: renamed from: lambda$autoRefresh$2$com-scwang-smart-refresh-layout-SmartRefreshLayout, reason: not valid java name */
    /* synthetic */ void m624xb81aeb82(ValueAnimator valueAnimator) {
        if (this.reboundAnimator != null) {
    ...
    public boolean autoLoadMore(int i, final int i2, final float f, final boolean z) {
        ...
        Runnable runnable = new Runnable() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m623xa1b6d087(i2, f, z);
            }
        };
    ...
    /* JADX INFO: renamed from: lambda$autoLoadMore$5$com-scwang-smart-refresh-layout-SmartRefreshLayout, reason: not valid java name */
    /* synthetic */ void m623xa1b6d087(int i, float f, final boolean z) {
        ...
        if (refreshComponent == null || !refreshComponent.autoOpen(i, f, z)) {
            int i2 = this.mFooterHeight;
            float f2 = i2 == 0 ? this.mFooterTriggerRate : i2;
            if (f < 10.0f) {
                f *= f2;
            }
            ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(this.mSpinner, -((int) f));
            ...
            valueAnimatorOfInt.setDuration(i);
            this.reboundAnimator.setInterpolator(new SmartUtil(SmartUtil.INTERPOLATOR_VISCOUS_FLUID));
            this.reboundAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout$$ExternalSyntheticLambda5
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    this.f$0.m622x73de3628(valueAnimator2);
                }
            });
            this.reboundAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.scwang.smart.refresh.layout.SmartRefreshLayout.7
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    /* JADX INFO: renamed from: lambda$autoLoadMore$4$com-scwang-smart-refresh-layout-SmartRefreshLayout, reason: not valid java name */
    /* synthetic */ void m622x73de3628(ValueAnimator valueAnimator) {
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshKernel setState(RefreshState refreshState) {
            switch (AnonymousClass8.$SwitchMap$com$scwang$smart$refresh$layout$constant$RefreshState[refreshState.ordinal()]) {
                case 1:
    ...
    /* JADX INFO: renamed from: com.scwang.smart.refresh.layout.SmartRefreshLayout$8, reason: invalid class name */
