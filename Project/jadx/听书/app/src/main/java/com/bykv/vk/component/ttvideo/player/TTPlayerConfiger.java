...
public final class TTPlayerConfiger {
    ...
    public static final String getAppFilesPath(Context context) {
        ...
        try {
            String absolutePath = g.z(context.getApplicationContext()).getAbsolutePath();
    ...
    public static final String getAppCrashFilePath2(Context context) {
        if (context != null && APP_PATH == null) {
            APP_PATH = g.z(context.getApplicationContext()).getAbsolutePath();
        }
        if (CRASH_FILE_PATH == null) {
            ...
            if (isPrintInfo()) {
                wp.z(TAG, "<TTPlayerConfigure.java,getAppCrashFilePath2,211>app files path:" + APP_PATH);
            }
            if (APP_PATH != null) {
        ...
        if (isPrintInfo()) {
            wp.z(TAG, "<TTPlayerConfigure.java,getAppCrashFileStorePath,195>carsh file path:" + CRASH_FILE_PATH);
        }
    ...
    public static final String getAppCrashFileStorePath(Context context) {
        ...
        if (CRASH_FILE_PATH == null) {
            ...
            if (isPrintInfo()) {
                wp.z(TAG, "<TTPlayerConfigure.java,getAppCrashFileStorePath,245>app files path:" + APP_PATH);
            }
            if (APP_PATH != null) {
                return APP_PATH + File.separatorChar + CRASH_FILE_NAME;
            }
        ...
        if (isPrintInfo()) {
            wp.z(TAG, "<TTPlayerConfigure.java,getAppCrashFileStorePath,253>carsh file path:" + CRASH_FILE_PATH);
        }
        return CRASH_FILE_PATH;
    }
    ...
    public static final String getAppCrashFilePath(Context context) {
        ...
        if (isPrintInfo()) {
            wp.z(TAG, "<TTPlayerConfigure.java,getAppCrashFileStorePath,278>carsh file path:" + CRASH_FILE_PATH);
        }
        return CRASH_FILE_PATH;
    }
