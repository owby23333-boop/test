...
public class fo extends a {
    public fo(View view, com.bytedance.sdk.component.adexpress.dynamic.dl.z zVar) {
        super(view, zVar);
    }

    @Override // com.bytedance.sdk.component.adexpress.dynamic.animation.z.a
    List<ObjectAnimator> z() {
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.dl, Key.ROTATION, 0.0f, 360.0f).setDuration((int) (this.g.uy() * 1000.0d));
