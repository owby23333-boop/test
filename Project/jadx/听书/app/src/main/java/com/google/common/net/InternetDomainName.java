...
public final class InternetDomainName {
    ...
    public InternetDomainName child(String str) {
        ...
        return from(new StringBuilder(String.valueOf(str2).length() + 1 + String.valueOf(str3).length()).append(str2).append(FileUtils.FILE_EXTENSION_SEPARATOR).append(str3).toString());
    }
