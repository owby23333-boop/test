...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.XNumberProgressBar, i, 0);
        this.mReachedBarColor = typedArrayObtainStyledAttributes.getColor(R.styleable.XNumberProgressBar_xnpb_reached_color, Color.rgb(66, MediaPlayer.MEDIA_PLAYER_OPTION_SINGLE_PLAY_DOWNLOAD_BYTES, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_INDEX_CACHE));
        this.mUnreachedBarColor = typedArrayObtainStyledAttributes.getColor(R.styleable.XNumberProgressBar_xnpb_unreached_color, Color.rgb(204, 204, 204));
        this.mTextColor = typedArrayObtainStyledAttributes.getColor(R.styleable.XNumberProgressBar_xnpb_text_color, Color.rgb(66, MediaPlayer.MEDIA_PLAYER_OPTION_SINGLE_PLAY_DOWNLOAD_BYTES, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_INDEX_CACHE));
        this.mTextSize = typedArrayObtainStyledAttributes.getDimension(R.styleable.XNumberProgressBar_xnpb_text_size, fSp2px);
        this.mReachedBarHeight = typedArrayObtainStyledAttributes.getDimension(R.styleable.XNumberProgressBar_xnpb_reached_bar_height, fDp2px);
        this.mUnreachedBarHeight = typedArrayObtainStyledAttributes.getDimension(R.styleable.XNumberProgressBar_xnpb_unreached_bar_height, fDp2px2);
        this.mOffset = typedArrayObtainStyledAttributes.getDimension(R.styleable.XNumberProgressBar_xnpb_text_offset, fDp2px3);
        if (typedArrayObtainStyledAttributes.getInt(R.styleable.XNumberProgressBar_xnpb_text_visibility, 0) != 0) {
            this.mIfDrawText = false;
        }
        setProgress(typedArrayObtainStyledAttributes.getInt(R.styleable.XNumberProgressBar_xnpb_current, 0));
        setMax(typedArrayObtainStyledAttributes.getInt(R.styleable.XNumberProgressBar_xnpb_max, 100));
    ...
    private void calculateDrawRectF() {
        ...
        if (this.mDrawTextStart + fMeasureText >= getWidth() - getPaddingRight()) {
            float width = (getWidth() - getPaddingRight()) - fMeasureText;
            this.mDrawTextStart = width;
            this.mReachedRectF.right = width - this.mOffset;
        }
        float f = this.mDrawTextStart + fMeasureText + this.mOffset;
