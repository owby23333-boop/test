...
public class MediationInitConfig {
    ...
    private SparseArray<Object> f340a;
    ...
    private boolean e() {
        SparseArray<Object> sparseArray = this.f340a;
    ...
    public String getADNName() {
        return e() ? (String) MediationValueUtil.objectValue(this.f340a.get(AVMDLDataLoader.KeyIsLiveGetPlayCacheSec), String.class, null) : "";
    }
    ...
    public int getAgeGroup() {
        if (e()) {
            return ((Integer) MediationValueUtil.objectValue(this.f340a.get(7), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public String getAppId() {
        if (e()) {
            return (String) MediationValueUtil.objectValue(this.f340a.get(3), String.class, null);
        }
        return null;
    }

    public String getAppKey() {
        return e() ? (String) MediationValueUtil.objectValue(this.f340a.get(AVMDLDataLoader.KeyIsLiveWatchDurationThreshold), String.class, null) : "";
    }
    ...
    public String getAppName() {
        return e() ? (String) MediationValueUtil.objectValue(this.f340a.get(8), String.class, null) : "";
    }
    ...
    public String getClassName() {
        return e() ? (String) MediationValueUtil.objectValue(this.f340a.get(AVMDLDataLoader.KeyIsLiveMobileUploadAllow), String.class, null) : "";
    }
    ...
    public Function<SparseArray<Object>, Object> getInitCallback() {
        if (e()) {
            return AdnAdapterBridgeWrapper.covertToFunction(MediationValueUtil.objectValue(this.f340a.get(8300), Object.class, null));
        }
        return null;
    }
