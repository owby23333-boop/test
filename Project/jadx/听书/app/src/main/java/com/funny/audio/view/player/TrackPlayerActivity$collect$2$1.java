...
@DebugMetadata(c = "com.funny.audio.view.player.TrackPlayerActivity$collect$2$1", f = "TrackPlayerActivity.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
final class TrackPlayerActivity$collect$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ AlbumDetailInfo $albumDetailInfo;
    int label;
    final /* synthetic */ TrackPlayerActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TrackPlayerActivity$collect$2$1(AlbumDetailInfo albumDetailInfo, TrackPlayerActivity trackPlayerActivity, Continuation<? super TrackPlayerActivity$collect$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TrackPlayerActivity$collect$2$1(this.$albumDetailInfo, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((TrackPlayerActivity$collect$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
