...
public abstract class MediaPlayerClient {
    ...
    public void rotateCamera(float f, float f2) {
        wp.z(TTPlayerConfiger.TAG, "<MediaPlayerClient.java,rotateCamera,55>rotateCamera is not implemented");
    }

    public int setIntOption(int i, int i2) {
        wp.z(TTPlayerConfiger.TAG, "<MediaPlayerClient.java,setIntOption,65>set os player is not inval");
        return -1;
    }
}
