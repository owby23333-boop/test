...
public final class TagAlbumAdapter extends BaseQuickAdapter<AlbumInfo, QuickViewHolder> {
    ...
    public QuickViewHolder onCreateViewHolder(Context context, ViewGroup parent, int viewType) {
        ...
        return new QuickViewHolder(R.layout.adapter_tag_album, parent);
    }
}
