...
public final class js implements com.kwad.sdk.core.d<com.kwad.components.core.webview.tachikoma.c.r> {
    ...
    private static void a(com.kwad.components.core.webview.tachikoma.c.r rVar, JSONObject jSONObject) {
        ...
        rVar.ahj = jSONObject.optBoolean("userForce");
    ...
    private static JSONObject b(com.kwad.components.core.webview.tachikoma.c.r rVar, JSONObject jSONObject) {
        ...
        if (rVar.ahj) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "userForce", rVar.ahj);
        }
        if (rVar.type != 0) {
