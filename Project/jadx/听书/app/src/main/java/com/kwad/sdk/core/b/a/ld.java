...
public final class ld implements com.kwad.sdk.core.d<bf.a> {
    ...
    private static void a(bf.a aVar, JSONObject jSONObject) {
        ...
        aVar.aet = jSONObject.optInt("taskStatus");
    }
    ...
    private static JSONObject b(bf.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.aet != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "taskStatus", aVar.aet);
        }
        return jSONObject;
    }
}
