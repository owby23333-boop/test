...
public class dl extends g {
    public dl(String str, com.bytedance.msdk.dl.z.g gVar) {
        super(str, gVar);
    }
    ...
    public void g(List<Function<SparseArray<Object>, Object>> list) {
        if (list != null) {
            if (!g()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new com.bytedance.msdk.dl.z.z.a(this, it.next()));
                }
                z(arrayList);
                return;
            }
    ...
    public <T> T z(int i, PluginValueSet pluginValueSet, Class<T> cls) {
        if (i == 8222) {
            boolean zDl = dl();
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw loader : isExpressRender: " + zDl);
            return (T) Boolean.valueOf(zDl);
        }
        if (i == 8223) {
            boolean zA = a();
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw loader : isNativeAd: " + zA);
        ...
        if (i == 8123) {
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw loader : callLoaderFail  code:" + iIntValue + " msg:" + strStringValue);
        ...
        com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw loader : callLoadSucceed  list size:" + (list != null ? list.size() : 0));
        g(list);
        return null;
    }
}
