...
public final class uy {
    ...
    public static int z(String str, int i, int i2, String str2) {
        while (i < i2) {
    ...
    public static int z(String str, int i, int i2, char c) {
        while (i < i2) {
            if (str.charAt(i) == c) {
                return i;
            }
    ...
    public static String z(String str) {
        InetAddress inetAddressDl;
        if (str.contains(":")) {
            if (str.startsWith("[") && str.endsWith("]")) {
                inetAddressDl = dl(str, 1, str.length() - 1);
            } else {
                inetAddressDl = dl(str, 0, str.length());
            }
            if (inetAddressDl == null) {
                return null;
            }
            byte[] address = inetAddressDl.getAddress();
    ...
    */
    private static java.net.InetAddress dl(java.lang.String r11, int r12, int r13) {
        /*
            r0 = 16
            byte[] r1 = new byte[r0]
            r2 = 0
        ...
        L8f:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.component.g.z.g.uy.dl(java.lang.String, int, int):java.net.InetAddress");
    }

    private static boolean z(String str, int i, int i2, byte[] bArr, int i3) {
        int i4 = i3;
        while (i < i2) {
            if (i4 == bArr.length) {
                return false;
    ...
    private static String z(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i) {
                ...
                zVar.g(((bArr[i2] & 255) << 8) | (bArr[i2 + 1] & 255));
                i2 += 2;
            }
        }
        return zVar.dl();
