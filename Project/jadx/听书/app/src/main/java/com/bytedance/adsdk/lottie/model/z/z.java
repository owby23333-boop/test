...
public class z extends v<Integer, Integer> {
    ...
    public z(List<com.bytedance.adsdk.lottie.m.z<Integer>> list) {
        super(list);
    }

    @Override // com.bytedance.adsdk.lottie.model.z.i
    public com.bytedance.adsdk.lottie.z.g.z<Integer, Integer> z() {
        return new com.bytedance.adsdk.lottie.z.g.g(this.z);
    }
}
