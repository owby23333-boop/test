...
public class MediationCustomInitConfig {
    ...
    public MediationCustomInitConfig(ValueSet valueSet) {
        if (valueSet != null) {
            ...
            this.f1460a = valueSet.stringValue(8536);
    ...
    public String toString() {
        return "MediationCustomInitConfig{mAppId='" + this.z + "', mAppKey='" + this.g + "', mADNName='" + this.dl + "', mAdnInitClassName='" + this.f1460a + "', mBannerClassName='" + this.gc + "', mInterstitialClassName='" + this.m + "', mRewardClassName='" + this.e + "', mFullVideoClassName='" + this.gz + "', mSplashClassName='" + this.fo + "', mFeedClassName='" + this.uy + "', mDrawClassName='" + this.kb + "'}";
    }
}
