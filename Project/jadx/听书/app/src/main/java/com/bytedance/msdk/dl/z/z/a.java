...
public class a extends gz {
    public a(com.bytedance.msdk.dl.dl.g.z.z.g gVar, Function<SparseArray<Object>, Object> function) {
        super(gVar, function);
        if (function != null) {
    ...
    public com.bytedance.sdk.openadsdk.ls.dl.g.e z(Activity activity) {
        ...
        Object objApply = this.uy.apply(com.bytedance.sdk.openadsdk.ls.a.z().z(6072).z(Object.class).z(20033, activity).g());
        if (objApply == null) {
            return null;
        }
        final com.bytedance.sdk.openadsdk.mediation.g.g.m mVar = new com.bytedance.sdk.openadsdk.mediation.g.g.m(com.bytedance.sdk.openadsdk.l.dl.z(objApply));
        return new com.bytedance.sdk.openadsdk.ls.dl.g.e() { // from class: com.bytedance.msdk.dl.z.z.a.1
    ...
    public Integer m() {
        if (this.uy != null) {
            Integer numZ = com.bytedance.sdk.openadsdk.core.ti.z.z.z(this.uy.apply(com.bytedance.sdk.openadsdk.ls.a.z().z(8121).z(20068, 1).z(Object.class).g()));
            if (numZ != null) {
                return numZ;
            }
        }
    ...
    public void z(View view, String str, int i) {
        if (pf() instanceof com.bytedance.msdk.api.a.z.dl.a) {
            try {
                ((com.bytedance.msdk.api.a.z.dl.a) pf()).z(view, str, i);
            } catch (Exception e) {
                wp.z(e);
            }
        }
    ...
    public void z(float f, float f2) {
        if (pf() instanceof com.bytedance.msdk.api.a.z.dl.a) {
            try {
                ((com.bytedance.msdk.api.a.z.dl.a) pf()).z(f, f2);
            } catch (Exception e) {
                wp.z(e);
            }
        }
    ...
    public void qz() {
        z(new z() { // from class: com.bytedance.msdk.dl.z.z.a.2
    ...
    public void aq() {
        g(new z() { // from class: com.bytedance.msdk.dl.z.z.a.3
            @Override // com.bytedance.msdk.dl.z.z.z
            public void z() {
                if (a.this.pf() != null) {
                    a.this.pf().z();
    ...
    public <T> T applyFunction(int i, PluginValueSet pluginValueSet, Class<T> cls) {
        if (i == 8134) {
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeRenderFail code:" + iIntValue + " msg:" + strStringValue + " view" + view);
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeRenderSuccess width:" + fFloatValue + " height:" + fFloatValue2);
            z(fFloatValue, fFloatValue2);
        } else if (i == 8130) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeAdClick");
            qz();
        } else if (i == 8113) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeAdShow");
            aq();
        } else if (i == 8145) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeVideoStart");
            mk();
        } else if (i == 8146) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeVideoPause");
            en();
        } else if (i == 8150) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeVideoResume");
            oc();
        } else if (i == 8118) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeVideoCompleted");
            ou();
        } else if (i == 8117) {
            int iIntValue2 = pluginValueSet.intValue(8014);
            String strStringValue2 = pluginValueSet.stringValue(8015);
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeVideoError code:" + iIntValue2 + " msg:" + strStringValue2);
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeVideoError current:" + jLongValue + " duration:" + jLongValue2);
            z(jLongValue, jLongValue2);
        } else if (i == 8152) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeOnIdle");
            bp();
        } else if (i == 8187) {
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadActive totalBytes:" + jLongValue3 + " curlBytes:" + jLongValue4);
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadPaused totalBytes:" + jLongValue5 + " curlBytes:" + jLongValue6 + " fileName:" + strStringValue3 + " appName:" + strStringValue4);
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadFailed totalBytes:" + jLongValue7 + " curlBytes:" + jLongValue8 + " fileName:" + strStringValue5 + " appName:" + strStringValue6);
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadFinished totalBytes:" + jLongValue9 + " fileName:" + strStringValue7 + " appName:" + strStringValue8);
            ...
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeOnDownloadFinished  fileName:" + strStringValue9 + " appName:" + strStringValue10);
            z(strStringValue9, strStringValue10);
        } else if (i == 8185) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeDislikeShow");
            mt();
        } else if (i == 8184) {
            com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeDislikeCancel");
            um();
        } else if (i != 6085) {
            if (i == 8110) {
                boolean zK = k();
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : isClientBiddingAd :".concat(String.valueOf(zK)));
                return (T) Boolean.valueOf(zK);
            }
            if (i == 8136) {
                boolean zHn = hn();
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : isServerBiddingAd :".concat(String.valueOf(zHn)));
                return (T) Boolean.valueOf(zHn);
            }
            if (i == 8160) {
                boolean zTi = ti();
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : isUseCustomVideo :".concat(String.valueOf(zTi)));
                return (T) Boolean.valueOf(zTi);
            }
            if (i == 8226) {
                int iYt = yt();
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : getBiddingType :".concat(String.valueOf(iYt)));
            ...
            if (i == 8132) {
                ...
                com.bytedance.msdk.z.gc.dl.g("TTMediationSDK", "Adn custom draw ad : callNativeDislikeSelected postion:" + iIntValue3 + " value:" + strStringValue11);
