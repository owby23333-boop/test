...
final class RequestManagerGenerator {
    ...
    private MethodSpec generateOverrideSetRequestOptions(String str, TypeSpec typeSpec) {
        ...
        String str2 = str + FileUtils.FILE_EXTENSION_SEPARATOR + typeSpec.name;
