...
public class EventBus {
    ...
    static final class LoggingHandler implements SubscriberExceptionHandler {
        ...
        private static Logger logger(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            return Logger.getLogger(new StringBuilder(String.valueOf(name).length() + 1 + String.valueOf(strIdentifier).length()).append(name).append(FileUtils.FILE_EXTENSION_SEPARATOR).append(strIdentifier).toString());
        }
