...
import com.funny.audio.databinding.FragmentPureModeRewardAdDialogBinding;
...
public final class PureModeRewardAdDialog extends BaseDialogFragment<FragmentPureModeRewardAdDialogBinding> {
    ...
    public static final /* synthetic */ FragmentPureModeRewardAdDialogBinding access$getBd(PureModeRewardAdDialog pureModeRewardAdDialog) {
        return pureModeRewardAdDialog.getBd();
    }
    ...
    public final void disableCancel() {
        ...
        if (dialog3 != null) {
            dialog3.setOnKeyListener(new DialogInterface.OnKeyListener() { // from class: com.funny.audio.view.mine.PureModeRewardAdDialog$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnKeyListener
                public final boolean onKey(DialogInterface dialogInterface, int i, KeyEvent keyEvent) {
                    return PureModeRewardAdDialog.disableCancel$lambda$0(dialogInterface, i, keyEvent);
                }
            });
        }
    }
    ...
    public void initView(View view) {
        ...
        ViewKt.click$default(qMUIFrameLayout, 0, new Function0<Unit>() { // from class: com.funny.audio.view.mine.PureModeRewardAdDialog.initView.1
            {
                super(0);
            }
            ...
            public final void invoke2() {
                if (PureModeRewardAdDialog.this.isLoading) {
                    return;
                }
                PureModeRewardAdDialog.this.dismissAllowingStateLoss();
            }
        }, 1, null);
        QMUIFrameLayout qMUIFrameLayout2 = getBd().btnPositive;
        Intrinsics.checkNotNullExpressionValue(qMUIFrameLayout2, "bd.btnPositive");
        ViewKt.click$default(qMUIFrameLayout2, 0, new Function0<Unit>() { // from class: com.funny.audio.view.mine.PureModeRewardAdDialog.initView.2
            {
                super(0);
            }
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                if (AdManager.INSTANCE.getPureModeRewardVideoAdLoader() != null) {
                    if (PureModeRewardAdDialog.this.isLoading) {
                        return;
                    }
                    PureModeRewardAdDialog.this.isLoading = true;
                    PureModeRewardAdDialog.access$getBd(PureModeRewardAdDialog.this).loading.setVisibility(0);
                    RewardVideoAdLoader pureModeRewardVideoAdLoader = AdManager.INSTANCE.getPureModeRewardVideoAdLoader();
                    Intrinsics.checkNotNull(pureModeRewardVideoAdLoader);
                    FragmentActivity fragmentActivityRequireActivity = PureModeRewardAdDialog.this.requireActivity();
                    Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity()");
                    final PureModeRewardAdDialog pureModeRewardAdDialog = PureModeRewardAdDialog.this;
                    pureModeRewardVideoAdLoader.load(fragmentActivityRequireActivity, new RewardVideoAdLoadListener() { // from class: com.funny.audio.view.mine.PureModeRewardAdDialog.initView.2.1
                        ...
                        public void onRewardVideoAdLoad() {
                            pureModeRewardAdDialog.isLoading = false;
                            PureModeRewardAdDialog.access$getBd(pureModeRewardAdDialog).loading.setVisibility(8);
                            Job job = (Job) pureModeRewardAdDialog.loadTimeoutJobRef.get();
                            if (job != null) {
                            ...
                            FragmentActivity fragmentActivityRequireActivity2 = pureModeRewardAdDialog.requireActivity();
                            Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity2, "this@PureModeRewardAdDialog.requireActivity()");
                            final PureModeRewardAdDialog pureModeRewardAdDialog2 = pureModeRewardAdDialog;
                            pureModeRewardVideoAdLoader2.show(fragmentActivityRequireActivity2, new RewardVideoAdListener() { // from class: com.funny.audio.view.mine.PureModeRewardAdDialog$initView$2$1$onRewardVideoAdLoad$1
                                ...
                                public void onAdShow() {
                                    Job job2 = (Job) pureModeRewardAdDialog2.showTimeoutJobRef.get();
                                    if (job2 != null) {
                                ...
                                public void onRewardVerify() {
                                    ...
                                    rewardAdVerifyEvent.setType(RewardAdType.INSTANCE.getPURE_MODE());
                                    rewardAdVerifyEvent.setSuccess(true);
                                    EventBus.getDefault().post(rewardAdVerifyEvent);
                                }
                            });
                            pureModeRewardAdDialog.startWaitShowTimeoutJob();
                        }
                        ...
                        public void onRewardVideoLoadFail(int code, String message) {
                            ...
                            pureModeRewardAdDialog.dismissAllowingStateLoss();
                        }
                    });
                    PureModeRewardAdDialog.this.startWaitLoadTimeoutJob();
                    return;
                }
    ...
    public void initData() {
        ...
        AdSettingEntity pureModeRewardAd = setting.getPureModeRewardAd();
        if (pureModeRewardAd.getDescription().length() > 0) {
            getBd().tvContent.setText(pureModeRewardAd.getDescription());
    ...
    */
    public final void startWaitLoadTimeoutJob() {
        ...
        L1e:
            ...
            r2 = 0
            r3 = 0
            com.funny.audio.view.mine.PureModeRewardAdDialog$startWaitLoadTimeoutJob$1$newJob$1 r0 = new com.funny.audio.view.mine.PureModeRewardAdDialog$startWaitLoadTimeoutJob$1$newJob$1     // Catch: java.lang.Throwable -> L42
            r4 = 0
        ...
        L42:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.funny.audio.view.mine.PureModeRewardAdDialog.startWaitLoadTimeoutJob():void");
    }
    ...
    */
    public final void startWaitShowTimeoutJob() {
        ...
        L1e:
            ...
            r2 = 0
            r3 = 0
            com.funny.audio.view.mine.PureModeRewardAdDialog$startWaitShowTimeoutJob$1$newJob$1 r0 = new com.funny.audio.view.mine.PureModeRewardAdDialog$startWaitShowTimeoutJob$1$newJob$1     // Catch: java.lang.Throwable -> L42
            r4 = 0
            r0.<init>(r7, r4)     // Catch: java.lang.Throwable -> L42
            r4 = r0
            kotlin.jvm.functions.Function2 r4 = (kotlin.jvm.functions.Function2) r4     // Catch: java.lang.Throwable -> L42
        ...
        L42:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.funny.audio.view.mine.PureModeRewardAdDialog.startWaitShowTimeoutJob():void");
    }

    public final void show(FragmentManager manager) {
        Intrinsics.checkNotNullParameter(manager, "manager");
        show(manager, "PureModeRewardAd");
    }
    ...
    public final void onMessageEvent(RewardAdVerifyEvent rewardAdVerifyEvent) {
        ...
        if (Intrinsics.areEqual(rewardAdVerifyEvent.getType(), RewardAdType.INSTANCE.getPURE_MODE())) {
            DialogUtils.INSTANCE.tip("已为你开启纯净模式~");
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(Dispatchers.getIO()), null, null, new C06221(null), 3, null);
            dismissAllowingStateLoss();
        }
    }

    /* JADX INFO: renamed from: com.funny.audio.view.mine.PureModeRewardAdDialog$onMessageEvent$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: PureModeRewardAdDialog.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "com.funny.audio.view.mine.PureModeRewardAdDialog$onMessageEvent$1", f = "PureModeRewardAdDialog.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    static final class C06221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06221(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            Intrinsics.checkNotNull(setting);
            AdSettingEntity pureModeRewardAd = setting.getPureModeRewardAd();
            long jMin = Math.min(LongKt.getEndOfDayTimestamp(), System.currentTimeMillis() + pureModeRewardAd.getRewardDuration());
            AdSetting setting2 = AdManager.INSTANCE.getSetting();
            Intrinsics.checkNotNull(setting2);
            AppSettingEntityKt.save(setting2.getPureTime(), Boxing.boxLong(jMin));
            return Unit.INSTANCE;
        }
    }
