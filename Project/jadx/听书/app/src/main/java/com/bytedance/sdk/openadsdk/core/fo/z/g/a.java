...
public class a implements com.bytedance.sdk.component.kb.z.z.dl {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @com.bytedance.sdk.component.kb.g.z(z = "privacy_popup_listener")
    private m.z f1042a;
    ...
    public boolean z(Map<String, Object> map, Map<String, Object> map2, com.bytedance.sdk.component.kb.z.z zVar) {
        ...
        TTDelegateActivity.g(this.z, this.dl, this.gc);
        zVar.z(map2);
        return true;
    }

    private m.z z() {
        return new m.z() { // from class: com.bytedance.sdk.openadsdk.core.fo.z.g.a.1
            @Override // com.bytedance.sdk.openadsdk.core.un.m.z
            public void onDialogBtnYes() {
                if (a.this.f1042a == null) {
                    return;
                }
                a.this.f1042a.onDialogBtnYes();
                a aVar = a.this;
                aVar.z(aVar.m);
            }
