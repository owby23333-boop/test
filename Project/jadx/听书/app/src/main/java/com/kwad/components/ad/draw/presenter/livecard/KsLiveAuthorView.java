...
public class KsLiveAuthorView extends FrameLayout implements ca.a {
    ...
    public void A(Context context) {
        ...
        this.f1893es = findViewById(R.id.ksad_top_flag_layout);
    }

    public void j(AdTemplate adTemplate) {
        AdInfo adInfoEl = e.el(adTemplate);
        String strCo = com.kwad.sdk.core.response.b.a.co(adInfoEl);
        if (!TextUtils.isEmpty(strCo)) {
            KSImageLoader.loadImage(this.el, strCo, adTemplate);
        }
        int iBg = com.kwad.sdk.core.response.b.a.bg(adInfoEl);
        if (com.kwad.sdk.core.response.b.a.cR(e.el(adTemplate))) {
            this.eo.setText("直播中");
            if (iBg == 8) {
                this.f1893es.setVisibility(8);
            ...
            this.eo.setText(com.kwad.sdk.core.response.b.a.cM(adInfoEl));
        }
    ...
    private void a(com.kwad.components.core.widget.e eVar, Drawable drawable) {
        if (drawable instanceof GradientDrawable) {
            ((GradientDrawable) drawable).setStroke(getResources().getDimensionPixelSize(R.dimen.ksad_draw_author_icon_stroke_width), eVar.wf());
        }
    }
