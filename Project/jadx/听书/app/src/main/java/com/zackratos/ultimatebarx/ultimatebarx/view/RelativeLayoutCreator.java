...
/* JADX INFO: compiled from: RelativeLayoutCreator.kt */
...
public final class RelativeLayoutCreator extends BaseCreator {
    ...
    public View getStatusBarView(Context context, boolean fitWindow) {
        ...
        View viewFindViewWithTag = this.relativeLayout.findViewWithTag(getTag().getStatusBarViewTag());
        if (viewFindViewWithTag == null) {
            ...
            this.relativeLayout.addView(viewFindViewWithTag);
        }
    ...
    public View getNavigationBarView(Context context, boolean fitWindow) {
        ...
        int i;
        Intrinsics.checkParameterIsNotNull(context, "context");
        View viewFindViewWithTag = this.relativeLayout.findViewWithTag(getTag().getNavigationBarViewTag());
        ...
        if (viewFindViewWithTag == null) {
            viewFindViewWithTag = new View(context);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(navigationBarHeight2, navigationBarHeight);
