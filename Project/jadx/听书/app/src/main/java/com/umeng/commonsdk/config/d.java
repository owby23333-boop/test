...
public class d {
    ...
    public static final long f2292a = 1000;
    ...
    public static String[] k = new String[EnumC0493d.values().length];
    ...
    static {
        ...
        for (int i5 = 0; i5 < EnumC0493d.values().length; i5++) {
            k[i5] = EnumC0493d.values()[i5].toString();
        }
        Map<String, String[]> map4 = l;
        if (map4 != null) {
            map4.put(EnumC0493d.class.getName(), k);
        }
    }
