...
public final class AnnouncerAlbumAdapter extends BaseQuickAdapter<AlbumInfo, QuickViewHolder> {
    ...
    public QuickViewHolder onCreateViewHolder(Context context, ViewGroup parent, int viewType) {
        ...
        return new QuickViewHolder(R.layout.adapter_announcer_album, parent);
    }
}
