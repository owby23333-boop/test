...
public class MediationAdSlotValueSet {
    ...
    private SparseArray<Object> f339a;
    ...
    */
    private MediationAdSlotValueSet(android.util.SparseArray<java.lang.Object> r4) {
        ...
        L6:
            ...
            r1 = 0
            java.lang.Object r4 = com.bytedance.msdk.adapter.ks.base.utils.MediationValueUtil.objectValue(r4, r0, r1)
            android.util.SparseArray r4 = com.bytedance.msdk.adapter.ks.base.proto.AdnAdapterValueSetBuilder.converToSparseArray(r4)
            r0 = 8443(0x20fb, float:1.1831E-41)
            r2 = 8089(0x1f99, float:1.1335E-41)
            if (r4 == 0) goto L32
            java.lang.Object r4 = r4.get(r2)
            java.lang.Class<java.lang.Object> r2 = java.lang.Object.class
            java.lang.Object r4 = com.bytedance.msdk.adapter.ks.base.utils.MediationValueUtil.objectValue(r4, r2, r1)
            android.util.SparseArray r4 = com.bytedance.msdk.adapter.ks.base.proto.AdnAdapterValueSetBuilder.converToSparseArray(r4)
            r3.b = r4
            if (r4 == 0) goto L56
            goto L46
        L32:
            android.util.SparseArray<java.lang.Object> r4 = r3.f339a
            java.lang.Object r4 = r4.get(r2)
            java.lang.Class<java.lang.Object> r2 = java.lang.Object.class
            java.lang.Object r4 = com.bytedance.msdk.adapter.ks.base.utils.MediationValueUtil.objectValue(r4, r2, r1)
            android.util.SparseArray r4 = com.bytedance.msdk.adapter.ks.base.proto.AdnAdapterValueSetBuilder.converToSparseArray(r4)
        ...
        L56:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.msdk.adapter.ks.base.config.MediationAdSlotValueSet.<init>(android.util.SparseArray):void");
    }
    ...
    private boolean b() {
        SparseArray<Object> sparseArray = this.f339a;
    ...
    public String getADNId() {
        if (b()) {
            return (String) MediationValueUtil.objectValue(this.f339a.get(AVMDLDataLoader.KeyIsLiveCacheThresholdP2pToHttp), String.class, null);
        }
        return null;
    }
    ...
    public Object getAdLoaderCallback() {
        if (b()) {
            return MediationValueUtil.objectValue(this.f339a.get(AVMDLDataLoader.KeyIsLiveMobileDownloadAllow), Object.class, null);
        }
        return null;
    }
    ...
    public int getAdSubType() {
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f339a.get(8094), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public int getAdloadSeq() {
        ...
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f339a.get(20), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public String getClientReqId() {
        return b() ? (String) MediationValueUtil.objectValue(this.f339a.get(8430), String.class, null) : "";
    }

    public String getContentUrl() {
        return b() ? (String) MediationValueUtil.objectValue(this.f339a.get(8083), String.class, null) : "";
    }

    public String getDevices() {
        return b() ? (String) MediationValueUtil.objectValue(this.f339a.get(8084), String.class, null) : "";
    }
    ...
    public int getOriginType() {
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f339a.get(8085), Integer.class, 0)).intValue();
        }
        return 0;
    }

    public Map<String, Object> getParams() {
        return b() ? (Map) MediationValueUtil.objectValue(this.f339a.get(8044), Map.class, null) : new HashMap();
    }

    public int getRenderControl() {
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f339a.get(8553), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public String getRitId() {
        if (b()) {
            return (String) MediationValueUtil.objectValue(this.f339a.get(4), String.class, null);
        }
        return null;
    }
    ...
    public String getWaterfallABTest() {
        return b() ? (String) MediationValueUtil.objectValue(this.f339a.get(8429), String.class, null) : "";
    }
    ...
    public boolean isExpress() {
        return b() && ((Boolean) MediationValueUtil.objectValue(this.f339a.get(8033), Boolean.class, false)).booleanValue();
    }
    ...
    public boolean isSupportDeepLink() {
        if (b()) {
            return ((Boolean) MediationValueUtil.objectValue(this.f339a.get(11), Boolean.class, false)).booleanValue();
        }
        return false;
    }
