...
public final class LongMath {
    ...
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, MediaPlayer.MEDIA_PLAYER_OPTION_HANDLE_AUDIO_EXTRADATA, 214, 169, MediaPlayer.MEDIA_PLAYER_OPTION_RENDER_DEVICE, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    */
    ...
    public static long factorial(int i) {
        MathPreconditions.checkNonNegative(t.h, i);
    ...
    public static long binomial(int i, int i2) {
        MathPreconditions.checkNonNegative(t.h, i);
        MathPreconditions.checkNonNegative(t.f1872a, i2);
    ...
    public static boolean isPrime(long j) {
        if (j < 2) {
            MathPreconditions.checkNonNegative(t.h, j);
            return false;
        }
        if (j < 66) {
