...
public class uf extends com.bytedance.sdk.component.z.gc<JSONObject, JSONObject> {
    private String g;
    private SSWebView z;

    public static void z(com.bytedance.sdk.component.z.p pVar, SSWebView sSWebView, String str) {
        pVar.z("close_twist_observer", (com.bytedance.sdk.component.z.gc<?, ?>) new uf(sSWebView, str));
    }
    ...
    public uf(SSWebView sSWebView, String str) {
        this.z = sSWebView;
        this.g = str;
    }
