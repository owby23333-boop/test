...
public final class _PathKt {
    ...
    private static final ByteString DOT = ByteString.INSTANCE.encodeUtf8(FileUtils.FILE_EXTENSION_SEPARATOR);
    ...
    public static final Path commonRelativeTo(Path path, Path other) {
        ...
        return Path.Companion.get$default(Path.INSTANCE, FileUtils.FILE_EXTENSION_SEPARATOR, false, 1, (Object) null);
    }
