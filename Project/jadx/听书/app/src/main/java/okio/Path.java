...
public final class Path implements Comparable<Path> {
    ...
    public final Path relativeTo(Path other) {
        ...
        return Companion.get$default(INSTANCE, FileUtils.FILE_EXTENSION_SEPARATOR, false, 1, (Object) null);
    }
