...
public interface AudioRendererEventListener {
    ...
    public static final class EventDispatcher {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda2
                    ...
                    public final void run() {
                        this.f$0.m153x55ee20a7(decoderCounters);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m153x55ee20a7(DecoderCounters decoderCounters) {
        ...
        public void decoderInitialized(final String str, final long j, final long j2) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m150x4e7a341d(str, j, j2);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m150x4e7a341d(String str, long j, long j2) {
        ...
        public void inputFormatChanged(final Format format, final DecoderReuseEvaluation decoderReuseEvaluation) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m154x1ee33b39(format, decoderReuseEvaluation);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m154x1ee33b39(Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
        ...
        /* synthetic */ void m155xa4e1944f(long j) {
        ...
        /* synthetic */ void m157x8e019017(int i, long j, long j2) {
        ...
        /* synthetic */ void m151x102cf822(String str) {
        ...
        public void disabled(final DecoderCounters decoderCounters) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m152xe116cfac(decoderCounters);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m152xe116cfac(DecoderCounters decoderCounters) {
            decoderCounters.ensureUpdated();
        ...
        /* synthetic */ void m156x60b531cc(boolean z) {
        ...
        /* synthetic */ void m149xc89a3787(Exception exc) {
        ...
        /* synthetic */ void m148xdf751697(Exception exc) {
