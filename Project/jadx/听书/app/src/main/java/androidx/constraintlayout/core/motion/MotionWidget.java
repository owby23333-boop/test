...
public class MotionWidget implements TypedValues {
    ...
    public String toString() {
        return this.widgetFrame.left + ", " + this.widgetFrame.f54top + ", " + this.widgetFrame.right + ", " + this.widgetFrame.bottom;
    }
    ...
    public int getTop() {
        return this.widgetFrame.f54top;
    }
    ...
    public int getHeight() {
        return this.widgetFrame.bottom - this.widgetFrame.f54top;
    }
