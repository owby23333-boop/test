...
class PlayerWrapper extends ForwardingPlayer {
    ...
    public PlaybackStateCompat createPlaybackStateCompat() {
        ...
        int iConvertToPlaybackStateCompatState = MediaUtils.convertToPlaybackStateCompatState(playerError, getPlaybackState(), getPlayWhenReady());
        Player.Commands availableCommands = getAvailableCommands();
        long jConvertCommandToPlaybackStateActions = 128;
        for (int i = 0; i < availableCommands.size(); i++) {
            jConvertCommandToPlaybackStateActions |= convertCommandToPlaybackStateActions(availableCommands.get(i));
        }
        long jConvertToQueueItemId = isCommandAvailable(17) ? MediaUtils.convertToQueueItemId(getCurrentMediaItemIndex()) : -1L;
    ...
    class AnonymousClass1 extends VolumeProviderCompat {
        ...
        public void onSetVolumeTo(final int i) {
            ...
            Util.postOrRun(handler, new Runnable() { // from class: androidx.media3.session.PlayerWrapper$1$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m413lambda$onSetVolumeTo$0$androidxmedia3sessionPlayerWrapper$1(i, i2);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onSetVolumeTo$0$androidx-media3-session-PlayerWrapper$1, reason: not valid java name */
        /* synthetic */ void m413lambda$onSetVolumeTo$0$androidxmedia3sessionPlayerWrapper$1(int i, int i2) {
        ...
        public void onAdjustVolume(final int i) {
            ...
            Util.postOrRun(handler, new Runnable() { // from class: androidx.media3.session.PlayerWrapper$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m412lambda$onAdjustVolume$1$androidxmedia3sessionPlayerWrapper$1(i, i2);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onAdjustVolume$1$androidx-media3-session-PlayerWrapper$1, reason: not valid java name */
        /* synthetic */ void m412lambda$onAdjustVolume$1$androidxmedia3sessionPlayerWrapper$1(int i, int i2) {
