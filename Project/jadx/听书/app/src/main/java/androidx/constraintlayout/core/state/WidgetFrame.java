...
public class WidgetFrame {
    ...
    public int height() {
        return Math.max(0, this.bottom - this.f54top);
    }
    ...
    public WidgetFrame(WidgetFrame widgetFrame) {
        ...
        this.f54top = widgetFrame.f54top;
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i12 = widgetFrame2.f54top;
        int i13 = widgetFrame3.left;
        int i14 = widgetFrame3.f54top;
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                int i20 = (int) (keyPositionFindPreviousPosition.x * i);
            ...
            if (keyPositionFindNextPosition != null) {
                ...
                int i22 = (int) (keyPositionFindNextPosition.y * i2);
        ...
        int i23 = (int) (i6 + ((i13 - i6) * f3));
        widgetFrame.left = i23;
        int i24 = (int) (i7 + (f3 * (i14 - i7)));
        widgetFrame.f54top = i24;
        float f8 = 1.0f - f;
        widgetFrame.right = i23 + ((int) ((i3 * f8) + (i17 * f)));
        widgetFrame.bottom = i24 + ((int) ((f8 * i4) + (i18 * f)));
    ...
    public float centerY() {
        return this.f54top + ((this.bottom - r0) / 2.0f);
    }
    ...
    public WidgetFrame update() {
        ...
        if (constraintWidget != null) {
            ...
            this.f54top = this.widget.getTop();
