...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    /* synthetic */ void m99lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m100lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    /* synthetic */ void m101lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m102lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    Parcelable saveAllState() {
        ...
        Bundle bundleM98lambda$attachController$4$androidxfragmentappFragmentManager = m98lambda$attachController$4$androidxfragmentappFragmentManager();
        if (bundleM98lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
            return null;
        }
        return bundleM98lambda$attachController$4$androidxfragmentappFragmentManager;
    }
