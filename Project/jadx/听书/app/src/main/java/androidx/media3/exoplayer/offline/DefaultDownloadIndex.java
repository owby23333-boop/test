...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    private static String inferMimeType(String str) {
        return "dash".equals(str) ? MimeTypes.APPLICATION_MPD : LiveConfigKey.HLS.equals(str) ? MimeTypes.APPLICATION_M3U8 : "ss".equals(str) ? MimeTypes.APPLICATION_SS : MimeTypes.VIDEO_UNKNOWN;
    }
