...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    */
    protected void onStreamChanged(androidx.media3.common.Format[] r13, long r14, long r16) throws androidx.media3.exoplayer.ExoPlaybackException {
        /*
            r12 = this;
            r0 = r12
    ...
    */
    private void maybeInitCodecWithFallback(android.media.MediaCrypto r8, boolean r9) throws androidx.media3.exoplayer.mediacodec.MediaCodecRenderer.DecoderInitializationException {
        ...
        La3:
            ...
            goto L49
        Lac:
            androidx.media3.exoplayer.mediacodec.MediaCodecRenderer$DecoderInitializationException r8 = r7.preferredDecoderInitializationException
            throw r8
        Laf:
    ...
    */
    ...
    private void processOutputMediaFormatChanged() {
        ...
        if (this.codecAdaptationWorkaroundMode != 0 && outputFormat.getInteger(com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_WIDTH) == 32 && outputFormat.getInteger(com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_HEIGHT) == 32) {
