...
public final class NalUnitUtil {
  ...
  0x01b1: PHI (r16v5 float) = (r16v4 float), (r16v9 float) binds: [B:72:0x0130, B:89:0x017e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static androidx.media3.container.NalUnitUtil.SpsData parseSpsNalUnitPayload(byte[] r23, int r24, int r25) {
        /*
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        return new H265SpsData(bits2, bit, bits3, i7, unsignedExpGolombCodedInt2, unsignedExpGolombCodedInt9, unsignedExpGolombCodedInt10, iArr, bits4, unsignedExpGolombCodedInt, i13, i3, f, iIsoColorPrimariesToColorSpace, i4, i5);
    }
