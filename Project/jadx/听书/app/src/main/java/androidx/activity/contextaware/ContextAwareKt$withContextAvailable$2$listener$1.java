...
@Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006"}, d2 = {"androidx/activity/contextaware/ContextAwareKt$withContextAvailable$2$listener$1", "Landroidx/activity/contextaware/OnContextAvailableListener;", "onContextAvailable", "", d.R, "Landroid/content/Context;", "activity_release"}, k = 1, mv = {1, 8, 0}, xi = MediaPlayer.MEDIA_PLAYER_OPTION_ABR_HURRY_THRESHOLD)
public final class ContextAwareKt$withContextAvailable$2$listener$1 implements OnContextAvailableListener {
    ...
    public void onContextAvailable(Context context) {
        ...
        try {
            ...
            objM635constructorimpl = Result.m635constructorimpl(function1.invoke(context));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM635constructorimpl = Result.m635constructorimpl(ResultKt.createFailure(th));
        }
        continuation.resumeWith(objM635constructorimpl);
    }
}
