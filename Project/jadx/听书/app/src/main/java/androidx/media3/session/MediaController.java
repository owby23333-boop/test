...
public class MediaController implements Player {
        ...
        if (this.connectionNotified) {
            notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaController$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m227lambda$release$0$androidxmedia3sessionMediaController((MediaController.Listener) obj);
                }
            });
        } else {
    ...
    /* synthetic */ void m227lambda$release$0$androidxmedia3sessionMediaController(Listener listener) {
