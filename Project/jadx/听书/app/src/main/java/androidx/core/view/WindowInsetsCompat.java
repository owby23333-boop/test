...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f59top;
    }
    ...
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f59top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f59top, insets.right, insets.bottom);
    }
    ...
    private static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 1) {
                if (z) {
                    return Insets.of(0, Math.max(getRootStableInsets().f59top, getSystemWindowInsets().f59top), 0, 0);
                }
                return Insets.of(0, getSystemWindowInsets().f59top, 0, 0);
            }
            if (i == 2) {
                if (z) {
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int iMax2 = Math.max(0, insets.f59top - i2);
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f59top, insets.right, insets.bottom);
            }
        }
