...
public class Motion {
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.f51top = this.mStartMotionPath.y;
        floatRect.right = floatRect.left + this.mStartMotionPath.width;
        floatRect.bottom = floatRect.f51top + this.mStartMotionPath.height;
        FloatRect floatRect2 = new FloatRect();
        floatRect2.left = this.mEndMotionPath.x;
        floatRect2.f51top = this.mEndMotionPath.y;
        floatRect2.right = floatRect2.left + this.mEndMotionPath.width;
        floatRect2.bottom = floatRect2.f51top + this.mEndMotionPath.height;
    ...
    public void setStartState(ViewState viewState, MotionWidget motionWidget, int i, int i2, int i3) {
        ...
        if (i == 1) {
            ...
            rect.left = ((viewState.f53top + viewState.bottom) - viewState.width()) / 2;
            rect.f52top = i2 - ((i4 + viewState.height()) / 2);
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f52top + viewState.height();
        } else if (i == 2) {
            int i5 = viewState.left + viewState.right;
            rect.left = i3 - (((viewState.f53top + viewState.bottom) + viewState.width()) / 2);
            rect.f52top = (i5 - viewState.height()) / 2;
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f52top + viewState.height();
        }
        this.mStartMotionPath.setBounds(rect.left, rect.f52top, rect.width(), rect.height());
    ...
    void rotate(Rect rect, Rect rect2, int i, int i2, int i3) {
        if (i == 1) {
            ...
            rect2.left = ((rect.f52top + rect.bottom) - rect.width()) / 2;
            rect2.f52top = i3 - ((i4 + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f52top + rect.height();
            return;
        }
        if (i == 2) {
            int i5 = rect.left + rect.right;
            rect2.left = i2 - (((rect.f52top + rect.bottom) + rect.width()) / 2);
            rect2.f52top = (i5 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f52top + rect.height();
            return;
        }
        if (i != 3) {
            ...
            rect2.left = i2 - (((rect.bottom + rect.f52top) + rect.width()) / 2);
            rect2.f52top = (i6 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f52top + rect.height();
            return;
        }
        ...
        int i8 = rect.f52top;
        int i9 = rect.bottom;
        rect2.left = ((rect.height() / 2) + rect.f52top) - (i7 / 2);
        rect2.f52top = i3 - ((i7 + rect.height()) / 2);
        rect2.right = rect2.left + rect.width();
        rect2.bottom = rect2.f52top + rect.height();
    }
