...
@DebugMetadata(c = "androidx.room.RoomDatabaseKt$invalidationTrackerFlow$1$job$1", f = "RoomDatabaseExt.kt", i = {}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_NETWORK_TRY_COUNT}, m = "invokeSuspend", n = {}, s = {})
        ...
        try {
            if (i == 0) {
                ...
                if (this.$emitInitialState) {
                    this.$$this$callbackFlow.mo2137trySendJP2dKIU(ArraysKt.toSet(this.$tables));
                }
