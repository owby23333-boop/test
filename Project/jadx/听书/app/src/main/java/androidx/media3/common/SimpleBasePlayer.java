...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda46
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m113lambda$new$0$androidxmedia3commonSimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m113lambda$new$0$androidxmedia3commonSimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda61
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m116x396b5ff4(list, state, i, j);
                }
            });
        }
    }
    ...
    /* synthetic */ State m116x396b5ff4(List list, State state, int i, long j) {
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda54
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m111lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(state, list, iMin);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$addMediaItems$3$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m111lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(State state, List list, int i) {
    ...
    public final void moveMediaItems(final int i, int i2, int i3) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda50
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m112lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(state, i, iMin, iMin2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$moveMediaItems$4$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m112lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(State state, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    public final void replaceMediaItems(final int i, int i2, final List<MediaItem> list) {
        ...
        final int iMin = Math.min(i2, size);
        updateStateForPendingOperation(handleReplaceMediaItems(i, iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda33
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m115x7bc5132c(state, list, iMin, i);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$replaceMediaItems$5$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m115x7bc5132c(State state, List list, int i, int i2) {
    ...
    public final void removeMediaItems(final int i, int i2) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i, iMin), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda56
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m114x3b22ba57(state, i, iMin);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$removeMediaItems$6$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m114x3b22ba57(State state, int i, int i2) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    protected ListenableFuture<?> handleReplaceMediaItems(int i, int i2, List<MediaItem> list) {
        ...
        return Util.transformFutureAsync(listenableFutureHandleAddMediaItems, new AsyncFunction() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda42
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda43
            ...
            public final void run() {
                this.f$0.m117xf52f679(listenableFuture);
            }
    ...
    /* JADX INFO: renamed from: lambda$updateStateForPendingOperation$61$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m117xf52f679(ListenableFuture listenableFuture) {
