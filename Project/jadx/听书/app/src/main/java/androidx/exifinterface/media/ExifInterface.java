...
public class ExifInterface {
    ...
    static {
        ...
        JPEG_INTERCHANGE_FORMAT_LENGTH_TAG = new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_EXPIRED_LICENSE, 4);
    ...
    public void saveAttributes() throws Throwable {
        ...
        try {
            if (this.mFilename != null) {
                fileCreateTempFile = new File(this.mFilename + bi.k);
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x00bf A[FALL_THROUGH] */
