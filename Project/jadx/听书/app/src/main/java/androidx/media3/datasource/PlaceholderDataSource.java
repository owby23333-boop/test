...
public final class PlaceholderDataSource implements DataSource {
    ...
    public static final DataSource.Factory FACTORY = new DataSource.Factory() { // from class: androidx.media3.datasource.PlaceholderDataSource$$ExternalSyntheticLambda0
        ...
        public final DataSource createDataSource() {
            return PlaceholderDataSource.m122$r8$lambda$vtmV5Njo8kR2KAgmyl6w_QrhmI();
        }
    };

    /* JADX INFO: renamed from: $r8$lambda$vtmV5Njo8kR2KAgmyl6w_Qrh-mI, reason: not valid java name */
    public static /* synthetic */ PlaceholderDataSource m122$r8$lambda$vtmV5Njo8kR2KAgmyl6w_QrhmI() {
