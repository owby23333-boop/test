...
public final class MediaFormatUtil {
    ...
    public static Format createFormatFromMediaFormat(MediaFormat mediaFormat) {
        int i = 0;
        Format.Builder pcmEncoding = new Format.Builder().setSampleMimeType(mediaFormat.getString("mime")).setLanguage(mediaFormat.getString("language")).setPeakBitrate(getInteger(mediaFormat, KEY_MAX_BIT_RATE, -1)).setAverageBitrate(getInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_BIT_RATE, -1)).setCodecs(mediaFormat.getString("codecs-string")).setFrameRate(getFrameRate(mediaFormat, -1.0f)).setWidth(getInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_WIDTH, -1)).setHeight(getInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_HEIGHT, -1)).setPixelWidthHeightRatio(getPixelWidthHeightRatio(mediaFormat, 1.0f)).setMaxInputSize(getInteger(mediaFormat, "max-input-size", -1)).setRotationDegrees(getInteger(mediaFormat, "rotation-degrees", 0)).setColorInfo(getColorInfo(mediaFormat, true)).setSampleRate(getInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_SAMPLE_RATE, -1)).setChannelCount(getInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_CHANNEL_COUNT, -1)).setPcmEncoding(getInteger(mediaFormat, "pcm-encoding", -1));
    ...
    public static MediaFormat createMediaFormatFromFormat(Format format) {
        ...
        maybeSetInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_WIDTH, format.width);
        maybeSetInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_HEIGHT, format.height);
