...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public SphericalGLSurfaceView(Context context, AttributeSet attributeSet) {
        ...
        SensorManager sensorManager = (SensorManager) Assertions.checkNotNull(context.getSystemService(an.ac));
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m217x24c550f4(surfaceTexture);
            }
        });
    }
    ...
    /* synthetic */ void m217x24c550f4(SurfaceTexture surfaceTexture) {
