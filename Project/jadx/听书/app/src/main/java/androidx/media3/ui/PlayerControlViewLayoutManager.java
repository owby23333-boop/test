...
final class PlayerControlViewLayoutManager {
    ...
    public PlayerControlViewLayoutManager(final PlayerControlView playerControlView) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m425lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m426lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda6
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m427lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        valueAnimatorOfFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda7
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m428lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m425lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m426lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        View view = this.controlsBackground;
        if (view != null) {
            view.setAlpha(fFloatValue);
    ...
    /* synthetic */ void m427lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m428lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        animateOverflow(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
