...
public class WidgetGroup {
    ...
    class MeasureResult {
        ...
        public MeasureResult(ConstraintWidget constraintWidget, LinearSystem linearSystem, int i) {
            ...
            this.f55top = linearSystem.getObjectVariableValue(constraintWidget.mTop);
        ...
        public void apply() {
            ...
            if (constraintWidget != null) {
                constraintWidget.setFinalFrame(this.left, this.f55top, this.right, this.bottom, this.baseline, this.orientation);
            }
        }
    }
}
