...
public final class WindowAreaControllerImpl implements WindowAreaController {
    ...
    public void transferActivityToWindowArea(Binder token, Activity activity, Executor executor, final WindowAreaSessionCallback windowAreaSessionCallback) {
        ...
        if (!Intrinsics.areEqual(token.getInterfaceDescriptor(), REAR_DISPLAY_BINDER_DESCRIPTOR)) {
            ...
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(ExecutorsKt.from(executor)), null, null, new C05302(activity, executor, windowAreaSessionCallback, null), 3, null);
        } else {
    ...
    static final class C05302 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C05302(Activity activity, Executor executor, WindowAreaSessionCallback windowAreaSessionCallback, Continuation<? super C05302> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return WindowAreaControllerImpl.this.new C05302(this.$activity, this.$executor, this.$windowAreaSessionCallback, continuation);
        }
