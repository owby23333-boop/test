...
public final class PublicSuffixDatabase {
    ...
    public final String getEffectiveTldPlusOne(String domain) {
        ...
        return SequencesKt.joinToString$default(SequencesKt.drop(CollectionsKt.asSequence(splitDomain(domain)), size - size2), FileUtils.FILE_EXTENSION_SEPARATOR, null, null, 0, null, null, 62, null);
    }
