...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        String str = hostname;
        if (!(str == null || str.length() == 0) && !StringsKt.startsWith$default(hostname, FileUtils.FILE_EXTENSION_SEPARATOR, false, 2, (Object) null) && !StringsKt.endsWith$default(hostname, "..", false, 2, (Object) null)) {
            String str2 = pattern;
            if (!(str2 == null || str2.length() == 0) && !StringsKt.startsWith$default(pattern, FileUtils.FILE_EXTENSION_SEPARATOR, false, 2, (Object) null) && !StringsKt.endsWith$default(pattern, "..", false, 2, (Object) null)) {
                if (!StringsKt.endsWith$default(hostname, FileUtils.FILE_EXTENSION_SEPARATOR, false, 2, (Object) null)) {
                    hostname = Intrinsics.stringPlus(hostname, FileUtils.FILE_EXTENSION_SEPARATOR);
                }
                if (!StringsKt.endsWith$default(pattern, FileUtils.FILE_EXTENSION_SEPARATOR, false, 2, (Object) null)) {
                    pattern = Intrinsics.stringPlus(pattern, FileUtils.FILE_EXTENSION_SEPARATOR);
                }
