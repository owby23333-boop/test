...
public final class Response implements Closeable {
    ...
    public final CacheControl m2323deprecated_cacheControl() {
        return cacheControl();
    }
