...
public final class HttpUrl {
    ...
    public final String m2261deprecated_encodedUsername() {
    ...
    public final String m2257deprecated_encodedPassword() {
    ...
    public static final class Builder {
        ...
        */
        ...
        private final boolean isDot(String input) {
            return Intrinsics.areEqual(input, FileUtils.FILE_EXTENSION_SEPARATOR) || StringsKt.equals(input, "%2e", true);
        }
        ...
        public static final class Companion {
            ...
            public final int schemeDelimiterOffset(String input, int pos, int limit) {
                ...
                if ((Intrinsics.compare((int) cCharAt, 97) < 0 || Intrinsics.compare((int) cCharAt, UMErrorCode.E_UM_BE_ERROR_WORK_MODE) > 0) && (Intrinsics.compare((int) cCharAt, 65) < 0 || Intrinsics.compare((int) cCharAt, 90) > 0)) {
                    return -1;
                }
                int i = pos + 1;
                while (i < limit) {
    ...
    public static final class Companion {
        ...
        public final HttpUrl m2275deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m2278deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m2277deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m2276deprecated_get(URI uri) {
