...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (StringsKt.equals(ILivePush.ClickType.CLOSE, responseBuild.request().header(com.google.common.net.HttpHeaders.CONNECTION), true) || StringsKt.equals(ILivePush.ClickType.CLOSE, Response.header$default(responseBuild, com.google.common.net.HttpHeaders.CONNECTION, null, 2, null), true)) {
            exchange.noNewExchangesOnConnection();
        }
