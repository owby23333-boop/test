...
public interface ReceiveChannel<E> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.ReceiveChannel$DefaultImpls", f = "Channel.kt", i = {}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_STALL_COUNTER}, m = "receiveOrNull", n = {}, s = {})
    ...
    Object mo2141receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2142tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2142tryReceivePtdJZtk = receiveChannel.mo2142tryReceivePtdJZtk();
            if (ChannelResult.m2157isSuccessimpl(objMo2142tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2153getOrThrowimpl(objMo2142tryReceivePtdJZtk);
            }
            Throwable thM2151exceptionOrNullimpl = ChannelResult.m2151exceptionOrNullimpl(objMo2142tryReceivePtdJZtk);
            if (thM2151exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2151exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2141receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2152getOrNullimpl(r4)
                return r4
            */
