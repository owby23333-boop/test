...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM635constructorimpl = Result.m635constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM635constructorimpl = Result.m635constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2147boximpl(Result.m642isSuccessimpl(objM635constructorimpl) ? ChannelResult.INSTANCE.m2162successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2160closedJP2dKIU(Result.m638exceptionOrNullimpl(objM635constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2137trySendJP2dKIU = sendChannel.mo2137trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2157isSuccessimpl(sendChannel.mo2137trySendJP2dKIU(obj))) {
            return;
        }
