...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2165trySendImplMj0NB7M = conflatedBufferedChannel.m2165trySendImplMj0NB7M(e, true);
        if (objM2165trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2151exceptionOrNullimpl(objM2165trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2165trySendImplMj0NB7M = conflatedBufferedChannel.m2165trySendImplMj0NB7M(e, true);
        if (!(objM2165trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2137trySendJP2dKIU(E element) {
        return m2165trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2165trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2163trySendDropLatestMj0NB7M(element, isSendOp) : m2164trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2163trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2137trySendJP2dKIU = super.mo2137trySendJP2dKIU(element);
        if (ChannelResult.m2157isSuccessimpl(objMo2137trySendJP2dKIU) || ChannelResult.m2155isClosedimpl(objMo2137trySendJP2dKIU)) {
            return objMo2137trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m2162successJP2dKIU(Unit.INSTANCE);
    }

    /* JADX INFO: renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m2164trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegment;
        Object obj = BufferedChannelKt.BUFFERED;
        ConflatedBufferedChannel<E> conflatedBufferedChannel = this;
        ChannelSegment channelSegment2 = (ChannelSegment) BufferedChannel.sendSegment$volatile$FU.get(conflatedBufferedChannel);
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2160closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2137trySendJP2dKIU = mo2137trySendJP2dKIU(element);
        if (!(objMo2137trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2137trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2151exceptionOrNullimpl(objMo2137trySendJP2dKIU);
