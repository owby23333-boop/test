...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo2192dispatch(CoroutineContext context, Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo2192dispatch(context, block);
        }
    }
