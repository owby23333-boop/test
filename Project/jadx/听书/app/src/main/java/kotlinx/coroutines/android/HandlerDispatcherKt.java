...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM635constructorimpl = Result.m635constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM635constructorimpl = Result.m635constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m641isFailureimpl(objM635constructorimpl) ? null : objM635constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2192dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
