...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM635constructorimpl = Result.m635constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM635constructorimpl = Result.m635constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m641isFailureimpl(objM635constructorimpl) ? null : objM635constructorimpl);
