...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM635constructorimpl = Result.m635constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM635constructorimpl = Result.m635constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m641isFailureimpl(objM635constructorimpl)) {
                objM635constructorimpl = null;
            }
            return (E) objM635constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM635constructorimpl = Result.m635constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM635constructorimpl = Result.m635constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m641isFailureimpl(objM635constructorimpl) ? null : objM635constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM635constructorimpl = Result.m635constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM635constructorimpl = Result.m635constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m641isFailureimpl(objM635constructorimpl)) {
            objM635constructorimpl = numValueOf;
        }
        return ((Number) objM635constructorimpl).intValue();
    }
