...
public interface SendChannel<E> {
    ...
    Object mo2137trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2157isSuccessimpl(objMo2137trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2151exceptionOrNullimpl = ChannelResult.m2151exceptionOrNullimpl(objMo2137trySendJP2dKIU);
