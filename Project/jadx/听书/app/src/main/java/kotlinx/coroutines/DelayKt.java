...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2193scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2125delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2126toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2126toDelayMillisLRDsOJo(long j) {
        boolean zM1995isPositiveimpl = Duration.m1995isPositiveimpl(j);
        if (zM1995isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1979getInWholeMillisecondsimpl(Duration.m1997plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1995isPositiveimpl) {
