...
public final class SharingStartedKt {
    ...
    public static /* synthetic */ SharingStarted m2180WhileSubscribed5qebJ5I$default(SharingStarted.Companion companion, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Duration.INSTANCE.m2064getZEROUwyO8pc();
        }
        if ((i & 2) != 0) {
            j2 = Duration.INSTANCE.m2062getINFINITEUwyO8pc();
        }
        return m2179WhileSubscribed5qebJ5I(companion, j, j2);
    }

    /* JADX INFO: renamed from: WhileSubscribed-5qebJ5I, reason: not valid java name */
    public static final SharingStarted m2179WhileSubscribed5qebJ5I(SharingStarted.Companion companion, long j, long j2) {
        return new StartedWhileSubscribed(Duration.m1979getInWholeMillisecondsimpl(j), Duration.m1979getInWholeMillisecondsimpl(j2));
    }
}
