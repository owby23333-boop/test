...
public final class ProduceKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.ProduceKt", f = "Produce.kt", i = {0, 0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_GET_VIDEO_OUTPUT_FPS}, m = "awaitClose", n = {"$this$awaitClose", "block"}, s = {"L$0", "L$1"})
