...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m2170debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2126toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m2126toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2", f = "Delay.kt", i = {0, 0, 0, 0}, l = {TTAdConstant.VIDEO_URL_CODE}, m = "invokeSuspend", n = {"downstream", "values", "lastValue", "ticker"}, s = {"L$0", "L$1", "L$2", "L$3"})
    static final class C07422<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C07422(long j, Flow<? extends T> flow, Continuation<? super C07422> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C07422 c07422 = new C07422(this.$periodMillis, this.$this_sample, continuation);
            c07422.L$0 = coroutineScope;
            c07422.L$1 = flowCollector;
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (objectRef.element != NullSurrogateKt.DONE) {
                SelectImplementation selectImplementation = new SelectImplementation(c07422.get$context());
                ...
                c07422.L$0 = flowCollector;
                c07422.L$1 = receiveChannel;
                c07422.L$2 = objectRef;
                c07422.L$3 = receiveChannelFixedPeriodTicker;
                c07422.label = 1;
                if (selectImplementation.doSelect(c07422) == coroutine_suspended) {
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C07422(j, flow, null));
    }
    ...
    public static final <T> Flow<T> m2171sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2126toDelayMillisLRDsOJo(j));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m2172timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m2173timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m2173timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
