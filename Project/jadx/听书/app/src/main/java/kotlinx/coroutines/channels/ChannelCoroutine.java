...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2141receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2141receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2142tryReceivePtdJZtk() {
        return this._channel.mo2142tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2137trySendJP2dKIU(E element) {
        return this._channel.mo2137trySendJP2dKIU(element);
    }
