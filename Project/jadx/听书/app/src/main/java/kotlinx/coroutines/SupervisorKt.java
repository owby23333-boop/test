...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m2132SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* JADX INFO: renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m2133SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m2132SupervisorJob(job);
    }
