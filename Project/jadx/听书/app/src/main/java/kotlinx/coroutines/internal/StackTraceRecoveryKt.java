...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM635constructorimpl2;
        ...
        try {
            ...
            objM635constructorimpl = Result.m635constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m638exceptionOrNullimpl(objM635constructorimpl) == null) {
            obj2 = objM635constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM635constructorimpl2 = Result.m635constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM635constructorimpl2 = Result.m635constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m638exceptionOrNullimpl(objM635constructorimpl2) == null) {
            obj = objM635constructorimpl2;
        }
