...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public boolean allocateLocked(StateFlowImpl<?> flow) {
        ...
        _state$volatile$FU.set(this, StateFlowKt.NONE);
        return true;
    }
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (obj == StateFlowKt.NONE) {
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj, StateFlowKt.PENDING)) {
                    return;
                }
            } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj, StateFlowKt.NONE)) {
                Result.Companion companion = Result.INSTANCE;
                ((CancellableContinuationImpl) obj).resumeWith(Result.m635constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
    ...
    public final boolean takePending() {
        Object andSet = _state$volatile$FU.getAndSet(this, StateFlowKt.NONE);
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(_state$volatile$FU.get(this) instanceof CancellableContinuationImpl))) {
            throw new AssertionError();
        }
        if (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, StateFlowKt.NONE, cancellableContinuationImpl2)) {
            if (DebugKt.getASSERTIONS_ENABLED()) {
                if (!(_state$volatile$FU.get(this) == StateFlowKt.PENDING)) {
                    throw new AssertionError();
                }
            }
            Result.Companion companion = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m635constructorimpl(Unit.INSTANCE));
        }
