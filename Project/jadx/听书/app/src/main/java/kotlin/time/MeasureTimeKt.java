...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> block) {
        ...
        long jM2100markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m2100markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m2105elapsedNowUwyO8pc(jM2100markNowz9LOYto);
    }
    ...
    public static final long measureTime(TimeSource timeSource, Function0<Unit> block) {
        ...
        block.invoke();
        return timeMarkMarkNow.mo1951elapsedNowUwyO8pc();
    }
    ...
    public static final long measureTime(TimeSource.Monotonic monotonic, Function0<Unit> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        long jM2100markNowz9LOYto = monotonic.m2100markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m2105elapsedNowUwyO8pc(jM2100markNowz9LOYto);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m2105elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m2100markNowz9LOYto()), null);
    }

    public static final <T> TimedValue<T> measureTimedValue(TimeSource timeSource, Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(timeSource, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), timeSource.markNow().mo1951elapsedNowUwyO8pc(), null);
    }

    public static final <T> TimedValue<T> measureTimedValue(TimeSource.Monotonic monotonic, Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(monotonic, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m2105elapsedNowUwyO8pc(monotonic.m2100markNowz9LOYto()), null);
    }
}
