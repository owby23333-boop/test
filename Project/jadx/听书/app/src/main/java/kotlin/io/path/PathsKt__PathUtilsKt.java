...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getNameWithoutExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringBeforeLast$default = StringsKt.substringBeforeLast$default(string, FileUtils.FILE_EXTENSION_SEPARATOR, (String) null, 2, (Object) null)) == null) ? "" : strSubstringBeforeLast$default;
    }
