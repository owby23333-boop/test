...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1952minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2098minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo1951elapsedNowUwyO8pc() {
        return Duration.m1996minusLRDsOJo(this.mark.mo1951elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1954plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1997plusLRDsOJo(this.adjustment, duration), null);
    }
}
